...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="r:report">
        <html>
            ...
            <body>
                ...
                <xsl:apply-templates select="r:tr_report"/>
    ...
    <xsl:template match="r:enq_report">
        <xsl:call-template name="ctos_header_template"/>
    ...
    <xsl:template match="r:enquiry">
        ...
        <xsl:call-template name="section_a_template"/>
        ...
        <!--<xsl:call-template name="section_c3_template"/>--> 
    ...
    <!-- start trade reference report -->
    <xsl:template match="r:tr_report">
        <xsl:call-template name="trade_reference_template"/>
    </xsl:template>
    <!-- finish trade reference report -->
    ...
    <!-- trade_reference -->
    <xsl:include href="subreport/trade_reference_report.xsl"/>
    <!-- internal_list -->

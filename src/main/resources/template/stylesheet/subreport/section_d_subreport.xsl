...
<xsl:stylesheet version="1.0"
                    ...
                    <tr>
                        ...
                        <td class="text-left">
                            ...
                            <xsl:if test="@rpttype = 'X4'">
                                RECORD REQUIRES UPDATING FROM SUBJECT
                            </xsl:if>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="long-content" colspan="3">
                        ...
                        &#160;
                        <xsl:value-of select="r:court_detail"/>
                        <xsl:call-template name="check_empty_string">
    ...
    <xsl:template name="section_d1_CD_template">
        ...
        <xsl:if test="@rpttype = 'CD'">
            ...
            <p class="notice">The CCM will strike-off from the register and dissolve a company.</p>
            <p class="notice">It believes is no longer carrying on business or in operations or is defunct. The following notification have been gazetted by the Registrar:</p>
    ...
    <xsl:template name="section_d1_I4_template">
        ...
        <xsl:if test="@rpttype = 'I4'">
            ...
            <p class="notice">NB: The above information only aim to show that the subject was a director at the time the company was petitioned for winding-up. Please note that the information does not in any way imply or attemp to suggest that the named director is under any legal action or that he/she has any guarantee exposure to the petitioner or other creditors.</p>
            <p class="notice">Director's details are extracted based on returns available at the CCM at the time the search was conducted. In cases where the company has failed to submit returns, the last set of available returns listing the directors are taken. Please make due enquiry for confirmation.</p>
            <p class="notice">Winding-up orders, where issued, may subsequently be stayed. Please check with the relevent parties.</p>
    ...
    <xsl:template name="section_d1_ID_template">
        ...
        <xsl:if test="@rpttype = 'ID'">
            ...
            <table class="table">
                <xsl:if test="r:special_remark != ''">
                    <tr>
                        <th class="caption">Special Remark</th>
                        <td class="long-content" colspan="3">
                            <xsl:value-of select="r:special_remark"/>
                        </td>
                    </tr>
                </xsl:if>
                <tr>

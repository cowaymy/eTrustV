...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="r:enquiry">
        ...
        <xsl:call-template name="report_legend_template"/>
    </xsl:template>
    ...
    <!-- standard -->
    <xsl:include href="subreport/section_a_sme_subreport.xsl"/>
    <xsl:include href="subreport/section_b_sme_subreport.xsl"/>

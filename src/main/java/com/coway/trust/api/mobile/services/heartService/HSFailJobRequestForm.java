...
//				map.put("signData", Base64.decodeBase64(installationResultForm.getSignData()));
				...
				// install Result
				map.put("userId", hSFailJobRequestForm.getUserId());
				map.put("salesOrderNo", hSFailJobRequestForm.getSalesOrderNo());
				map.put("serviceNo", hSFailJobRequestForm.getServiceNo());

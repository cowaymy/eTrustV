 ...
 * </pre>
 */
@ApiModel(value = "HomecareServiceApiForm", description = "HomecareServiceApiForm")
public class HomecareServiceApiForm {

	public static Map<String, Object> createMap(HomecareServiceApiForm vo){

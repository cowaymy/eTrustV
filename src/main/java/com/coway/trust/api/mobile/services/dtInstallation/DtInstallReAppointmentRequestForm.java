...
public class DtInstallReAppointmentRequestForm {
	...
	public static Map<String, Object> createMaps(DtInstallReAppointmentRequestForm installReAppointmentRequestForm) {

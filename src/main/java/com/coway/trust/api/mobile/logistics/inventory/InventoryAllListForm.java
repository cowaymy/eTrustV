...
public class InventoryAllListForm {
	...
	@ApiModelProperty(value = "userId [default : '' 전체] 예) C430,CT100591 ", example = "1, 2, 3")
	private String userId;

	@ApiModelProperty(value = "productCode [default : '' 전체] 예) 110181,112098,1206012", example = "1100305,110181")

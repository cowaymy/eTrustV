...
public class DtAfterServicePartsDto {
	...
	public static DtAfterServicePartsDto create(EgovMap egovMap) {
		return BeanConverter.toBean(egovMap, DtAfterServicePartsDto.class);
	}

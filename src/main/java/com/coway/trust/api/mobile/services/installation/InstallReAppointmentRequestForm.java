...
public class InstallReAppointmentRequestForm {
	...
	public static Map<String, Object> createMaps(InstallReAppointmentRequestForm installReAppointmentRequestForm) {

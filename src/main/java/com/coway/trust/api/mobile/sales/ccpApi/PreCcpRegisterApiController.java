...
public class PreCcpRegisterApiController {
  ...
  public Map<String, Object> triggerSms( @RequestParam Map<String, Object> params ) {
    ...
    try {
      ...
      if ( getCustInfo.get( "smsCount" ).toString().equals( "0" ) || compareResult.equals( 1 ) ) {
        ...
        message.put( "msg", smsResult.getSmsStatus() == 4 ? "The SMS Consent is successfully sent to customer."
  ...
  public ResponseEntity<Map<String, Object>> sendWhatsapp( @RequestBody Map<String, Object> params ) throws Exception {
  ...
  public ResponseEntity<ReturnMessage> chkDuplicated( @RequestParam Map<String, Object> params ) {
    String chkDate = preCcpRegisterService.chkSmsResetFlag().get( "chkDate" ).toString(), chkResetSmsFlag = preCcpRegisterService.chkSmsResetFlag().get( "resetFlag" ).toString();

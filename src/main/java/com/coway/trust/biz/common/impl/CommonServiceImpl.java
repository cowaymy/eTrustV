    ...
    implements CommonService
{
    ...
    /*
     * @Override public int insertUserExceptAuthMapping(List<Object> addList, Integer crtUserId) {
     * int saveCnt = 0; for (Object obj : addList) { ((Map<String, Object>) obj).put("crtUserId",
     ...
     * saveCnt; }
     * @Override public int updateUserExceptAuthMapping(List<Object> updList, Integer crtUserId) {
     * int saveCnt = 0; for (Object obj : updList) { ((Map<String, Object>) obj).put("crtUserId",
     * crtUserId); ((Map<String, Object>) obj).put("updUserId", crtUserId); LOGGER.debug(
     * " >>>>> updateUserExceptAuthMapping "); // LOGGER.debug(" hidden : {}", ((Map<String,
     * Object>) obj).get("hidden")); ((Map<String, Object>) // obj).put("userId", ((Map<String,
     * Object>) obj).get("hidden") ); LOGGER.debug("UserId : {}", ((Map<String, Object>)
     * obj).get("userId")); saveCnt++; commonMapper.updateUserExceptAuthMapping((Map<String,
     * Object>) obj); } return saveCnt; }
     * @Override public int deleteUserExceptAuthMapping(List<Object> delList, Integer crtUserId) {
     * int delCnt = 0; for (Object obj : delList) { ((Map<String, Object>) obj).put("crtUserId",
     * crtUserId); ((Map<String, Object>) obj).put("updUserId", crtUserId); LOGGER.debug(
     ...
     * obj).get("authCode")); delCnt++; if (((Map<String, Object>)
     * obj).get("authCode").equals("INT")) { LOGGER.debug(" deleteRoleAuthMapping_MGR_AuthCode : {}"
     * , ((Map<String, Object>) obj).get("authCode")); ((Map<String, Object>) obj).put("oldRoleId",
    ...
    /*
     * @Override public int insertAuth(List<Object> addList, Integer crtUserId) { int saveCnt = 0;
     * for (Object obj : addList) { ((Map<String, Object>) obj).put("crtUserId", crtUserId);
     * ((Map<String, Object>) obj).put("updUserId", crtUserId); LOGGER.debug(" >>>>> insertAuth ");
     * LOGGER.debug(" hidden : {}", ((Map<String, Object>) obj).get("hidden")); String tmpStr =
     * (String) ((Map<String, Object>) obj).get("hidden"); saveCnt++;
     * commonMapper.insertAuth((Map<String, Object>) obj); } return saveCnt; }
     * @Override public int updateAuth(List<Object> updList, Integer crtUserId) { int saveCnt = 0;
     * for (Object obj : updList) { ((Map<String, Object>) obj).put("crtUserId", crtUserId);
     * ((Map<String, Object>) obj).put("updUserId", crtUserId); LOGGER.debug(" >>>>> updateAuth ");
     * LOGGER.debug(" authCode : {}", ((Map<String, Object>) obj).get("authCode")); saveCnt++;
     * commonMapper.updateAuth((Map<String, Object>) obj); } return saveCnt; }
     * @Override public int deleteAuth(List<Object> delList, Integer crtUserId) { int delCnt = 0;
     ...
     * " >>>>> deleteAuthCode "); LOGGER.debug(" authCode : {}", ((Map<String, Object>)
     * obj).get("authCode")); delCnt++; commonMapper.deleteAuth((Map<String, Object>) obj); } return
     * delCnt; }
     */
    /**
     ...
     * @Override public int insertMenuCode(List<Object> addList, Integer crtUserId) { int saveCnt =
     * 0; for (Object obj : addList) { ((Map<String, Object>) obj).put("crtUserId", crtUserId);
     * ((Map<String, Object>) obj).put("updUserId", crtUserId); LOGGER.debug(
     * " >>>>> insertMenuCode "); LOGGER.debug(" menuCode : {}", ((Map<String, Object>)
     * obj).get("menuCode")); saveCnt++; commonMapper.insertMenuCode((Map<String, Object>) obj); }
     * return saveCnt; }
     * @Override public int updateMenuCode(List<Object> updList, Integer crtUserId) { int saveCnt =
     * 0; for (Object obj : updList) { ((Map<String, Object>) obj).put("crtUserId", crtUserId);
     * ((Map<String, Object>) obj).put("updUserId", crtUserId); LOGGER.debug(
     * " >>>>> updateMenuCode "); LOGGER.debug(" menuCode : {}", ((Map<String, Object>)
     * obj).get("menuCode")); saveCnt++; commonMapper.updateMenuCode((Map<String, Object>) obj); }
     * return saveCnt; }
     */
    /**
    ...
    /*
     * @Override public int deletePgmId(List<Object> delList, Integer crtUserId) { int delCnt = 0;
     * for (Object obj : delList) { ((Map<String, Object>) obj).put("crtUserId", crtUserId);
     * ((Map<String, Object>) obj).put("updUserId", crtUserId); if (String.valueOf(((Map<String,
     * Object>) obj).get("pgmCode")).length() == 0 || "null".equals(String.valueOf(((Map<String,
     * Object>) obj).get("pgmCode")))) { continue; } LOGGER.debug(" >>>>> deletePgmId ");
     * LOGGER.debug(" pgmCode : {}", ((Map<String, Object>) obj).get("pgmCode")); delCnt++;
     ...
     * Object>) obj).get("pgmDesc")); saveCnt++; commonMapper.insertPgmId((Map<String, Object>)
     * obj); } return saveCnt; }
     ...
     * obj).get("pgmDesc")); saveCnt++; commonMapper.updatePgmId((Map<String, Object>) obj); }
     * return saveCnt; }
     * @Override public int updPgmIdTrans(List<Object> addList, Integer crtUserId) { int saveCnt =
     * 0; for (Object obj : addList) { ((Map<String, Object>) obj).put("crtUserId", crtUserId);
     * ((Map<String, Object>) obj).put("updUserId", crtUserId); if (String.valueOf(((Map<String,
     ...
     * } LOGGER.debug(" InsertSatusCategory "); LOGGER.debug(" stusCtgryId : {}", ((Map<String,
     * Object>) obj).get("stusCtgryId")); LOGGER.debug(" stusCtgryName : {}", ((Map<String, Object>)
     ...
     * LOGGER.debug(" codeName : {}", ((Map<String, Object>) obj).get("codeName")); LOGGER.debug(
     * " code : {}", ((Map<String, Object>) obj).get("code")); saveCnt++;
     * commonMapper.updateStatusCode((Map<String, Object>) obj); } return saveCnt; }
     */
    /**
     ...
     * " createName : {}", ((Map<String, Object>) obj).get("createName")); LOGGER.debug(
     * " crtDt : {}", ((Map<String, Object>) obj).get("crtDt")); saveCnt++;
     ...
     * obj).get("detailcodeid")); saveCnt++; commonMapper.updDetailCommCodeGrid((Map<String,
     * Object>) obj); } return saveCnt; }
     */
    @Override

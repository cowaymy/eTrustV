...
////              "We have received your request to reset the One-Time Password (OTP) for " + memCode + " Multi-Factor Authentication (MFA) via Google Authenticator. To complete the reset process, kindly follow the steps outlined below:<br /><br/>"
////			  + "<dl><dt><strong>1. Remove the Old OTP Setup</strong></dt><dd>Before proceeding, please remove the previously configured OTP from your Google Authenticator app to avoid any conflicts with the new setup.</dd><br/>"
////              + "<dt><strong>2. Scan the New QR Code</strong></dt><dd>Below is the QR code for your new OTP configuration. To set up the new OTP, open your Google Authenticator app and scan the QR code displayed below:</dd><br />"
////              + "<div style=\"text-align: center; padding: 20px; background-color: #f7f7f7; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);\">" +
////              "<img src=\"" + qrCodeImageUrl + "\" alt=\"QR Code for OTP\" style=\"max-width: 100%; height: auto; border: 3px solid #4CAF50; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);\">" +
////              "<p style=\"font-size: 14px; color: #333; margin-top: 10px;\">Scan this QR code to complete your OTP setup.</p>" +
////              "</div><br />"  // Styling and centering the QR code
////              + "<dt><strong>3. Retry Logging into Your eTrust Account</strong></dt><dd>Once you have scanned the new QR code, please attempt to log in to your eTrust account again using the updated OTP generated by Google Authenticator.</dd><br />"
////              + "Should you experience any issues or need further assistance, please contact our support team.<br /> Thank you for your prompt attention to this matter and for ensuring the security of your account."
////              ;
////
//		content = "<html>" +
//			    "<head>" +

...
@Service("hsAccConfigService")
public class HsAccConfigServiceImpl extends EgovAbstractServiceImpl implements HsAccConfigService {
  ...
  public List<EgovMap> selectHsConfigList(Map<String, Object> params) {
    ...
    return hsAccConfigMapper.selectHsConfigList(params);
  }
...
/*	    hsAccConfigMapper.updateAssignHTMultiple(params);*/
  ...
  @Override
	public List<EgovMap> getDeptTreeList(Map<String, Object> params) {
		...
		return hsAccConfigMapper.getDeptTreeList(params);
	}

  @Override
	public List<EgovMap> getGroupTreeList(Map<String, Object> params) {
		// TODO Auto-generated method stub
		return hsAccConfigMapper.getGroupTreeList(params);
  ...
  public List<EgovMap> selectHsManualList(Map<String, Object> params) {
    ...
    return hsAccConfigMapper.selectHsManualList(params);
  }
  ...
  public List<EgovMap> selectHsAssiinlList(Map<String, Object> params) {
    ...
    return hsAccConfigMapper.selectHsAssiinlList(params);
  }

  @Override
  public List<EgovMap> selectBranchList(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectBranchList(params);
  }

  @Override
  public List<EgovMap> selectCtList(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectCtList(params);
  }
  ...
  public List<EgovMap> getCdUpMemList(Map<String, Object> params) {
    // TODO Auto-generated method stub
    params.put("memLvl", 3);
    return hsAccConfigMapper.getCdUpMemList(params);
  }
  ...
  public List<EgovMap> getCdDeptList(Map<String, Object> params) {
    // TODO Auto-generated method stub
    params.put("memLvl", 3);
    return hsAccConfigMapper.getCdDeptList(params);
  }
   ...
   * hsAccConfigMapper.getCdUpMemList(params); }
   */
  ...
  public List<EgovMap> getCdList_1(Map<String, Object> params) {
    // TODO Auto-generated method stub
    params.put("memLvl", 3);
    return hsAccConfigMapper.getCdList_1(params);
  }
  ...
  public List<EgovMap> selectHsManualListPop(Map<String, Object> params) {
    ...
    return hsAccConfigMapper.selectHsManualListPop(params);
  }
  ...
  public Map<String, Object> insertHsResult(Map<String, Object> params, List<Object> docType, SessionVO sessionVO) {
    ...
    for (int i = 0; i < docType.size(); i++) {
      ...
      int nextSchId = hsAccConfigMapper.getNextSchdulId();
      ...
      hsAccConfigMapper.insertHsResult(docSub);
      // hsAccConfigMapper.insertHsResult((Map<String, Object>)obj);
    ...
    success = true;
    // hsAccConfigMapper.insertHsResult(MemApp);
  ...
  public EgovMap selectHsInitDetailPop(Map<String, Object> params) {
    ...
    return hsAccConfigMapper.selectHsInitDetailPop(params);
  }
  ...
  private Map<String, Object> SaveResult(boolean isfreepromo, Map<String, Object> params, List<Object> docType,
    ...
    int masterCnt = hsAccConfigMapper.selectHSResultMCnt(params);
    int nextSeq = hsAccConfigMapper.getNextSvc006dSeq();

    EgovMap insertHsResultfinal = new EgovMap();
    String LOG_SVC0008D_NO = "";
    LOG_SVC0008D_NO = (String) hsAccConfigMapper.getSVC008D_NO(params);

    if (masterCnt > 0) {
      params.put("resultId", nextSeq);
      hsAccConfigMapper.insertHsResultCopy(params);
    } else {
      params.put("resultId", nextSeq);
      ...
      hsAccConfigMapper.insertHsResultfinal(insertHsResultfinal); // INSERT
                                                               // SVC0006D

      List<EgovMap> qryUsedFilter = hsAccConfigMapper.selectQryUsedFilter2(insertHsResultfinal);
      ...
      for (int i = 0; i < docType.size(); i++) {
        ...
        int custId = hsAccConfigMapper.selectCustomer(params);
        int codyId = hsAccConfigMapper.selectCody(params);
        params.put("bsResultId", nextSeq);

        // String serialNo = hsAccConfigMapper.selectSerialNo(params);
        ...
        /*
         * String filterLastserial = hsAccConfigMapper.select0087DFilter(docSub);
         *
         ...
         *
         * hsAccConfigMapper.updateHsFilterSiriNo(docSub);
         */

        if (!"".equals(vstkId) && !("null").equals(vstkId) && vstkId != null) {
          logger.debug("= INSERT SVC0007D VIA docSub: {}", docSub);
          hsAccConfigMapper.insertHsResultD(docSub); // INSERT SVC0007D
          logger.debug("= INSERT LOG0082M VIA docSub2: {}", docSub2);
          hsAccConfigMapper.insertUsedFilter(docSub2); // INSERT LOG0082M
          ...
          if (!CommonUtils.nvl(docSub.get("srvFilterId")).equals("")) {
            filterLastserial = hsAccConfigMapper.select0087DFilter(docSub);
          } else {
            filterLastserial = hsAccConfigMapper.select0087DFilter2(docSub);
          }
          ...
          if (!CommonUtils.nvl(docSub.get("srvFilterId")).equals("")) {
            hsAccConfigMapper.updateHsFilterSiriNo(docSub); // UPDATE SAL0087D
          } else {
            hsAccConfigMapper.updateHsFilterSiriNo2(docSub); // UPDATE SAL0087D
          }
        }
      }
      hsAccConfigMapper.updateHs009d(params); // UPDATE SAL0090D
    }

    EgovMap getHsResultMList = hsAccConfigMapper.selectHSResultMList(params); // GET
                                                                           // SVC0006D
    int scheduleCnt = hsAccConfigMapper.selectHSScheduleMCnt(params);
    ...
    if (scheduleCnt > 0) {
      ...
      hsAccConfigMapper.updateHsScheduleM(insertHsScheduleM); // UPDATE SVC0008D
    }

    EgovMap srvConfiguration = hsAccConfigMapper.selectSrvConfiguration(params);
    ...
    if (srvConfiguration.size() > 0) {
      if (getHsResultMList.get("resultStusCodeId").toString().equals("4")) {
        ...
        hsAccConfigMapper.insertCcr0001d(callMas);

        // hsAccConfigMapper.updateHsSrvConfigM(insertHsSrvConfigM);
    ...
    if ("API".equals(CommonUtils.nvl(params.get("stage")).toString())) { // MOBILE
      ...
      EgovMap useFilterList = hsAccConfigMapper.getBSFilterInfo(params);
  ...
  private boolean insertHsResultfinal(int statusId, Map<String, Object> installResult, Map<String, Object> callEntry,
    ...
    hsAccConfigMapper.insertHsResultfinal(installResult);
    ...
    // }
    //
    // hsAccConfigMapper.insertOrderLog(orderLog);
    // }
    return true;
  }
  ...
  public List<EgovMap> selectHsViewfilterInfo(Map<String, Object> params) {
    ...
    return hsAccConfigMapper.selectHsViewfilterInfo(params);
  }

  @Override
  public EgovMap selectSettleInfo(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectSettleInfo(params);
  }
  ...
  public Map<String, Object> UpdateHsResult(Map<String, Object> params, List<Object> docType, SessionVO sessionVO) {
    ...
    for (int i = 0; i < docType.size(); i++) {
      ...
      hsAccConfigMapper.updateHsResultD(docSub);
    }
    ...
    hsAccConfigMapper.updateHsResultM(HsResultUdateEdit); // m
    ...
    if (scheduleCnt > 0) {
      ...
      hsAccConfigMapper.updateHsScheduleM(insertHsScheduleM);
    }
    ...
    // hsAccConfigMapper.updateHsSrvConfigM(updateHsSrvConfigM);
  ...
  public List<EgovMap> selectFilterTransaction(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectFilterTransaction(params);
  }

  @Override
  public List<EgovMap> selectHistoryHSResult(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectHistoryHSResult(params);
  }

  @Override
  public EgovMap selectConfigBasicInfo(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectConfigBasicInfo(params);
  }
  ...
  public int updateHsConfigBasic(Map<String, Object> params, SessionVO sessionVO) {
    ...
    EgovMap selectConfigBasicInfoYn = hsAccConfigMapper.selectConfigBasicInfoYn(hsBasicmap);
    ...
    if (selectConfigBasicInfoYn.size() > 0) {
      ...
      // hsAccConfigMapper.updateHsSVC0006D(sal0090);
      cnt = hsAccConfigMapper.updateHsConfigBasic(sal0090);

      // SrvConfigSetting --> Installation : 281
      List<EgovMap> configSettingMap = hsAccConfigMapper.selectConfigSettingYn(hsBasicmap);
      ...
      if (configSettingMap.size() > 0) {
        for (int i = 0; i < configSettingMap.size(); i++) {
          ...
          hsAccConfigMapper.updateHsconfigSetting(sal0089);
  ...
  public EgovMap selectHSOrderView(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectHSOrderView(params);
  }

  @Override
  public List<EgovMap> selectOrderInactiveFilter(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectOrderInactiveFilter(params);
  }

  @Override
  public List<EgovMap> selectOrderActiveFilter(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.selectOrderActiveFilter(params);
  }
  ...
  public int saveHsFilterInfoAdd(Map<String, Object> params) {
    ...
    String configID = hsAccConfigMapper.getSrvConfigId_SAL009(params);
    String filterPeriod = hsAccConfigMapper.getbomPartPriod_LOG0001M(params);
    String orderdate = hsAccConfigMapper.getSalesDtSAL_0001D(params);
    ...
    if (configID != null && !"0".equals(configID)) {
      EgovMap sal0087D = hsAccConfigMapper.getSrvConfigFilter_SAL0087D(params);
      ...
      if (sal0087D != null) {
         ...
         *
         * hsAccConfigMapper.saveChanges(send_sal0087D);
         */
        ...
        // Insert SAL0087D
        hsAccConfigMapper.saveHsFilterInfoAdd(params);
        result = 1;
  ...
  public int saveDeactivateFilter(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.saveDeactivateFilter(params);
  }

  @Override
  public int saveFilterUpdate(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.saveFilterUpdate(params);
  }

  @Override
  public List<EgovMap> selecthSFilterUseHistorycall(Map<String, Object> params) {
    return hsAccConfigMapper.selecthSFilterUseHistorycall(params);
  }
  ...
  public String UpdateIsReturn(Map<String, Object> params, List<Object> docType, SessionVO sessionVO)
    ...
    for (int i = 0; i < docType.size(); i++) {
      ...
      if ("1428".equals(CommonUtils.nvl(docSub.get("stkId")))) {
        ...
        qryConfig = hsAccConfigMapper.selectQryConfig(bsResultMas);
        ...
        hsAccConfigMapper.updateIsReturn(value);
      } else {
  ...
  public Map<String, Object> UpdateHsResult2(Map<String, Object> params, List<Object> docType, SessionVO sessionVO)
    ...
    String docNo = null;
    docNo = hsAccConfigMapper.GetDocNo(bsResultMas_Rev);
    ...
    hsAccConfigMapper.updateQry_New(bsResultMas_Rev);
    // int docNo1 = hsAccConfigMapper.GetDocNo1(bsResultMas_Rev);

    EgovMap qryBS_Rev = null;
    qryBS_Rev = hsAccConfigMapper.selectQryBS_Rev(bsResultMas);
    logger.debug("qryBS_Rev : {}" + qryBS_Rev);

    if (qryBS_Rev != null) {
      int BSResultM_resultID = hsAccConfigMapper.getBSResultM_resultID();
      ...
      int count = hsAccConfigMapper.selectTotalFilter(bsResultMas_Rev);
      logger.debug("selectQryResultDet : {}" + bsResultMas_Rev);
      List<EgovMap> qryResultDet = hsAccConfigMapper.selectQryResultDet(bsResultMas_Rev);
      List<EgovMap> qryUsedFilter;
      if (count == 0) {
        qryUsedFilter = hsAccConfigMapper.selectQryUsedFilterNew(bsResultMas_Rev);

      } else {
        qryUsedFilter = hsAccConfigMapper.selectQryUsedFilter(bsResultMas_Rev);
      ...
      for (int i = 0; i < qryResultDet.size(); i++) {
        ...
        if (CommonUtils.intNvl(qryResultDet.get(i).get("bsResultPartQty")) > 0) {
          hsAccConfigMapper.addbsResultDet_Rev(bsResultDet_Rev); // insert svc
                                                              // 0007d c
          hsAccConfigMapper.addusedFilter_Rev(usedFilter_Rev); // insert log0082m
      ...
      if (checkInt > 0) {
        hsAccConfigMapper.addbsResultMas_Rev(bsResultMas_Rev); // svc 0006d B
                                                            // insert
      ...
      qry_stkReqM = hsAccConfigMapper.selectQry_stkReqM(bsResultMas_Rev);

      if (qry_stkReqM != null) {
        String PDONo = null;
        int PDO_REQUEST = 26;
        bsResultMas_Rev.put("docType", PDO_REQUEST);
        PDONo = hsAccConfigMapper.GetDocNo(bsResultMas_Rev);
         ...
         *
         * int qry_PDO = hsAccConfigMapper.GetDocNo1(bsResultMas_Rev);
         */
        ...
        hsAccConfigMapper.addstkReqM_Rev(stkReqM_Rev);

        int LocationID_Rev = 0;
        if (Integer.parseInt(qryBS_Rev.get("codyId").toString()) != 0) {
          LocationID_Rev = hsAccConfigMapper.getMobileWarehouseByMemID(qryBS_Rev);
        }

        int stkReqM_StkReqID = hsAccConfigMapper.getStkReqM_StkReqID();

        EgovMap qryBS = null;
        qryBS = hsAccConfigMapper.selectQryBS(bsResultMas);
        // bsResultMas_Rev.put("ResultMatchID
        EgovMap qry_stkReqD_Rev = null;
        qry_stkReqD_Rev = hsAccConfigMapper.qry_stkReqD_Rev(bsResultMas_Rev);
        ...
        for (int i = 0; i < qry_stkReqD_Rev.size(); i++) {
          ...
          hsAccConfigMapper.addStkReqD_Rev(stkReqD_Rev);
          ...
          hsAccConfigMapper.addStkCrd_Rev(stkCrd_Rev);
      ...
      hsAccConfigMapper.updateQry_CurBS(qry_CurBS); // 업데이트 svc0006d

      String ResultNo_New = null;
      BS_RESULT = 11;
      bsResultMas_Rev.put("doctype", String.valueOf(BS_RESULT));
      ResultNo_New = hsAccConfigMapper.GetDocNo(bsResultMas_Rev);
      ...
      hsAccConfigMapper.updateQry_New(qry_New);

      int BSResultM_resultID2 = hsAccConfigMapper.getBSResultM_resultID();
      ...
      for (int i = 0; i < bsResultDet.size(); i++) {
        ...
        if (row.get("BSResultPartQty") != null && !row.get("BSResultPartQty").toString().equals("0")) {
          hsAccConfigMapper.addbsResultDet_Rev(row); // 인서트 svc 0007d
          hsAccConfigMapper.addusedFilter(usedFilter);
          cnt++;
      ...
      if (cnt != 0) { // 0이 아닐 경우 인서트
        hsAccConfigMapper.addbsResultMas(bsResultMas); // insert 1건 svc0006d
        ...
        hsAccConfigMapper.updatebsResultMas(bsResultMas); // UPDATE 1건 svc0006d
      }

      hsAccConfigMapper.updateQry_CurBSZero(qry_CurBS);// 최신거 업데이트

      hsAccConfigMapper.updateQrySchedule(bsResultMas);// 업데이트 00008d

      Map<String, Object> qrySchedule = new HashMap<String, Object>();
      qrySchedule = hsAccConfigMapper.selectQrySchedule(bsResultMas);
      ...
      hsAccConfigMapper.updateQryConfig(bsResultMas);
      Map<String, Object> qryConfig = new HashMap<String, Object>();
      qryConfig = hsAccConfigMapper.selectQryConfig(bsResultMas);

      if (Integer.parseInt(bsResultMas.get("ResultStatusCodeID").toString()) == 4) {
        hsAccConfigMapper.updateQryConfig4(bsResultMas);
      } else {
        hsAccConfigMapper.updateQryConfig(bsResultMas);
      }
      ...
      if (bsResultDet.size() > 0) {
        ...
        for (int i = 0; i < bsResultDet.size(); i++) {
          ...
          LocationID = hsAccConfigMapper.selectLocationID(bsResultMas);
          ...
          if (LocationID != 0) {
            ...
            hsAccConfigMapper.addStkCrd_new(stkCrd_new);
          }
          ...
          hsAccConfigMapper.updateQryFilter(qryFilter_param);
         ...
         *
         * hsAccConfigMapper.addBsResultDet_NoFilter(bsResultDet_NoFilter); 이거때문에
         */
      }
  ...
  public int isHsAlreadyResult(Map<String, Object> params) {
    return hsAccConfigMapper.isHsAlreadyResult(params);
  }

  @Override
  public int saveValidation(Map<String, Object> params) {
    return hsAccConfigMapper.saveValidation(params);
  }
  ...
  public Map<String, Object> saveASEntryResult(Map<String, Object> params) {
    ...
    params.put("DOCNO", "17");
    EgovMap eMap = hsAccConfigMapper.getASEntryDocNo(params);

    EgovMap seqMap = hsAccConfigMapper.getASEntryId(params);
    ...
    EgovMap seqMap2 = hsAccConfigMapper.getResultASEntryId(params2);
    EgovMap eMap2 = hsAccConfigMapper.getASEntryDocNo(params2);
    ...
    hsAccConfigMapper.insertSVC0001D(params);
    hsAccConfigMapper.insertSVC0004D(params2);
    hsAccConfigMapper.insertSVC0005D(params3);
  ...
  public Map<String, Object> saveASTaxInvoice(Map<String, Object> params) {
    ...
    EgovMap invoiceDocNo = hsAccConfigMapper.getASEntryDocNo(params);
    int taxInvcId = hsAccConfigMapper.getSeqPay0031D();
    EgovMap taxPersonInfo = hsAccConfigMapper.selectTaxInvoice(params);
    params.put("DOCNO", "22");
    EgovMap asBillDocNo = hsAccConfigMapper.getASEntryDocNo(params);
    ...
    hsAccConfigMapper.insert_Pay0031d(param);
    hsAccConfigMapper.insert_Pay0032d(param2);
    hsAccConfigMapper.insert_Pay0016d(param3);
    hsAccConfigMapper.insert_Pay0006d(param4);
    hsAccConfigMapper.insert_Pay0007d(param5);
  ...
  public EgovMap checkStkDuration(Map<String, Object> params) {
    return hsAccConfigMapper.checkStkDuration(params);
  }

  @Override
  public EgovMap checkHsBillASInfo(Map<String, Object> params) {
    if (params.get("revInd").equals("1")) {
      return hsAccConfigMapper.checkHsBillASInfoPass(params);
    } else {
      return hsAccConfigMapper.checkHsBillASInfo(params);
    }
  }
  ...
  public String reverseHSResult(Map<String, Object> params, SessionVO sessionVO) { // ADDED
    ...
    EgovMap qryBS_Rev = null;
    logger.debug("reverseHSResult - params : " + params);
    qryBS_Rev = hsAccConfigMapper.selectQryBS_Rev(params);
    logger.debug("qryBS_Rev : {}" + qryBS_Rev);
    ...
    if (qryBS_Rev != null) {
      ...
      for (int i = 0; i < qryResultDet.size(); i++) {
        ...
        usedFilter_Rev.put("ResultId", CommonUtils.intNvl(qryUsedFilter.get(i).get("resultId")));
        if (CommonUtils.intNvl(qryResultDet.get(i).get("bsResultPartQty")) > 0) {
          hsAccConfigMapper.addbsResultDet_Rev(bsResultDet_Rev); // insert svc0007d
      ...
      if (checkInt > 0) {
        hsAccConfigMapper.addbsResultMas_Rev(bsResultMas_Rev); // insert svc0006d
        logger.debug("reverse JM" + String.valueOf(bsResultDet_Rev.get("BSResultID")));
        // 물류 프로시져 호출
        Map<String, Object> logPram = null;
        logPram = new HashMap<String, Object>();
      ...
      hsAccConfigMapper.updateHsResultMas(bsResultMas_Rev); // update svc0006d
      hsAccConfigMapper.updateQrySchedule(bsResultMas);// 업데이트 00008d
  ...
  public String createCreditNote(Map<String, Object> params, SessionVO sessionVO) { // ADDED
    ...
    for (EgovMap obj : detailDataList) {
      ...
      if ("459".equals(String.valueOf(obj.get("noteItmTypeId")))) { // AS Change
        ...
        hsAccConfigMapper.insert_Pay0006d(ledgerMap);
  ...
  public String createASResults(Map<String, Object> params, SessionVO sessionVO) { // ADDED
    ...
    hsAccConfigMapper.insertSVC0004D(params2);
    hsAccConfigMapper.updateIsCurrent_SVC0004D(params2);
    hsAccConfigMapper.insertSVC0005D(params3);
    hsAccConfigMapper.insert_Pay0007d(param5);
  ...
  public String createReverseASResults(Map<String, Object> params, SessionVO sessionVO) { // ADDED
    ...
    EgovMap seqMap3 = hsAccConfigMapper.getResultASEntryId(params4);
    EgovMap eMap3 = hsAccConfigMapper.getASEntryDocNo(params4);
    ...
    hsAccConfigMapper.insertSVC0004D(params4);
  ...
  public EgovMap checkWarrentyStatus(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.checkWarrentyStatus(params);
  }

  public EgovMap checkSvcMembershipInfo(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.checkSvcMembershipInfo(params);
  }

  public EgovMap checkRentalStatusInfo(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.checkRentalStatusInfo(params);
  }

  public EgovMap checkOrderStatusInfo(Map<String, Object> params) {
    // TODO Auto-generated method stub
    return hsAccConfigMapper.checkOrderStatusInfo(params);
  }

  @Override
  public List<EgovMap> getAppTypeList(Map<String, Object> params) {
    return hsAccConfigMapper.getAppTypeList(params);
  }
  ...
  public void updateDisinfecSrv(Map<String, Object> params) {
    hsAccConfigMapper.updateDisinfecSrv(params);
  }
}

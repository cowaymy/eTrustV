...
public class ServiceApiASDetailServiceImpl extends EgovAbstractServiceImpl implements ServiceApiASDetailService {
    ...
    try {
      ...
      if ( asResultMemId > 0 ) {
        ...
        if ( isAsCnt == 0 ) {
          ...
          params.put( "PARTNER_CODE", !"".equals( CommonUtils.nvl( insApiresult.get( "partnerCode" ) ) ) ? CommonUtils.nvl( insApiresult.get( "partnerCode" ) ) : "" );
          params.put( "VOLT", !"".equals( CommonUtils.nvl( insApiresult.get( "voltage" ) ) ) ? CommonUtils.nvl( insApiresult.get( "voltage" ) ) : "" );
  ...
  public ResponseEntity<AfterServiceResultDto> asDtResultProc( Map<String, Object> insApiresult ) throws Exception {
    ...
    today2.append( String.format( "%02d", cal.get( Calendar.DATE ) ) );
    today2.append( String.format( "%02d", cal.get( Calendar.MONTH ) + 1 ) );
    today2.append( String.format( "%04d", cal.get( Calendar.YEAR ) ) );
    ...
    if ( asResultMemId > 0 ) {
      ...
      if ( isAsCnt == 0 ) {
        ...
        for ( int x = 0; x < paramsDetail.size(); x++ ) {
          ...
          Map<String, Object> map = new HashMap<String, Object>();
          map.put( "filterDesc", "API" );
          map.put( "filterID", !"".equals( CommonUtils.nvl( paramsDetail.get( x ).get( "filterCode" ) ) ) ? CommonUtils.nvl( paramsDetail.get( x ).get( "filterCode" ) ) : CommonUtils.nvl( paramsDetail.get( x ).get( "filterCode" ) ) );
          map.put( "filterExCode", !"".equals( CommonUtils.nvl( paramsDetail.get( x ).get( "exchangeId" ) ) ) ? CommonUtils.nvl( paramsDetail.get( x ).get( "exchangeId" ) ) : 0 );
          map.put( "filterQty", !"".equals( CommonUtils.nvl( paramsDetail.get( x ).get( "filterQty" ) ) ) ? CommonUtils.nvl( paramsDetail.get( x ).get( "filterQty" ) ) : 0 );
          map.put( "filterPrice", !"".equals( CommonUtils.nvl( paramsDetail.get( x ).get( "salesPrice" ) ) ) ? CommonUtils.nvl( paramsDetail.get( x ).get( "salesPrice" ) ) : 0 );

          int foc = CommonUtils.intNvl( paramsDetail.get( x ).get( "chargesFoc" ) );
          if ( foc == 1 ) {
            map.put( "filterType", "FOC" );
          } else {
            map.put( "filterType", CommonUtils.nvl( paramsDetail.get( x ).get( "chargesFoc" ) ) );
          }
          ...
          int qty = Integer.parseInt( CommonUtils.nvl( paramsDetail.get( x ).get( "filterChangeQty" ) ) );
          double filterPrice = Double.parseDouble( CommonUtils.nvl( paramsDetail.get( x ).get( "salesPrice" ) ) );
          double amt = 0.00;
          ...
          map.put( "retSmoSerialNo", !"".equals( CommonUtils.nvl( paramsDetail.get( x ).get( "retSmoSerialNo" ) ) ) ? CommonUtils.nvl( paramsDetail.get( x ).get( "retSmoSerialNo" ) ) : 0 );
          map.put( "isSmo", !"".equals( CommonUtils.nvl( paramsDetail.get( x ).get( "isSmo" ) ) ) ? CommonUtils.nvl( paramsDetail.get( x ).get( "retSmoSerialNo" ) ) : "N" );
          map.put( "isSerialReplace", !"".equals( CommonUtils.nvl( paramsDetail.get( x ).get( "isSerialReplace" ) ) ) ? CommonUtils.nvl( paramsDetail.get( x ).get( "isSerialReplace" ) ) : "N" );
        ...
        params.put( "AS_WORKMNSH", !"".equals( CommonUtils.nvl( insApiresult.get( "labourCharge" )) ) ? CommonUtils.nvl( insApiresult.get( "labourCharge" ) ) : "" );
        params.put( "AS_RESULT_REM", !"".equals( CommonUtils.nvl( insApiresult.get( "resultRemark" )) ) ? CommonUtils.nvl( insApiresult.get( "resultRemark" ) ) : "" );
        params.put( "PARTNER_CODE", !"".equals( CommonUtils.nvl( insApiresult.get( "partnerCode" )) ) ? CommonUtils.nvl( insApiresult.get( "partnerCode" ) ) : "" );
        params.put( "IN_HUSE_REPAIR_REM", !"".equals( CommonUtils.nvl( insApiresult.get( "inHouseRepairRemark" )) ) ? CommonUtils.nvl( insApiresult.get( "inHouseRepairRemark" ) ) : "" );
        params.put( "IN_HUSE_REPAIR_REPLACE_YN", !"".equals( CommonUtils.nvl( insApiresult.get( "inHouseRepairReplacementYN" )) ) ? CommonUtils.nvl( insApiresult.get( "inHouseRepairReplacementYN" ) ) : "" );
        ...
        params.put( "IN_HUSE_REPAIR_SERIAL_NO", !"".equals( CommonUtils.nvl( insApiresult.get( "inHouseRepairSerialNo" )) ) ? CommonUtils.nvl( insApiresult.get( "inHouseRepairSerialNo" ) ) : "" );
        params.put( "IN_HUSE_REPAIR_SERIAL_NO", !"".equals( CommonUtils.nvl( insApiresult.get( "inHouseRepairSerialNo" )) ) ? CommonUtils.nvl( insApiresult.get( "inHouseRepairSerialNo" ) ) : "" );
        params.put( "RESULT_CUST_NAME", !"".equals( CommonUtils.nvl( insApiresult.get( "resultCustName" )) ) ? CommonUtils.nvl( insApiresult.get( "resultCustName" ) ) : "" );
        params.put( "RESULT_MOBILE_NO", !"".equals( CommonUtils.nvl( insApiresult.get( "resultIcMobileNo" )) ) ? CommonUtils.nvl( insApiresult.get( "resultIcMobileNo" ) ) : "" );
        params.put( "RESULT_REP_EMAIL_NO", !"".equals( CommonUtils.nvl( insApiresult.get( "resultReportEmailNo" )) ) ? CommonUtils.nvl( insApiresult.get( "resultReportEmailNo" ) ) : "" );
        params.put( "RESULT_ACEPT_NAME", !"".equals( CommonUtils.nvl( insApiresult.get( "resultAcceptanceName" )) ) ? CommonUtils.nvl( insApiresult.get( "resultAcceptanceName" ) ) : "" );

 ...
 *--------------------------------------------------------------------------------------------
 * 04/03/2025    ONGHC      1.0.1     - Amend File Format
 *********************************************************************************************/
...
public class ServiceApiASServiceImpl extends EgovAbstractServiceImpl implements ServiceApiASService {
  ...
  @Override
  public ResponseEntity<AfterServiceResultDto> asDtResult( List<AfterServiceResultForm> afterServiceForms ) throws Exception {
    String transactionId = "";
    String serviceNo = "";

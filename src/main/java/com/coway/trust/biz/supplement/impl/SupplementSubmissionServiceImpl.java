...
/*********************************************************************************************
 * DATE PIC VERSION COMMENT -------------------------------------------------------------------------------------------- 14/05/2024 TOMMY 1.0.1 - RE-STRUCTURE SupplementSubmissionServiceImpl
 *
 *********************************************************************************************/

@Service("supplementSubmissionService")
public class SupplementSubmissionServiceImpl implements SupplementSubmissionService {
  ...
  @Override
  public List<EgovMap> selectSupplementSubmissionJsonList(Map<String, Object> params) throws Exception {

    return supplementSubmissionMapper.selectSupplementSubmissionJsonList(params);
  }

  @Override
  public List<EgovMap> selectSupplementSubmissionItmList(Map<String, Object> params) throws Exception {
  ...
  @Override
  public List<EgovMap> chkSupplementStockList(Map<String, Object> params) throws Exception {
  ...
  @Override
  public EgovMap selectSupplementSubmissionView(Map<String, Object> params) throws Exception {

    return supplementSubmissionMapper.selectSupplementSubmissionView(params);
  }

  @Override
  public List<EgovMap> selectSupplementSubmissionItmView(Map<String, Object> params) throws Exception {

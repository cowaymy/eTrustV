...
public class SupplementBatchPaymentVO {
  ...
  public static SupplementBatchPaymentVO create(CSVRecord CSVRecord) {
    SupplementBatchPaymentVO vo = new SupplementBatchPaymentVO();

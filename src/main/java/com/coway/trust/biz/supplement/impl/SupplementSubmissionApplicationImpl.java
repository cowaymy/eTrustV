...
@Service("SupplementSubmissionApplication")
public class SupplementSubmissionApplicationImpl implements SupplementSubmissionApplication {
  ...
  @Override
  public void insertSupplementSubmissionAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params, List<String> seqs) {
  ...
  public void insertFile(int fileGroupKey, FileVO flVO, FileType flType, Map<String, Object> params,String seq) {
        ...
        int atchFlId = supplementSubmissionMapper.selectNextFileId();
        ...
        supplementSubmissionMapper.insertFileDetail(flInfo);
  ...
  @Override
  public void updateSupplementSubmissionAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params,List<String> seqs) {
    // TODO Auto-generated method stub

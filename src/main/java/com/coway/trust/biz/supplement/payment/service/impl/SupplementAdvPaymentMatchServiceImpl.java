...
public class SupplementAdvPaymentMatchServiceImpl extends EgovAbstractServiceImpl  implements SupplementAdvPaymentMatchService {
  ...
  public void saveAdvPaymentMapping(Map<String, Object> params) {
    ...
    if (returnList != null && returnList.size() > 0) {
      for (int i = 0; i < returnList.size(); i++) {
        ...
        supplementAdvPaymentMatchMapper.updSupplementOrdStage(ifMap);
      }
    }
  }

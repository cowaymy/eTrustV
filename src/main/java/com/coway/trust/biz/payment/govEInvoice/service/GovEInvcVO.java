...
public class GovEInvcVO {
	    ...
	    public void Invoice(Map<String, Object> mapValue) {
	        ...
	        PartyIdentificationId custBrnId = new PartyIdentificationId();
	        ...
	        custBrnId.setSchemeID("BRN");
	        custBrnId.setValue(mapValue.get("acccustPartyBrn")==null?"N/A":mapValue.get("acccustPartyBrn").toString());
	        custBrn.setId(custBrnId);

...
import com.coway.trust.biz.payment.billing.service.BillingRentalService;
...
public class BillingRantalServiceImpl extends EgovAbstractServiceImpl implements BillingRentalService {

	private static final Logger logger = LoggerFactory.getLogger(BillingRantalServiceImpl.class);

	@Value("${app.name}")
	private String appName;

	@Resource(name = "billingRantalMapper")
	private BillingRantalMapper billingRantalMapper;

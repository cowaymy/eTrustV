...
@Service("ctDutyAllowanceApplication")
public class CtDutyAllowanceApplicationImpl implements CtDutyAllowanceApplication {
	...
	@Override
	public void insertCtDutyAllowanceAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
	...
	@Override
	public void updateCtDutyAllowanceAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
	...
	@Override
	public void deleteCtDutyAllowanceAttachBiz(FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
		LOGGER.debug("params =====================================>>  " + params);

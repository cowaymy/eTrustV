...
@Service("smGmClaimApplication")
public class SmGmClaimApplicationImpl implements SmGmClaimApplication {
	...
	@Override
	public void insertSmGmClaimAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
	...
	@Override
	public void updateSmGmClaimAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
	...
	@Override
	public void deleteSmGmClaimAttachBiz(FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
		LOGGER.debug("params =====================================>>  " + params);
		if(CommonUtils.isEmpty(params.get("clmNo"))) {
			...
			fileService.removeFilesByFileGroupId(type, (int) params.get("atchFileGrpId"));
			smGmClaimService.deleteSmGmClaimExpItem(params);
			LOGGER.debug("expGrp =====================================>>  " + params.get("expGrp"));
			if("1".equals(params.get("expGrp"))) {
				smGmClaimService.deleteSmGmClaimExpMileage(params);
			}
			smGmClaimService.updateSmGmClaimExpTotAmt(params);
		}
	}

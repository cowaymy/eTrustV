...
@Service("codyClaimApplication")
public class CodyClaimApplicationImpl implements CodyClaimApplication {
	...
	@Override
	public void insertCodyClaimAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
	...
	@Override
	public void updateCodyClaimAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
	...
	@Override
	public void deleteCodyClaimAttachBiz(FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
		LOGGER.debug("params =====================================>>  " + params);
		if(CommonUtils.isEmpty(params.get("clmNo"))) {
			...
			fileService.removeFilesByFileGroupId(type, (int) params.get("atchFileGrpId"));
			codyClaimService.deleteCodyClaimExpItem(params);
			LOGGER.debug("expGrp =====================================>>  " + params.get("expGrp"));
			if("1".equals(params.get("expGrp"))) {
				codyClaimService.deleteCodyClaimExpMileage(params);
			}
			codyClaimService.updateCodyClaimExpTotAmt(params);
		}
	}

...
@Service("ctClaimApplication")
public class CtClaimApplicationImpl implements CtClaimApplication {
	...
	@Override
	public void insertCtClaimAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
	...
	@Override
	public void updateCtClaimAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
	...
	@Override
	public void deleteCtClaimAttachBiz(FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
		LOGGER.debug("params =====================================>>  " + params);

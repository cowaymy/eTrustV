...
import com.coway.trust.biz.eAccounting.staffClaim.impl.NewStaffClaimMapper;
import com.coway.trust.biz.eAccounting.staffClaim.impl.NewStaffClaimServiceImpl;
...
@Service("newStaffClaimService")
public class NewStaffClaimServiceImpl extends EgovAbstractServiceImpl implements NewStaffClaimService {

    private static final Logger logger = LoggerFactory.getLogger(NewStaffClaimServiceImpl.class);

    @Resource(name = "newStaffClaimMapper")
    private NewStaffClaimMapper newStaffClaimMapper;
...
//    private FileService fileService;
    ...
    public EgovMap getClaimNo() {
        return newStaffClaimMapper.getClaimNo();
    }

    @Override
    public EgovMap getCostCenter(Map<String, Object> params) {
        return newStaffClaimMapper.getCostCenter(params);
    }

    @Override
    public void insertClaimMaster(Map<String, Object> params) {
        newStaffClaimMapper.insertClaimMaster(params);
    }
...
//    @Override
    public void insertFile(int fileGroupKey, FileVO flVO, FileType flType, int userId, String claimUn, String claimSeq) {
        ...
        int atchFlId = newStaffClaimMapper.selectNextFileId();
        ...
        newStaffClaimMapper.insertFileDetail(flInfo);

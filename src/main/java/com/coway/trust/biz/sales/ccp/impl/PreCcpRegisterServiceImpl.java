...
public class PreCcpRegisterServiceImpl
  extends EgovAbstractServiceImpl
  implements PreCcpRegisterService {
  ...
  @Override
  @Transactional
  public int insertPreCcpSubmission( Map<String, Object> params )
    throws Exception {
  ...
  @Override
  @Transactional
  public int editRemarkRequest( Map<String, Object> params )
    throws Exception {
  ...
  public int confirmTransfer( Map<String, Object> params ) {
    ...
    int sum = chkList.stream().map( d -> Integer.parseInt( d.get( "transferQuota" ).toString() ) )
  ...
  @Override
  public String getCustId( Map<String, Object> params ) {
    return preCcpRegisterMapper.getCustId( params );
  }
}
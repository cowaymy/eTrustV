...
public class EKeyInApiServiceImpl extends EgovAbstractServiceImpl implements EKeyInApiService {
            ...
            for (EKeyInApiDto listData : homecareList) {
                ...
                if (CommonUtils.isNotEmpty(listData.getFraPreOrdId()) && 0 < listData.getFraPreOrdId() ){
                    ...
                    if (MapUtils.isNotEmpty(selecteKeyInDetailOrder)) {
                        ...
                        frame.setItmStkId(mattressItmStkId);                    //mattress itmStkId -> frame itmStkId select
    ...
    public EKeyInApiDto selectItmStkChangeInfo(EKeyInApiForm param) throws Exception {
        ...
        if( CommonUtils.isNotEmpty(param.getGu()) && param.getGu().equals("MATTRESS") ){//mattress product select
            param.setStkCtgryId(5707);
            param.setGu("MATTRESS");
...
//                priceInfo.put("promoDiscPeriodTp", selectPromoDesc.get("promoDiscPeriodTp"));
//                priceInfo.put("promoDiscPeriod", selectPromoDesc.get("promoDiscPeriod"));
...
//                priceInfo.put("normalPricePromo", normalRentalFees);
    ...
    public EKeyInApiDto selectNewCardInfo() throws Exception {
        ...
        selectNewCardInfo.setParamVal("-----BEGIN PUBLIC KEY-----" + selectNewCardInfo.getParamVal() + "-----END PUBLIC KEY-----");
    ...
    public EKeyInApiDto saveTokenLogging(EKeyInApiDto param) throws Exception {
        ...
        /*
         * Construct RefNO for tokenization's reference NN :: New Customer > New CRC :: NRIC EN :: Edit Customer > New
         * CRC :: NRIC + Cust ID EE :: Edit Customer > Edit CRC :: NRIC + Cust ID + Cust CRC ID
         */
        String r1 = "";
        String r2 = "";
        String r3 = "";
...
//                sys0070M.put("updDt", );
    ...
    public EKeyInApiDto insertEkeyIn(EKeyInApiDto param) throws Exception {
        ...
        if (CommonUtils.isEmpty(param.getOrderType())) {                        // Basic
            ...
            int mattressPreOrdId = insertEkeyInSal0213M(param.getMattress());   //★☆★☆INSERT SAL0213M
            int framePreOrdId = 0;
            ...
            if (CommonUtils.isNotEmpty(param.getFrame())) {
                ...
                framePreOrdId = insertEkeyInSal0213M(param.getFrame());         //★☆★☆INSERT SAL0213M
            }
...
//            hmc0011D.put("srvOrdId", );
            int saveCnt = eKeyInApiMapper.insertHMC0011D(hmc0011D);             //★☆★☆INSERT HMC0011D
            if (saveCnt == 0) {
                throw new ApplicationException(AppConstants.FAIL, "Insert Exception.");
            }
            ...
            saveCnt = eKeyInApiMapper.updateBndlIdSAL0213M(updateBndl);         //★☆★☆UPDATE SAL0213M
            if (saveCnt == 0) {
...
//            throw new ApplicationException(AppConstants.FAIL, "instct value does not exist.");
//        }
        if (CommonUtils.isEmpty(param.getCustId()) || param.getCustId() <= 0) {
            throw new ApplicationException(AppConstants.FAIL, "custId value does not exist.");
        }

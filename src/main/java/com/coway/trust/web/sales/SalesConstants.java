...
public class SalesConstants {
  ...
  public static final String APP_TYPE_CODE_TRIAL_RENTAL = "TRLREN"; // Rental
  ...
  public static final String APP_TYPE_CODE_TRIAL_RENTAL_FULL = "Trial Rental"; // Trial Rental
  ...
  public static final int APP_TYPE_CODE_ID_TRIAL_RENTAL = 7759; // Rental
  ...
  public static final int PROMO_APP_TYPE_CODE_ID_TRL_REN = 7761; // Trial Rental

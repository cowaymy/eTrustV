...
public class OwnershipTransferController {
    ...
    public ResponseEntity<List<EgovMap>> selectRootList(@RequestParam Map<String, Object> params, HttpServletRequest request, ModelMap model, SessionVO sessionVO) throws Exception {
    ...
    public ResponseEntity<ReturnMessage> getOrdId(@RequestParam Map<String, Object> params, ModelMap model, SessionVO sessionVO) throws Exception {
        LOGGER.info("params : {}", params);
    ...
    public String requestROT(@RequestParam Map<String, Object> params, ModelMap model,SessionVO sessionVO) throws Exception {
    ...
    public ResponseEntity<ReturnMessage> attachmentUpload(MultipartHttpServletRequest request, @RequestParam Map<String, Object> params, Model model, SessionVO sessionVO) throws Exception {
        ...
        List<EgovFormBasedFileVo> list = EgovFileUploadUtil.uploadFiles(request, uploadDir,
                File.separator + "sales" + File.separator + "ownershipTransfer", AppConstants.UPLOAD_MAX_FILE_SIZE, true);
        ...
        if(list.size() > 0) {
            ownershipTransferApplication.insertOwnershipTransferAttach(FileVO.createList(list), FileType.WEB_DIRECT_RESOURCE, params);
        }
    ...
    public ResponseEntity<ReturnMessage> attachmentUpdate(MultipartHttpServletRequest request, @RequestParam Map<String, Object> params, Model model, SessionVO sessionVO) throws Exception {
        ...
        if(list.size() > 0) {
            ownershipTransferApplication.updateOwnershipTransferAttach(FileVO.createList(list), FileType.WEB_DIRECT_RESOURCE, params);
        }
    ...
    /*
    @RequestMapping(value = "/getOrdDetails.do", method = RequestMethod.GET)
    public ResponseEntity<ReturnMessage> getOrdDetails(@RequestParam Map<String, Object> params, ModelMap model, SessionVO sessionVO) throws Exception {
        ...
        int ordId = 0;
        ordId = ownershipTransferService.getSalesOrdId((String) params.get("sOrdNo"));

        EgovMap orderDetail = new EgovMap();
        if(ordId != 0) {
            params.put("salesOrderId", ordId);
    ...
    */
    ...
    public String updateROT(@RequestParam Map<String, Object> params, ModelMap model,SessionVO sessionVO) throws Exception {
    ...
    public ResponseEntity<List<EgovMap>> selectRotCallLog(@RequestParam Map<String, Object> params, HttpServletRequest request, ModelMap model, SessionVO sessionVO) throws Exception {
        LOGGER.info("params : {}", params);
    ...
    public ResponseEntity<List<EgovMap>> selectRotHistory(@RequestParam Map<String, Object> params, HttpServletRequest request, ModelMap model, SessionVO sessionVO) throws Exception {
        LOGGER.info("params : {}", params);
    ...
    public ResponseEntity<ReturnMessage> saveRotCCP(@RequestBody Map<String, Object> params, Model model, SessionVO sessionVO) {
    ...
    public ResponseEntity<ReturnMessage> getAttachments(@RequestParam Map<String, Object> params, HttpServletRequest request, ModelMap model) throws Exception {

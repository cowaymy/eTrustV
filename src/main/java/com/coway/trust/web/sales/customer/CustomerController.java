...
//			message.setMessage(messageAccessor.getMessage(AppConstants.MSG_SUCCESS));
	...
	public String selectCustomerOrderView(@RequestParam Map<String, Object> params, ModelMap model)throws Exception{
		...
		if("REG".equals(rentStatus)  && "No".equals(icare) && "WP".equals(stkCategory) && rentInstNo.compareTo(BigDecimal.valueOf(6)) == 1 && apptypeId == 66 && valiOutStanding.compareTo(BigDecimal.valueOf(2)) == -1 && custtypeid == 964){
			valid = "Yes";
		}
		else{
			valid = "No";

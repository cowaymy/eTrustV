...
public class  HcMembershipQuotationController {

	private static Logger logger = LoggerFactory.getLogger(HcMembershipQuotationController.class);
	...
	public String main(@RequestParam Map<String, Object> params, ModelMap model, SessionVO sessionVO) {
		...
		return "homecare/sales/membership/hcMembershipQuotationList";
	}

	@RequestMapping(value = "/quotationList" ,method = RequestMethod.GET)
	public ResponseEntity<List<EgovMap>>  quotationList(@RequestParam Map<String, Object> params,HttpServletRequest request,Model mode, SessionVO sessionVO)	throws Exception {
	...
	public String mViewQuotation(@RequestParam Map<String, Object> params, ModelMap model) {
		...
		return "homecare/sales/membership/hcmViewQuotationPop";
	}
	...
	public String mNewQuotation(@RequestParam Map<String, Object> params, ModelMap model) {
    	...
    	return "homecare/sales/membership/hcmNewQuotationPop";
	}

	@RequestMapping(value = "/getPromoDetails" ,method = RequestMethod.GET)
	public ResponseEntity<List<EgovMap>>  getPromoDetails(@RequestParam Map<String, Object> params,HttpServletRequest request, Model mode)	throws Exception {
		...
		List<EgovMap>  list = membershipQuotationService.getPromoDetails(params);
	...
	public String mQuotationRawData(@RequestParam Map<String, Object> params, ModelMap model) {
		...
		return "homecare/sales/membership/hcmQuotationRawDataPop";
	}
	...
	public String mNewQuotationSavePop(@RequestParam Map<String, Object> params, ModelMap model) {
		...
		return "homecare/sales/membership/mNewQuotationSavePop";
	}
	...
	public String mFilterChargePop(@RequestParam Map<String, Object> params, ModelMap model) {
		...
		return "homecare/sales/membership/mFilterChargePop";
	}
	...
	*//**
	...
	public String initSrchMembershipQuotationPop(@RequestParam Map<String, Object> params, ModelMap model) {
		return "homecare/sales/membership/srchMembershipQuotationPop";
	}

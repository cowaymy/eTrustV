...
/*********************************************************************************************
 * DATE PIC VERSION COMMENT -------------------------------------------------------------------------------------------- 14/05/2024 TOMMY 1.0.1 - RE-STRUCTURE SupplementSubmissionController
 *
 *********************************************************************************************/
...
public class SupplementSubmissionController {
  ...
  public ResponseEntity<List<EgovMap>> selectSupplementSubmissionJsonList(@RequestParam Map<String, Object> params,
  ...
  public ResponseEntity<List<EgovMap>> selectSupplementSubmissionItmList(@RequestParam Map<String, Object> params)
      throws Exception {
  ...
  public ResponseEntity<EgovMap> selectExistSupplementSubmissionSofNo(@RequestParam Map<String, Object> params,
  ...
  public String supplementSubmissionItemSearchPop(@RequestParam Map<String, Object> params, ModelMap model)
      throws Exception {
  ...
  public ResponseEntity<List<EgovMap>> selectSupplementItmList(@RequestParam Map<String, Object> params)
      throws Exception {
  ...
  public ResponseEntity<List<EgovMap>> chkSupplementStockList(@RequestParam Map<String, Object> params,
      HttpServletRequest request) throws Exception {
  ...
  public ResponseEntity<ReturnMessage> supplementSubmissionRegister(@RequestBody Map<String, Object> params)
    ...
    try {
      ...
      LOGGER.info("############################ supplementSubmissionRegister - params: {}", params);
  ...
  public ResponseEntity<ReturnMessage> attachFileUpload(MultipartHttpServletRequest request,
    ...
    String subPath = File.separator + "supplement" + File.separator + "submission" + File.separator + year
    ...
    try {
      ...
      supplementSubmissionApplication.insertSupplementSubmissionAttachBiz(FileVO.createList(list),
  ...
  public String preOrderModifyPop(@RequestParam Map<String, Object> params, ModelMap model, SessionVO sessionVO)
      throws Exception {

    LOGGER.info("############################ supplementSubmissionViewApprovalPop - params: {}", params);
  ...
  public ResponseEntity<EgovMap> selectSupplementSubmissionView(@RequestParam Map<String, Object> params)
      throws Exception {
  ...
  public ResponseEntity<List<EgovMap>> selectSupplementSubmissionItmView(@RequestParam Map<String, Object> params)
      throws Exception {
  ...
  public ResponseEntity<ReturnMessage> updateSubmissionApprovalStatus(@RequestBody Map<String, Object> params)
      throws Exception {
    ReturnMessage message = new ReturnMessage();
    String msg = "";

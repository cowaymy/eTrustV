...
public class CommonPaymentController {
	...
	public ResponseEntity<List<EgovMap>> selectHTOrderInfoNonRental(@RequestParam Map<String, Object> params, ModelMap model) {
    ...
    public ResponseEntity<EgovMap> checkHTOrderOutstanding(@RequestParam Map<String, Object>params, ModelMap model) throws Exception {
    	EgovMap RESULT;

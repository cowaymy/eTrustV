...
////    	Map<String, ArrayList<Object>> formInfoMap1 = new HashMap<String, ArrayList<Object>>();
...
////    	List<EgovMap> resultList = commonPaymentService.savePayment(gridFormList,formList);
...
//
//    	Map<String, Object> gridList = (Map<String, Object>) params.get(AppConstants.AUIGRID_ALL); // 그리드 데이터 가져오기
//    	List<Object> formList = (List<Object>) params.get(AppConstants.AUIGRID_FORM); // 폼 객체 데이터 가져오기
//
...
//		List<EgovMap> resultList = mobilePaymentKeyInService.saveMobilePaymentKeyInNormalPayment(formInfo,gridList,key);

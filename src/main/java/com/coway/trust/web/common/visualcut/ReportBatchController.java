...
public class ReportBatchController {
	...
	public void TDBalanceReport() {
		...
		Map<String, Object> params = new HashMap<>();
		params.put(REPORT_FILE_NAME, "/visualcut/TDBalanceReport.rpt");// visualcut rpt file name.
		params.put(REPORT_VIEW_TYPE, "EXCEL"); // viewType
		params.put("V_TEMP", "TEMP");// parameter
		params.put(AppConstants.REPORT_DOWN_FILE_NAME,
	...
	public void OutrightPlusAging() {
		...
		Map<String, Object> params = new HashMap<>();
		params.put(REPORT_FILE_NAME, "/visualcut/OutrightPlusAging.rpt");// visualcut rpt file name.
		params.put(REPORT_VIEW_TYPE, "EXCEL"); // viewType
		params.put("V_TEMP", "TEMP");// parameter
		params.put(AppConstants.REPORT_DOWN_FILE_NAME,
	...
	public void adminProductivityCody() throws IOException {
		...
		Map<String, Object> params = new HashMap<>();
		params.put(REPORT_FILE_NAME, "/visualcut/AdminProductivityCody2.rpt");// visualcut rpt file name.
		params.put(REPORT_VIEW_TYPE, "PDF"); // viewType
		params.put(AppConstants.REPORT_DOWN_FILE_NAME,

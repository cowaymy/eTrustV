...
public class CommonController {
  ...
  public void export(HttpServletRequest request, HttpServletResponse response) throws IOException, URISyntaxException {
    ...
    if (data == null) {
      ...
      List<NameValuePair> bodyParams = URLEncodedUtils.parse(new URI("tempUrl?" + body), AppConstants.DEFAULT_CHARSET);
  ...
  public ResponseEntity<List<EgovMap>> selectStockLocationList2(@RequestParam Map<String, Object> params, ModelMap model) {
  ...
  public ResponseEntity<List<EgovMap>> selectStockLocationList3(@RequestParam Map<String, Object> params, ModelMap model) {

...
public class ClaimFileCrcCIMBHandler extends BasicTextDownloadHandler implements ResultHandler<Map<String, Object>> {
	...
	public ClaimFileCrcCIMBHandler(FileInfoVO fileInfoVO, Map<String, Object> params) {

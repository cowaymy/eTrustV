...
<script type="text/javaScript" language="javascript">
    ...
    $(document)
            .ready(
                    function() {
                        ...
                        rotCallLogGridID = AUIGrid.create("#callLog_grid_wrap",
                                rotCLColumnLayout, rotCLGridOption);
                        rotHistoryGridID = AUIGrid.create("#rotHist_grid_wrap",
                                rotHistColumnLayout, rotHistGridOption);
                        ...
                        if (chsStatus == "YELLOW") {
                            $('#chs_stus').append(
                                    "<span class='red_text'>" + chsStatus
                                            + "</span>");
                            $('#chs_rsn').append(
                                    "<span class='red_text'>" + chsRsn
                                            + "</span>");
                        } else if (chsStatus == "GREEN") {
                            $('#chs_stus').append(
                                    "<span class='black_text''>" + chsStatus
                                            + "</span>");
                            $('#chs_rsn').append(
                                    "<span class='black_text'>" + chsRsn
                                            + "</span>");
                        } else {
                            $('#chs_stus').append(
                                    "<span class='black_text''>" + chsStatus
                        ...
                        getUnitCombo(mst, 210, custUnitSelVal,
                                '_ordExistingCust');
                        ...
                        doGetCombo('/sales/ccp/getCcpStusCodeList', '',
                                ccpStus, '_statusEdit', 'S');

                        // CommonCombo.make('_incomeRangeEdit', '/sales/ccp/getLoadIncomeRange' , {editCcpId : ccpId}, selVal , optionModule);
                        doGetCombo('/sales/ccp/getCcpRejectCodeList', '', '',
                                '_rejectStatusEdit', 'S');
                        ...
                        $(".auto_file")
                                .append(
                                        "<label><input type='text' class='input_text' readonly='readonly' /><span class='label_text'><a href='#'>File</a></span></label>");
                                ...
                                .change(
                                        function() {
                                            ...
                                            var div = $(this).parents(
                                                    ".auto_file");
                                            var oriFileName = div.find(":text")
                                                    .val();

                                            for (var i = 0; i < attachmentList.length; i++) {
                                                if (attachmentList[i].atchFileName == oriFileName) {
                                                    update
                                                            .push(attachmentList[i].atchFileId);
                                                    console.log(JSON
                                                            .stringify(update));
                                                }
                                            }
                        ...
                        // General
                        $(
                                "#rotReqAS option[value='"
                                        + "${rotInfoMap.rotReqAs}" + "']")
                                .attr('selected', 'selected');
                        $(
                                "#rotReqRebill option[value='"
                                        + "${rotInfoMap.rotReqRebill}" + "']")
                                .attr('selected', 'selected');
                        $(
                        ...
                        // RPS Tab
                        $("#estmBillTypeCheckbox").attr({
                            "disabled" : "disabled",
                            "class" : "disabled"
                        });
                        $("#smsBillTypeCheckbox").attr({
                            "disabled" : "disabled",
                            "class" : "disabled"
                        });
                        $("#postBillTypeCheckbox").attr({
                            "disabled" : "disabled",
                            "class" : "disabled"
                        });
                        $("#btnThirdPartyOwnt").attr({
                            "disabled" : "disabled",
                            "class" : "disabled"
                        });
                        ...
                        if ("${rotInfoMap.rotAtchGrpId}" != null
                                && "${rotInfoMap.rotAtchGrpId}" != "") {
                            ...
                            fn_retrievAttachment("${rotInfoMap.rotAtchGrpId}",
                                    "rot");
                        }
    ...
    function fn_retrievAttachment(attachId, type) {
        ...
        Common
                .ajax(
                        "GET",
                        "/sales/ownershipTransfer/getAttachments.do",
                        {
                            attachId : attachId
                        },
                        function(result) {
                            ...
                            if (result.data) {
                                ...
                                if (type == "rot") {
                                    for (var i = 0; i < result.data.length; i++) {
                                        console
                                                .log("getAttachmentInfo :: attachList :: "
                                                        + i);
                                        var atchTdId = "atchId" + (i + 1);
                                        $("#attachTd")
                                                .append(
                                                        "<div class='auto_file2 auto_file3'><input type='text' class='input_text' readonly='readonly' name='" + atchTdId + "'/></div>");
                                        $(
                                                ".input_text[name='" + atchTdId
                                                        + "']").val(
                                                result.data[i].atchFileName);
                                    }
                                }
    ...
    function fn_atchViewDown(fileGrpId, fileId) {
        ...
        Common.ajax("GET", "/sales/ownershipTransfer/getAttachmentInfo.do",
                data, function(result) {
                    ...
                    if (result.fileExtsn == "jpg" || result.fileExtsn == "png"
                        ...
                        console.log(DEFAULT_RESOURCE_FILE + fileSubPath + '/'
                        ...
                        var fileSubPath = result.fileSubPath;
                        fileSubPath = fileSubPath.replace('\', ' / '');
                        console.log("/file/fileDownWeb.do?subPath="
    ...
    function getUnitCombo(mst, ctgryVal, selVal, comId) {
        unitCombo("/sales/ccp/getOrderUnitList", mst, ctgryVal, selVal, comId,
                'S');
    }
...
//              }
                ...
                if (ficoScre >= 350 && ficoScre <= 450) {
                    if (isHold == 0) {
                        ...
                        if (isAllowSendSMS() == true) {
                            ...
                            $("#_updSmsMsg").attr("disabled", false);
                            $("#_reasonCodeEdit").val("2177");
                            setSMSMessage('Pending', $(
                                    "#_reasonCodeEdit option:selected").text());
                        }
                    }
                } else if (ficoScre >= 451 && ficoScre <= 500) {
                ...
                Common.ajax("GET",
                        "/sales/ownershipTransfer/getFicoScoreByAjax", data,
                        function(result) {
    ...
    function isAllowSendSMS() {
        ...
        if (salesmanMemTypeID != 1 && salesmanMemTypeID != 2) {
            ...
            if (isValidMobileNo(editSalesManTelMobile) == false) {
                Common
                        .alert('<spring:message code="sal.alert.msg.salesmanNumInvalid" />');
                return false;
            }
        }
        return true;
    ...
    function setSMSMessage(status, remark) {
        ...
        var webSite = salesmanMemTypeID == '1' ? "hp.coway.com.my"
                : "cody.coway.com.my";
    ...
    function fn_saveRotCCPValidation() {
        ...
        if (null == $("#_statusEdit").val() || '' == $("#_statusEdit").val()) {
            Common
                    .alert("<spring:message code='sys.common.alert.validation' arguments='CCP Status'/>");
            return;
        } else {
            if ('6' == $("#_statusEdit").val()) {
                if (null == $("#_rejectStatusEdit").val()
                        || '' == $("#_rejectStatusEdit").val()) {
                    Common
                            .alert("<spring:message code='sys.common.alert.validation' arguments='CCP Reject Status'/>");
                    return;
                }
            }

            if ('6' == $("#_statusEdit").val()) { //|| '1' == $("#_statusEdit").val()
                if (null == $("#_reasonCodeEdit").val()
                        || '' == $("#_reasonCodeEdit").val()) {
                    Common
                            .alert("<spring:message code='sys.common.alert.validation' arguments='CCP Feedback Code'/>");
                    return;
                }
            }
        }
        ...
        if (sst == 5495 || sst == 5496) {
            ...
            Common.ajaxSync("GET", "/sales/ccp/countCallEntry", salData,
                    function(result) {
    ...
    function fn_saveRotCCP() {
        ...
        if (ccpAtchFlg > 0) {
            if ($("#ccpAtchFileGrpId").val() != null
                    && $("#ccpAtchFileGrpId").val() != "") {
                console.log("Update attachment");

                var formData = Common.getFormData("ccpForm");
                formData.append("atchFileGrpId", $("#ccpAtchFileGrpId").val());
                formData.append("update", JSON.stringify(update).replace(
                        /[\[\]\"]/gi, ''));

                Common.ajaxFile("/sales/ownershipTransfer/attachmentUpdate.do",
    ...
    function fn_retrieveRotCallLog() {
        Common.ajax("GET", "/sales/ownershipTransfer/selectRotCallLog.do", {
            rotId : rotId
        }, function(result) {
            console.log(result);
    ...
    function fn_saveCallLog() {
        ...
        if (addedItems.length <= 0) {
            ...
            Common.ajax("POST", "/sales/ownershipTransfer/saveRotCallLog.do",
                    GridCommon.getEditData(rotCallLogGridID), function(result) {
                        if (result.code == "00") {
                            Common.alert("Call Log save success.",
                                    fn_retrieveRotCallLog());
                        } else {
    ...
    <header class="pop_header">
        ...
        <ul class="right_opt">
            <li><p class="btn_blue2">
                    <a href="#" id="btnCloseUdp"><spring:message code="sal.btn.close" /></a>
                </p></li>
        </ul>
    </header>
    <!-- pop_header end -->
           ...
           <!-- ********************************************************************************** -->
            ...
            <article class="tap_area">
                ...
                <form action="#" id="ccpForm" method="post">
                    ...
                    <!--  from Basic -->
                    <input type="hidden" name="editOrdId" id="_editOrdId"
                        value="${orderDetail.basicInfo.ordId}"> <input
                        type="hidden" name="editAppTypeCode"
                        value="${orderDetail.basicInfo.appTypeCode }"> <input
                        type="hidden" name="editOrdStusId"
                        value="${orderDetail.basicInfo.ordStusId}"> <input
                        type="hidden" id="_editCustName"
                    ...
                    <input type="hidden" name="editSalesMemTypeId"
                        id="_editSalesMemTypeId" value="${salesMan.memType}"> <input
                        type="hidden" id="_editSalesManTelMobile"
                        name="editSalesManTelMobile" value="${salesMan.telMobile}">

                    <!-- from GSTCertInfo -->
                    <input type="hidden" name="editEurcFilePathName"
                        value="${orderDetail.gstCertInfo.eurcFilePathName}">

                    <!-- Cust Type Id  > Ccp Master Id -->
                    <input type="hidden" name="ccpMasterId" value="${ccpMasterId}"
                        id="_ccpMasterId">

                    <!-- from FieldMap -->
                    <input type="hidden" id="_ordUnitSelVal"
                        value="${fieldMap.ordUnitSelVal}"> <input type="hidden"
                        id="_rosUnitSelVal" value="${fieldMap.rosUnitSelVal}"> <input
                        type="hidden" id="_susUnitSelVal"
                        value="${fieldMap.susUnitSelVal}"> <input type="hidden"
                        id="_custUnitSelVal" value="${fieldMap.custUnitSelVal}">

                    <!-- from IncomMap -->
                    <input type="hidden" id="_rentPayModeId" name="rentPayModeId"
                        value="${incomMap.rentPayModeId}"> <input type="hidden"
                        id="_applicantTypeId" name="applicantTypeId"
                        value="${incomMap.applicantTypeId}">

                    <!-- from ccpInfoMap  -->
                    <input type="hidden" id="_ccpStusId" name="ccpStusId"
                        value="${ccpInfoMap.ccpStusId}"> <input type="hidden"
                        id="_ccpIncRngId" value="${ccpInfoMap.ccpIncomeRangeId}">
                    <input type="hidden" id="_ccpResnId" value="${ccpInfoMap.resnId}">

                    <input type="hidden" id="_ccpIsHold"
                        value="${ccpInfoMap.ccpIsHold}"> <input type="hidden"
                        id="_ccpIsSaman" value="${ccpInfoMap.ccpIsSaman}"> <input
                        type="hidden" id="_ccpIsLou" value="${ccpInfoMap.ccpIsLou}">

                    <!-- previous -->
                    <input type="hidden" id="_isPreVal">

                    <!-- cust ID  -->
                    <input type="hidden" id="_editCustId"
                        value="${orderDetail.basicInfo.custId}"> <input
                        type="hidden" id="ccpAtchFileGrpId" name="ccpAtchFileGrpId"
                        value="${ccpInfoMap.ccpAtchGrpId}"> <input type="hidden"
                        id="ccpRotId" name="ccpRotId" value="${rotId}">

                    <!-- calSaveForm Hidden Fields - Start -->
                    <input type="hidden" name="saveCcpId" id="_saveCcpId"
                        value="${ccpId}" /> <input type="hidden" name="ccpTotalScorePoint"
                        value="${fieldMap.totUnitPoint}"> <input type="hidden"
                        id="_saveCustTypeId" name="saveCustTypeId"
                        value="${orderDetail.basicInfo.custTypeId}"> <input
                        type="hidden" name="saveOrdId" id="_saveOrdId"
                        value="${orderDetail.basicInfo.ordId}"> <input
                        type="hidden" name="bndlId" id="_bndlId"
                        value="${orderDetail.basicInfo.bndlId}">

                    <!-- Ord Unit  -->
                    <input type="hidden" name="saveOrdUnit" id="_saveOrdUnit">
                    <input type="hidden" name="saveOrdCount"
                        value="${fieldMap.ordUnitCount }"> <input type="hidden"
                        name="saveOrdPoint" value="${fieldMap.orderUnitPoint}">

                    <!-- Avg ROS Mth -->
                    <input type="hidden" name="saveRosUnit" id="_saveRosUnit">
                    <input type="hidden" name="saveRosCount"
                        value="${fieldMap.rosCount}"> <input type="hidden"
                        name="saveRosPoint" value="${fieldMap.rosUnitPoint}">

                    <!-- Suspension/Termination  -->
                    <input type="hidden" name="saveSusUnit" id="_saveSusUnit">
                    <input type="hidden" name="saveSusCount"
                        value="${fieldMap.susUnitCount}"> <input type="hidden"
                        name="saveSusPoint" value="${fieldMap.susUnitPoint}">

                    <!-- Existing Customer -->
                    <input type="hidden" name="saveCustUnit" id="_saveCustUnit">
                    <input type="hidden" name="saveCustCount"
                        value="${fieldMap.custUnitCount}"> <input type="hidden"
                        name="saveCustPoint" value="${fieldMap.custUnitPoint}">

                    <!-- check box(sms) -->
                    <input type="hidden" name="isChkSms" id="_isChkSms"> <input
                        type="hidden" name="hiddenUpdSmsMsg" id="_hiddenUpdSmsMsg">
                    <input type="hidden" name="hiddenSalesMobile"
                        id="_hiddenSalesMobile">
                    ...
                    <table class="type1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                --> <c:forEach var="files"
                                        items="${ccpAttachment}" varStatus="st">
                                        <div class="auto_file2 attachment_file w100p">
                                            ...
                                            <label> <input type="text" class="input_text"
                                                readonly="readonly" value="${files.atchFileName}" /> <c:if
                                                    test="${ccpInfoMap.name eq 'Active'}">
                                                    <span class='label_text'><a href='#'>File</a></span>
                                                </c:if>
                                            </label>
                                        </div>
                                    </c:forEach> <c:if test="${fn:length(ccpAttachment) <= 0}">
                                        <c:if test="${ccpInfoMap.name eq 'Active'}">
                                            <div class="auto_file attachment_file w100p">
                                                <input type="file" title="file add" style="width: 300px"
                                                    id="ccpFile" name="ccpFile" />
                                            </div>
                                        </c:if>
                                    </c:if>
                                </td>
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.ordUnit" /></th>
                                    <td><select class="w100p" name="ordUnit" id="_ordUnit"></select>
                                    </td>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.count" /></th>
                                    <td><span><b>${fieldMap.ordUnitCount }</b></span></td>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.point" /></th>
                                    <td><span><b>${fieldMap.orderUnitPoint}</b></span></td>
                                </tr>
                                <tr>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.avgRosMth" /></th>
                                    <td><select class="w100p" name="ordMth" id="_ordMth"></select>
                                    </td>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.count" /></th>
                                ...
                                <tr>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.suspensionTermination" /></th>
                                    <td><select class="w100p" name="ordSuspen" id="_ordSuspen"></select>
                                    </td>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.count" /></th>
                                ...
                                <tr>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.existCust" /></th>
                                    <td><select class="w100p" name="ordExistingCust"
                                        id="_ordExistingCust"></select></td>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.count" /></th>
                                ...
                                <tr>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.totPoint" /></th>
                    ...
                    <article class="title_line">
                        <h3>
                            <spring:message code="sal.title.text.ccpResult" />
                        </h3>
                    </article>
                    ...
                    <table class="type1">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"><spring:message
                                        code="sal.title.text.ccpStatus" /></th>
                                <td><span><select class="w100p" name="statusEdit"
                                        id="_statusEdit"
                                        onchange="javascript : fn_ccpStatusChangeFunc(this.value)"></select></span>
                                </td>
                                <!--
                            ...
                            <td>
                             ...
                             -->
                                <th scope="row"><spring:message
                                        code="sal.title.text.rejStus" /></th>
                                <td><span><select class="w100p"
                                        name="rejectStatusEdit" id="_rejectStatusEdit"></select></span></td>
                                <th></th>
                                <td></td>
                            </tr>
                            <tr>
                                <th scope="row"><spring:message
                                        code="sal.title.text.ficoScore" /></th>
                                <td><span><input type="text" id="_ficoScore"
                                        name="ficoScore" value="${ccpInfoMap.ccpFico}"
                                        disabled="disabled" maxlength="10" class="w100p"></span></td>
                            ...
                            <tr>
                                ...
                                <td colspan="5"><span> <select class="w100p"
                                        name="reasonCodeEdit" id="_reasonCodeEdit"
                                        onchange="javascript: fn_chgFunFeedBack(this.value)">
                            ...
                            <tr>
                                <th scope="row"><spring:message
                                        code="sal.title.text.pncRem" /></th>
                                <td colspan="5"><textarea cols="20" rows="5" id="_pncRem"
                                        name="pncRem" maxlength="4000">${ccpInfoMap.ccpPncRem}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Need Agreement</th>
                                <td><span><input type="checkbox" id="agmReq"
                                        name="agmReq"
                                        <c:if test="${ccpInfoMap.ccpAgmReq eq '1'}">checked</c:if> /></span>
                                </td>
                                <th scope="row">Coway Template</th>
                                <td><span><input type="checkbox" id="cowayTemplate"
                                        name="cowayTemplate"
                                        <c:if test="${ccpInfoMap.ccpTemplate eq '1'}">checked</c:if> /></span>
                                </td>
                                <th scope="row"><spring:message
                                        code="sal.title.text.onHoldCcp" /></th>
...
<!--                            </tr> -->
                    ...
                    <div id="_smsDiv" style="display: none;">
                        <aside class="title_line">
                            <h2>
                                <spring:message code="sal.title.text.smsInfo" />
                            </h2>
                        </aside>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="2"><label><input type="checkbox"
                                            id="_updSmsChk" /><span><spring:message
                                                    code="sal.title.text.sendSmsQuest" /></span></label></td>
                                </tr>
                                <tr>
                                    <th scope="row"><spring:message
                                            code="sal.title.text.smsMsg" /></th>
                                    <td><textarea cols="20" rows="5" name="updSmsMsg"
                                            id="_updSmsMsg"></textarea></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><span id="_charCounter"><spring:message
                                                code="sal.title.text.totChars" /></span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <aside class="title_line">
                        <ul class="center_btns">
                            <li><p class="btn_blue2">
                                    <a href="#" id="save_rotCcpbtn">Save CCP</a>
                                </p></li>
                        </ul>
                    </aside>
            ...
            <article class="tap_area">
                ...
                <section class="tap_wrap">
                    <ul class="tap_type1 num4">
                        <li id="tabCT" class="on"><a href="#" class="on"><spring:message
                        ...
                        <section class="search_table">
                            <table class="type1">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><spring:message
                                                code="sal.text.addressDetail" /></th>
                                        <td colspan="3"><span id="txtMailAddrDtlOwnt">${rotInfoMap.mailAddr1}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.street" /></th>
                                        <td colspan="3"><span id="txtMailStreetOwnt">${rotInfoMap.mailAddr2}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.area" /></th>
                                        <td colspan="3"><span id="txtMailAreaOwnt">${rotInfoMap.mailArea}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.city" /></th>
                                        <td><span id="txtMailCityOwnt">${rotInfoMap.mailCity}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.postCode" /></th>
                                        <td><span id="txtMailPostcodeOwnt">${rotInfoMap.mailPostcode}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.state" /></th>
                                        <td><span id="txtMailStateOwnt">${rotInfoMap.mailState}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.country" /></th>
                                        <td><span id="txtMailCountryOwnt">${rotInfoMap.mailCountry}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="type1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span id="billingGrpNo">${rotInfoMap.billingGrp}</span>
                                        </td>
                                        <th scope="row">Billing Type</th>
                                        <td><input type="checkbox" id="smsBillTypeCheckbox"
                                            <c:if test="${rotInfoMap.billSms eq '1'}">checked</c:if> /><span
                                            class="txt_box">SMS</span> <input type="checkbox"
                                            id="postBillTypeCheckbox"
                                            <c:if test="${rotInfoMap.billPost eq '1'}">checked</c:if> /><span
                                            class="txt_box">Post</span> <input type="checkbox"
                                            id="estmBillTypeCheckbox"
                                            <c:if test="${rotInfoMap.billEstm eq '1'}">checked</c:if> /><span
                                            class="txt_box">E-Statement</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </section>
                        ...
                        <section class="search_table">
                            <table class="type1">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.name" /></th>
                                        <td><span id="txtContactNameOwnt">${rotInfoMap.cntcName}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.initial" /></th>
                                        <td><span id="txtContactInitialOwnt">${rotInfoMap.cntcInitial}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.gender" /></th>
                                        <td><span id="txtContactGenderOwnt">${rotInfoMap.cntcGender}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.nric" /></th>
                                        <td><span id="txtContactICOwnt">${rotInfoMap.cntcNric}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.dob" /></th>
                                        <td><span id="txtContactDOBOwnt">${rotInfoMap.cntcDob}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.race" /></th>
                                        <td><span id="txtContactRaceOwnt">${rotInfoMap.cntcRace}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.email" /></th>
                                        <td><span id="txtContactEmailOwnt">${rotInfoMap.cntcEmail}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.dept" /></th>
                                        <td><span id="txtContactDeptOwnt">${rotInfoMap.cntcDept}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.post" /></th>
                                        <td><span id="txtContactPostOwnt">${rotInfoMap.cntcPost}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.telM" /></th>
                                        <td><span id="txtContactTelMobOwnt">${rotInfoMap.telM}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.telR" /></th>
                                        <td><span id="txtContactTelResOwnt">${rotInfoMap.telR}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.telO" /></th>
                                        <td><span id="txtContactTelOffOwnt">${rotInfoMap.telO}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.telF" /></th>
                                        <td><span id="txtContactTelFaxOwnt">${rotInfoMap.telF}</span>
                                        </td>
                                        <th scope="row"></th>
                                        <td></td>
                                        <th scope="row"></th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="3"><input type="checkbox"
                                            id="btnThirdPartyOwnt"
                                            <c:if test="${rotInfoMap.is3rdParty eq '1'}">checked</c:if> />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <table class="type1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.customerId" /></th>
                                            <td><span id="txtThirdPartyIDOwnt">${rotInfoMap.paymode3rdPartyId}</span>
                                            </td>
                                            <th scope="row"><spring:message code="sal.text.type" /></th>
                                            <td><span id="txtThirdPartyTypeOwnt">${rotInfoMap.paymode3rdPartyCtype}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><spring:message code="sal.text.name" /></th>
                                            <td><span id="txtThirdPartyNameOwnt">${rotInfoMap.paymode3rdPartyName}</span>
                                            </td>
                                            <th scope="row"><spring:message
                                                    code="sal.text.nricCompanyNo" /></th>
                                            <td><span id="txtThirdPartyNRICOwnt">${rotInfoMap.paymode3rdPartyNric}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <section id="sctRentPayMode">
                                <table class="type1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.rentalPaymode" /></th>
                                            <td><span id="cmbRentPaymodeOwnt">${rotInfoMap.paymode}</span>
                                            </td>
                                            <th scope="row"><spring:message
                                                    code="sal.text.nricPassbook" /></th>
                                            <td><span id="txtRentPayICOwnt">${rotInfoMap.issuNric}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <section id="sctCrCard" class="blind">
                                ...
                                <table class="type1 mb1m">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.creditCardNumber" /></th>
                                            <td><span id="txtRentPayCRCNoOwnt">${rotInfoMap.custOriCrcNo}</span>
                                            </td>
                                            <th scope="row"><spring:message
                                                    code="sal.text.creditCardType" /></th>
                                            <td><span id="txtRentPayCRCTypeOwnt">${rotInfoMap.crcType}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.nameOnCard" /></th>
                                            <td><span id="txtRentPayCRCNameOwnt">${rotInfoMap.custCrcOwner}</span>
                                            </td>
                                            <th scope="row"><spring:message code="sal.text.expiry" /></th>
                                            <td><span id="txtRentPayCRCExpiryOwnt">${rotInfoMap.crcExpr}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.issueBank" /></th>
                                            <td><span id="txtRentPayCRCBankOwnt">${rotInfoMap.crcBank}</span>
                                            </td>
                                            <th scope="row"><spring:message code="sal.text.cardType" /></th>
                                            <td><span id="rentPayCRCCardTypeOwnt">${rotInfoMap.cardType}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <section id="sctDirectDebit" class="blind">
                                ...
                                <table class="type1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.accountNumber" /></th>
                                            <td><span id="txtRentPayBankAccNoOwnt">${rotInfoMap.ddAccNo}</span>
                                            </td>
                                            <th scope="row"><spring:message
                                                    code="sal.text.accountType" /></th>
                                            <td><span id="txtRentPayBankAccTypeOwnt">${rotInfoMap.ddAccType}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.accountHolder" /></th>
                                            <td><span id="txtRentPayBankAccNameOwnt">${rotInfoMap.custAccOwner}</span>
                                            </td>
                                            <th scope="row"><spring:message
                                                    code="sal.text.issueBankBranch" /></th>
                                            <td><span id="txtRentPayBankAccBankBranchOwnt">${rotInfoMap.ddIssueBankBrnch}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><spring:message
                                                    code="sal.text.issueBank" /></th>
                                            <td colspan=3><span id="txtRentPayBankAccBankOwnt">${rotInfoMap.ddBank}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table class="type1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="3"><span id="txtInstAddrDtlOwnt">${rotInfoMap.instAddr1}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.street" /></th>
                                        <td colspan="3"><span id="txtInstStreetOwnt">${rotInfoMap.instAddr2}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.area" /><span
                                            class="must">*</span></th>
                                        <td colspan="3"><span id="txtInstAreaOwnt">${rotInfoMap.instArea}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.city" /><span
                                            class="must">*</span></th>
                                        <td><span id="txtInstCityOwnt">${rotInfoMap.instCity}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.postCode" /><span
                                            class="must">*</span></th>
                                        <td><span id="txtInstPostcodeOwnt">${rotInfoMap.instPostcode}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.state" /><span
                                            class="must">*</span></th>
                                        <td><span id="txtInstStateOwnt">${rotInfoMap.instState}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.country" /><span
                                            class="must">*</span></th>
                                        <td><span id="txtInstCountryOwnt">${rotInfoMap.instCountry}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.name" /><span
                                            class="must">*</span></th>
                                        <td><span id="txtInstContactNameOwnt">${rotInfoMap.instCntcName}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.initial" /></th>
                                        <td><span id="txtInstContactInitialOwnt">${rotInfoMap.instCntcInitial}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.gender" /></th>
                                        <td><span id="txtInstContactGenderOwnt">${rotInfoMap.instCntcGender}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.nric" /></th>
                                        <td><span id="txtInstContactICOwnt">${rotInfoMap.instCntcNric}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.dob" /></th>
                                        <td><span id="txtInstContactDOBOwnt">${rotInfoMap.instCntcDob}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.race" /></th>
                                        <td><span id="txtInstContactRaceOwnt">${rotInfoMap.instCntcRace}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.email" /></th>
                                        <td><span id="txtInstContactEmailOwnt">${rotInfoMap.instCntcEmail}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.dept" /></th>
                                        <td><span id="txtInstContactDeptOwnt">${rotInfoMap.instCntcDept}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.post" /></th>
                                        <td><span id="txtInstContactPostOwnt">${rotInfoMap.instCntcPost}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.telM" /></th>
                                        <td><span id="txtInstContactTelMobOwnt">${rotInfoMap.instTelM}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.telR" /></th>
                                        <td><span id="txtInstContactTelResOwnt">${rotInfoMap.instTelR}</span>
                                        </td>
                                        <th scope="row"><spring:message code="sal.text.telO" /></th>
                                        <td><span id="txtInstContactTelOffOwnt">${rotInfoMap.instTelO}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message code="sal.text.telF" /></th>
                                        <td><span id="txtInstContactTelFaxOwnt">${rotInfoMap.instTelF}</span>
                                        </td>
                                        <th scope="row"></th>
                                        <td></td>
                                        <th scope="row"></th>
                            ...
                            <table class="type1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="3"><span id="cmbDSCBranchOwnt">${rotInfoMap.brnchName}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message
                                                code="sal.title.text.perferInstDate" /><span class="must">*</span></th>
                                        <td><span id="dpPreferInstDateOwnt">${rotInfoMap.preInstDt}</span>
                                        </td>
                                        <th scope="row"><spring:message
                                                code="sal.title.text.perferInstTime" /><span class="must">*</span></th>
                                        <td><span id="tpPreferInstTimeOwnt">${rotInfoMap.preInstTm}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><spring:message
                                            ...
                                            class="must">*</span></th>
                                        <td colspan=3><span id="txtInstSpecialInstructionOwnt">${rotInfoMap.instct}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <article class="tap_area">
                <form action="#" id="rotCLForm" method="post">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" title="" placeholder="" class=""
                                    id="newMemAccName" name="memAccId" /> <a href="#"
                                    class="search_btn" id="supplier_search_btn"> <img
                            ...
                            <tr>
                                ...
                                <td><input type="text" title="Call Date"
                                    placeholder="DD/MM/YYYY" class="j_date w100p" id="callDt"
                                    name="callDt" /></td>
                            </tr>
                            <tr>
                                <th scope="row">ROT Call Log Status</th>
                                <td><select id="callLogStus" name="callLogStus"
                                    class="w100p">
                            ...
                            <tr>
                                ...
                                <td><textarea cols="20" rows="5" id="callLogRem"
                                        name="callLogRem" maxlength="4000"
                                        placeholder="Enter up to 4000 characters"></textarea></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <aside class="title_line">
                        <ul class="center_btns">
                            <li><p class="btn_blue2">
                                    <a href="#" id="save_rotCLbtn">Save Call Log</a>
                                </p></li>
                        </ul>
                    </aside>
                </form>

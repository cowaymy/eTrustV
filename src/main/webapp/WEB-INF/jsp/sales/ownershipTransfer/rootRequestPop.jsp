...
<script type="text/javaScript">
    ...
    $(function() {
        ...
        $('#btnAddCRC').click(function() {
            ...
            Common.popupDiv("/sales/customer/customerCreditCardAddPop.do", {custId : vCustId, nric : $("#nricOwnt").val()}, null, true);
        });
        ...
        $('#liBillNewAddr').click(function() {
            Common.popupDiv("/sales/customer/updateCustomerNewAddressPop.do", {custId : $('#txtHiddenCustIDOwnt').val(), callParam : "ORD_REGISTER_BILL_MTH"}, null , true);
        });
...
//          $('#sctBillPrefer').removeClass("blind");
            ...
            if($('#typeIdOwnt').val() == '965') {
                //Company
                console.log("fn_setBillGrp 1 typeId : " + $('#typeIdOwnt').val());
                ...
                console.log("fn_setBillGrp 2 typeId : "+$('#typeIdOwnt').val());
                console.log("custCntcEmail : "+$('#txtContactEmailOwnt').val());
                console.log(FormUtil.isNotEmpty($('#txtContactEmailOwnt').val().trim()));
    ...
    function fn_doSaveReqOwnt() {
        ...
        Common.ajax("POST", "/sales/ownershipTransfer/saveRequest.do", $('#frmReqOwnt').serializeJSON(), function(result) {
            var msg = "Order Number : " + $("#salesOrdNo").val() + "<br/>Ownership successfully transferred."
            Common.alert('<spring:message code="sal.alert.msg.ownTransSum" />' + DEFAULT_DELIMITER + "<b>" + msg + "</b>", fn_selfClose("req"));
                        ...
                        <table class="type1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <select id="rotReason" name="rotReason" class="w100p">
                                        <c:forEach var="list" items="${requestReasonList}" varStatus="status">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="rotReqAS" name="rotReqAS" class="w100p">
                                    ...
                                    <td>
                                        <select id="rotReqRebill" name="rotReqRebill" class="w100p">
                                            <option value="1">YES</option>
                                            <option value="0">NO</option>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <select id="rotReqInvoiceGrp" name="rotReqInvoiceGrp" class="w100p">
                                            <option value="1">YES</option>
                                            <option value="0">NO</option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector2" name="fileSelector2" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector3" name="fileSelector3" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector4" name="fileSelector4" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector5" name="fileSelector5" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector6" name="fileSelector6" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector7" name="fileSelector7" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector8" name="fileSelector8" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector9" name="fileSelector9" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <div class="auto_file3 w100p">
                                            <input type="file" id="fileSelector10" name="fileSelector10" title="file add" />
                                            <!--
                                            <label>
                                                <input type='text' class='input_text' readonly='readonly' />
                                                <span class='label_text'><a href='#'>File</a></span>
                                ...
                                <table class="type1">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input id="custIdOwnt" name="txtCustID" type="text" title="" placeholder="Customer ID" class="" />
                                                <a class="search_btn" id="custBtnOwnt"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a>
                                            </td>
                                            <th scope="row"><spring:message code="sal.text.type" /></th>
                                            <td>
                                                <input id="custTypeNmOwnt" name="txtCustType" type="text" title="" placeholder="Customer Type" class="w100p" readonly />
            ...
            *****************************************************************************
                     -->
                            ...
                            <ul class="center_btns">
                              <li><p class="btn_blue"><a id="ordSaveBtn" href="#"><spring:message code="sal.btn.ok" /></a></p></li>
                            </ul>
                          </section>

...
//          $('#sctBillPrefer').removeClass("blind");
    ...
    function setInputFile2(){//인풋파일 세팅하기
        //$(".auto_fileOT").append("<label><input type='text' class='input_text' readonly='readonly' /><span class='label_text'><a href='#'>File</a></span></label><span class='label_text'><a href='#'>Add</a></span><span class='label_text'><a href='#'>Delete</a></span>");
    ...
    */
    ...
    function fn_doSaveReqOwnt() {
        ...
        Common.ajax("POST", "/sales/ownershipTransfer/saveRequest.do", $('#frmReqOwnt').serializeJSON(), function(result) {
            ...
            Common.alert('<spring:message code="sal.alert.msg.ownTransSum" />' + DEFAULT_DELIMITER + "<b>" + msg + "</b>", fn_selfClose);

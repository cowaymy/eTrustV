...
function fn_report(viewType){
	...
	var appType = "";
	var sortBy = "";
	var whereSQL = " AND som.BNDL_ID > 0 ";
	var extraWhereSQL = "";
	var orderBySQL = "";
	var custName = "";
	var runNo = 0;
    ...
    if(viewType == "PDF"){
    	...
    	$("#form #reportFileName").val("/sales/OrderMSOFList.rpt");
    }else if(viewType == "EXCEL"){
    	$("#form #viewType").val("EXCEL");
    	$("#form #reportFileName").val("/sales/OrderMSOFList_Excel.rpt");
    }
...
<h1><spring:message code="sal.title.text.ordReportMatSalesOrdFromMSofList" /></h1>
<ul class="right_opt">

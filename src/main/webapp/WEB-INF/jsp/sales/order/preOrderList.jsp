...
<ul class="right_btns">
    ...
    <c:if test="${(PAGE_AUTH.funcUserDefine3 == 'Y') or (SESSION_INFO.memberLevel == '4' and SESSION_INFO.userTypeId == '1')}">
        <li><p class="btn_blue"><a id="_btnFail" href="#">Update Status</a></p></li>
    </c:if>
	<c:if test="${(PAGE_AUTH.funcUserDefine1 == 'Y') or (SESSION_INFO.memberLevel == '4' and SESSION_INFO.userTypeId == '1')}">

...
<script type="text/javascript">
	...
	function createAUIitemGrid() {
        ...
        var columnLayout = [ {
                ...
                dataField : "payCnvrSrvCntrctRefNo",
    ...
    function fn_getCnvrItmJsonAjax(){
        Common.ajax("GET", "/sales/order/paymodeConvertViewItmJsonList",$("#gridForm").serialize(), function(result) {
...
<form id="gridForm" name="gridForm" method="GET">
    ...
    <input type="hidden" id="payCnvrId" name="payCnvrId" value="${cnvrInfo.payCnvrId}">

    <input type="hidden" id="payCnvrStusFrom" name="payCnvrStusFrom" value="${cnvrInfo.payCnvrStusFrom }">
    <input type="hidden" id="payCnvrStusTo" name="payCnvrStusTo" value="${cnvrInfo.payCnvrStusTo }">
</form>

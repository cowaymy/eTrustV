...
<script type="text/javaScript" language="javascript">
  ...
  function fn_loadPreOrderInfo(custId, nric) {
    ...
    }, '${preOrderInfo.itmStkId}', 'ordProudct', 'S', 'fn_setOptGrpClass');//product 생성
        ...
        <article class="tap_area">
          ...
          <section class="search_table">
            ...
            <form id="frmPreOrdReg" name="frmPreOrdReg" action="#" method="post">
              <input id="hiddenPreOrdId" name="preOrdId" type="hidden" value="${preOrderInfo.preOrdId}" /> <input id="hiddenCustId" name="custId" type="hidden" /> <input id="hiddenTypeId" name="typeId" type="hidden" /> <input id="hiddenCustCntcId" name="custCntcId" type="hidden" /> <input id="hiddenCustAddId" name="custAddId" type="hidden" /> <input id="hiddenRcdTms" name="rcdTms" type="hidden" value="${preOrderInfo.updDt}" />
              <aside class="title_line">
                <!-- title_line start -->
            ...
            <table class="type1">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <p><select id="exTrade" name="exTrade" class="w100p"></select></p> <a id="btnRltdNoEKeyIn" href="#" class="search_btn blind"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a>
                ...
                <tr>
                  ...
                  <td>
                    <select id="ordPromo" name="ordPromo" class="w50p" disabled></select>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <input id="ordPrice" name="ordPrice" type="text" title="" placeholder="Price/Rental Processing Fees (RPF)" class="w100p readonly" readonly /> <input id="ordPriceId" name="ordPriceId" type="hidden" /> <input id="normalOrdPrice" name="normalOrdPrice" type="hidden" /> <input id="normalOrdPv" name="normalOrdPv" type="hidden" />
                  </td>
                </tr>
                <tr>
                  <th scope="row">Rental Fee<span class="must">*</span></th>
                  <td>
                    <p><input id="ordRentalFees" name="ordRentalFees" type="text" title="" placeholder="" class="w100p readonly" readonly /></p>
                  </td>
                </tr>
                <tr>
                ...
                <tr style="display: none;">
                  ...
                  <td>
                    <input id="ordPv" name="ordPv" type="text" title="" placeholder="Point Value (PV)" class="w100p readonly" readonly /> <input id="ordPvGST" name="ordPvGST" type="hidden" />
                  </td>

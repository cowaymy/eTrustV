...
<script type="text/javascript">
	function fn_saveExchgCancel(){
	    Common.ajax("GET", "/sales/order/saveCancelReq.do", $("#sForm").serialize(), function(result){
	        ...
	        Common.alert("Product exchange request has been cancelled.", fn_success);
...
<h1>Order Exchange REMARK</h1>
<ul class="right_opt">
    <li id="mClose"><p class="btn_blue2"><a href="#" id="_close">CLOSE</a></p></li>
</ul>
...
<h2>REQUEST CANCEL CONFIRMATION</h2>
...
<ul class="center_btns">
    <li><p class="btn_blue2 big"><a href="#" onClick="fn_saveExchgCancel()">Cancel Request</a></p></li>
</ul>

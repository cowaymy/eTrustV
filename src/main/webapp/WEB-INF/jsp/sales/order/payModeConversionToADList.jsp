...
<script type="text/javaScript" language="javascript">
    ...
    $(document).ready(function(){
      ...
      //AUIGrid.setSelectionMode(myGridID, "singleRow");
        ...
        AUIGrid.bind(myGridID, "cellDoubleClick", function(event){
            ...
            Common.popupDiv("/payment/batchTokenizeDetailPop.do", $("#searchForm").serializeJSON(), null, true, 'detailPop');
        });
    });
    ...
    function fn_searchListAjax(){
        ...
        Common.ajax("GET", "/payment/searchBatchTokenizeList", $("#searchForm").serialize(), function(result) {
        	console.log(result)
    ...
    function fn_newConvert(){
        Common.popupDiv("/payment/paymodeConversionToAD.do", $("#detailForm").serializeJSON(), null, true, 'savePop');
    }

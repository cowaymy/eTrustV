        ...
        Common.ajax("GET", "/sales/customer/selectCustomerJsonList", {custId : _CUST_ID}, function(result) {
            ...
            if(result != null && result.length == 1) {
              ...
              //$('#srvPacId').val('${orderInfo.srvPacId}');
                ...
                doGetComboAndGroup2('/sales/order/selectProductCodeList.do', {stkType:stkType, srvPacId:'${orderInfo.basicInfo.srvPacId}'}, '${orderInfo.basicInfo.stockId}', 'ordProudct', 'S', 'fn_setOptGrpClass');//product 생성

...
<h1><spring:message code="sal.page.title.custBankAccMaintenance" /></h1>
<ul class="right_opt">
...
<tr>
    ...
    <p class="btn_sky"><a href="#" id="_confirm"><spring:message code="sal.text.confirm" /></a></p>
    </td>
</tr>
</tbody>
</table><!-- table end -->
...
<h3><spring:message code="sal.title.custBankAccList" /></h3>
</aside><!-- title_line end -->
<!-- ########## Bank Acc Grid Start ########## -->
<ul class="right_btns">
    <li><p class="btn_grid"><a href="#" id="_newBank"><spring:message code="sal.btn.addNewBankAcc" /></a></p></li> <!-- xml :   insertBankAccountInfo -->
</ul>

...
var emptyData = [];
    ...
    $(document).ready(function() {
      ...
      var selDdtChnl = $("#selCodeAccDdtChnl").val();
      if (selDdtChnl == "e-Mandate") {
        selDdtChnl = '3182';
      } else {
        selDdtChnl = '3181';
      }
      ...
      doGetComboCodeId('/sales/customer/selectDdlChnl.do', { isAllowForDd : '1' }, selDdtChnl, 'cmbDdtChnl', 'S', ''); //DEDUCTION CHANNEL

      doGetComboCodeId('/sales/customer/selectAccBank.do', {
          isAllowForDd : '1',
          ddlChnl : $('#cmbDdtChnl').val()
        }, selCodeAccBankId, 'bankCmbAccBankId', 'S', '');
...
<div id="popup_wrap" class="popup_wrap">
 ...
 <header class="pop_header">
  <!-- pop_header start -->
  <h1>
   <spring:message code="sal.page.title.editCustBankInfo" />
  </h1>
  <ul class="right_opt">
 ...
 <!-- pop_header end -->
 <input type="hidden" value="${detailbank.custAccTypeId}"
  id="selCodeAccType"> <input type="hidden"
  value="${detailbank.custAccBankId}" id="selCodeAccBankId"><input
  type="hidden" value="${detailbank.ddtChnl}" id="selCodeAccDdtChnl">C
 <section class="pop_body">
  <!-- pop_body start -->
  <form id="updForm">
   <!-- Form Start  -->
   <input type="hidden" value="${detailbank.custAccId }"
    name="bankCustAccId">
   <table class="type1">
    <!-- table start -->
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><input type="text" title="" placeholder="Account Number"
       class="w100p" readonly value="${detailbank.custAccNo}"
       maxlength="16" id="bankAccountNo" name="bankCustAccNo" /></td>
     </tr>
     <tr>
      <th scope="row"><spring:message code="sal.text.bankBranch" /></th>
      <td><input type="text" title="" placeholder="Bank Branch"
       class="w100p" value="${detailbank.custAccBankBrnch}"
       maxlength="16" name="bankCustAccBankBrnch" /></td>
      <th scope="row"><spring:message code="sal.text.accountOwner" /><span
       class="must">*</span></th>
      <td><input type="text" title="" placeholder="Account Owner"
       class="w100p" value="${detailbank.custAccOwner}"
       id="bankCustAccOwner" name="bankCustAccOwner" /></td>
     </tr>
     <tr>
      <th scope="row"><spring:message code="sal.text.remarks" /></th>
      <td colspan="3"><textarea cols="20" rows="5"
        name="bankCustAccRem">${detailbank.custAccRem}</textarea></td>
     </tr>
    </tbody>
   </table>
   <!-- table end -->
  ...
  <ul class="center_btns">
   <li><p class="btn_blue2 big">
     <a href="#" id="_updBtn"><spring:message code="sal.btn.update" /></a>
    </p></li>
   <li><p class="btn_blue2 big">
     <a href="#" id="_delBtn"><spring:message code="sal.btn.delete" /></a>
    </p></li>
  </ul>
 </section>
 <!-- pop_body end -->

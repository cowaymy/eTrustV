...
function fn_uploadFile() {
    ...
    Common.ajaxFile("/sales/customer/loyaltyHpCsvUpload", formData, function (result) {
...
function fn_closePop() {
    $("#loyaltyHpFileUploadClose").click();
}
...
<h1>Loyalty HP - File Upload</h1>
<ul class="right_opt">
    <li><p class="btn_blue2"><a id="loyaltyHpFileUploadClose" href="#">CLOSE</a></p></li>
</ul>
...
<!-- <article class="grid_wrap">grid_wrap start
  ...
  <ul class="center_btns mt20">
            ...
            <li><p class="btn_blue2 big"><a href="${pageContext.request.contextPath}/resources/download/sales/LoyaltyHpUploadTemplate.csv">Template Download</a></p></li>
        </ul>

...
<form id="insAddressForm" name="insAddressForm" method="POST">
    <input type="hidden" id="streetId" name="streetId" value="${detailaddr.streetId}">
    ...
    <colgroup>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="3">
                <input type="text" title="" id="mAddr1" name="mAddr1" placeholder="Address(1)" class="w100p" value="${detailaddr.add1}" />
                </td>
            </tr>
            <tr>
                <td colspan="3">
                <input type="text" title="" id="mAddr2" name="mAddr2" placeholder="Address(2)" class="w100p" value="${detailaddr.add2}" />
                </td>
            </tr>
            <tr>
                <th scope="row">Country<span class="must">*</span></th>
                <td>
                <input type="text" title="" id="mCountry" name="mCountry" placeholder="" class="w100p readonly" readonly="readonly"  value="${detailaddr.country}"/>
                </td>
                <th scope="row">Region<span class="must">*</span></th>
                <td>
                <input type="text" title="" id="mState" name="mState" placeholder="" class="w100p readonly" readonly="readonly" value="${detailaddr.region1}" />
                </td>
            </tr>
            <tr>
                <th scope="row">City<span class="must">*</span></th>
                <td>
                <input type="text" title="" id="mCity" name="mCity" placeholder="" class="w100p readonly" readonly="readonly"  value="${detailaddr.region2}"/>
                </td>
                <th scope="row">Town<span class="must">*</span></th>
                <td>
                <input type="text" title="" id="mTown" name="mTown" placeholder="" class="w100p readonly" readonly="readonly"  value="${detailaddr.locality}"/>
                </td>
            </tr>
            <tr>
                <th scope="row">Street<span class="must">*</span></th>
                <td>
                <input type="text" title="" id="mStreet" name="mStreet" placeholder="" class="w100p readonly" readonly="readonly" value="${detailaddr.street}"/>
                </td>
                <th scope="row">PostCode<span class="must">*</span></th>
                <td>
                <input type="text" title="" id="mPostCd" name="mPostCd" placeholder="" class="w100p readonly" readonly="readonly" value="${detailaddr.postCode}"/>
                </td>
            </tr>
            <tr>

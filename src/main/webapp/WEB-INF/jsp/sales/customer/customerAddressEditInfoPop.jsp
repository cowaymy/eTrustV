    ...
    <colgroup>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="3">
                <input type="text" title="" id="addrDtl" name="addrDtl" placeholder="eg. NO 10/UNIT 13-02-05/LOT 33945" class="w100p" value="${detailaddr.addrDtl}"  maxlength="100"/>
                </td>
            </tr>
            <tr>
                <th scope="row" ><spring:message code="sal.text.street" /></th>
                <td colspan="3">
                <input type="text" title="" id="streetDtl" name="streetDtl" placeholder="eg. TAMAN/JALAN/KAMPUNG" class="w100p" value="${detailaddr.street}"  maxlength="100"/>
                </td>
            </tr>
            <tr>

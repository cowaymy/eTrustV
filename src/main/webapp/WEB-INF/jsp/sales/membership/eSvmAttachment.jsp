...
<tr>
    <th scope="row">NRIC / CRC front copy</th>
    <td id="tdPayFile">
        <div class='auto_file2 auto_file3'>
...
<tr>
    <th scope="row">NRIC / CRC back copy</th>
    <td id="tdTrFile">
        <div class='auto_file2 auto_file3'>
...
<tr>
    <th scope="row">Transaction Slip / PNP Slip / MOTO / MOTO IPP & etc.</th>
    <td id="tdOtherFile">
        <div class='auto_file2 auto_file3'>

...
<div class="side_btns">
<ul class="left_btns">
    <li><p class="btn_blue"><a href="#" onclick="javascript:fn_doPrint()">Quotation Download</a></p></li>
</ul>

<ul class="right_btns">
    <li><p class="btn_grid"><a href="#"  onclick="javascript:fn_doViewQuotation()">View Quotation</a></p></li>
</ul>
</div>

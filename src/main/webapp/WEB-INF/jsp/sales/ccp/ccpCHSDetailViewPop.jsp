...
var viewColumnLayout = [ {
    ...
    dataField : "chsStus",
    headerText : "CHS_Status"
}, {
    dataField : "chsRsn",
    headerText : "CHS_Reason"
...
$(document).ready(function () {
    viewGridID = AUIGrid.create("#CHS_view_grid_wrap", viewColumnLayout, viewGridPros);
    ...
    $('#excelDown').click(function() {
        GridCommon.exportTo("CHS_view_grid_wrap", 'xlsx', 'CHS File Upload List');
    });


    AUIGrid.setGridData(viewGridID, $.parseJSON('${chsBatchItem}'));
});
...
<article class="grid_wrap" id="CHS_view_grid_wrap"><!-- grid_wrap start -->

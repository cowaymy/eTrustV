    ...
    //    fn_allGridResize();
        ...
        $("#_saveBtn").click(function() {
            ...
            if(fn_saveValidation() == false){
                ...
                Common.ajax("POST", "/sales/ccp/insertRentalAgreement.do", data, function(result){
...
function createAUIGrid11() {
    ...
    function fn_selectOrderJsonList(){
    	$.ajax({
            ...
            type : "GET",
            url : getContextPath() + "/sales/ccp/getRentalOrderId",
            contentType: "application/json;charset=UTF-8",
            crossDomain: true,
            data: {salesOrderNo : '${orderDetail.basicInfo.ordNo}'},
            dataType: "json",
  ...
  //Consignment Check false
    ...
    function fn_saveValidation(){
        ...
        //문서 양 숫자 체크
        /* if($("#_govAgQty").val() <= -1){
            Common.alert('Please fill in No. of Copies');
            return false;
        } */
        ...
        //시작 날짜 종료날짜 비교
        if($("#_govAgStartDt").val() > $("#_govAgEndDt").val()){
            Common.alert('* Please Check Contract Commencement Date cannot bigger than Contract Expiry Date.');
            return false;
        }
...
<input id="salesOrderNo" name="salesOrderNo" type="hidden" value="${orderDetail.basicInfo.ordNo}">
...
<tr>
    ...
    <!-- <th scope="row">No. of copies<span class="must">*</span></th>
    <td>
    <input type="text" id="_govAgQty" name="govAgQty" class="w100p" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
    </td> -->
...
<%-- <tr>
    ...
    <td colspan="4"><textarea cols="20"  name="agreementMsg" id="_agreementMsg" ></textarea></td>
</tr> --%>
<tr>
    <th scope="row">Remarks<span class="must">*</span></th>
    <td colspan="4"><textarea cols="20" name="agreementAgmRemark" id="_agreementAgmRemark"></textarea></td>
</tr>
</tbody>
</table><!-- table end -->

...
function fn_searchNewOrderPop(){
  ...
  //  fn_getOrderId(inputNum);
    ...
    if(isRtn == true){
    	Common.popupDiv("/sales/ccp/newCcpRenAgrSearchResultPop.do", $("#_searchForm").serializeJSON(), null , true , '_newInsDiv');
    }
...
<form  method="post" id="_searchForm" onsubmit="retun false;">

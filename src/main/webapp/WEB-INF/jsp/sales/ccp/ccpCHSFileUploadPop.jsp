...
var excelLayout = [
                   {dataField:"custId" ,headerText:"Cust_ID ",width:200 ,height:30},
                   {dataField:"month" ,headerText:"MM ",width:120 ,height:30},
                   {dataField:"year" ,headerText:"YYYY ",width:120 ,height:30},
                   {dataField:"chsStatus" ,headerText:"CHS_Status ",width:120 ,height:30},
                   {dataField:"chsRsn" ,headerText:"CHS_Reason ",width:120 ,height:30}
                   ];
var gridPros = {
        // 페이지 설정
        usePaging : true,
...
function fn_uploadFile() {
    ...
    Common.ajaxFile("/sales/ccp/excelUpload", formData, function (result) {
...
<h2>Customer Health Score File Upload</h2>
...
<article class="grid_wrap"><!-- grid_wrap start -->
  ...
  <ul class="center_btns mt20">
            ...
            <li><p class="btn_blue2 big"><a id="excelDown">Templete Download</a></p></li>
        </ul>

...
<script type="text/javaScript" language="javascript">
  ...
  $(document).ready(
    function() {
    	 $("#modKeyInBranch").prop("readonly", true);
         $("#modKeyInBranch").attr("class", "readonly");
    var tabNm = 'BSC';
    fn_changeTab(tabNm);
      if ("${memType}" == "2") {
        TAB_NM = 'CNT';
  ...
  function fn_validBasicInfo() {
    ...
    if (APP_TYPE_ID == '66' && CUST_TYPE_ID == '965' && PV_MONTH == '0' && PV_YEAR == '0') {
        ...
        if ($("#modAgreementType option:selected").index() <= 0) {
            isValid = false;
            msg += 'Please select the Agreement Type';
        }
  ...
  function fn_doSaveBasicInfo() {
    ...
    Common
        .ajax(
            "POST",
            "/sales/order/updateCcpOrderBasinInfo.do",
      ...
      <tbody>
       <tr>
        ...
        <td><input id="modSalesmanCd" name="salesmanCd" type="text"
         title="" placeholder="Salesman Code" class=""  disabled/> </td>
       </tr>
       <tr>
        <th scope="row"><spring:message code="sal.text.refNo" /></th>
        <td><input id="modOrdRefNo" name="ordRefNo" type="text"
         title="" placeholder="Reference Number" class="w100p"  disabled/></td>
        <th scope="row"><spring:message
       ...
       <tr>
        ...
        <td><input id="modOrdPoNo" name="ordPoNo" type="text"
         title="" placeholder="PO Number" class="w100p" disabled /></td>
       ...
       <tr>
        <th scope="row"><spring:message
          code="sal.text.keyInBranch" /></th>
        <td><input id="modKeyInBranch" name="keyInBranch" type="text"
         title="" placeholder="Key In Branch" class="readonly" readonly /></td>
        <th scope="row"><spring:message
       ...
       <tr>
        ...
        <td rowspan="3"><textarea id="modOrdRem" name="ordRem"
          cols="20" rows="5" disabled></textarea></td>
        <th scope="row"><spring:message

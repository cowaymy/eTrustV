...
<tr>
    ...
    <td>
    <label><input type="radio" name="cntcGender" value="M" <c:if test="${dealerCntTop.gender eq 'M' }">checked</c:if>/><span>Male</span></label>
...
<ul class="center_btns">
    <li><p class="btn_blue2 big"><a href="#" id="_saveBtn">Save Contact</a></p></li>
</ul>

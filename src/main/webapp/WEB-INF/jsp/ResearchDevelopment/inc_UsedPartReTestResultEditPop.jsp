...
<script type="text/javascript">
  ...
  function fn_getASRulstSVC0004DInfo() {
    Common.ajax("GET", "/ResearchDevelopment/getASRulstSVC0004DInfo1", {
    ...
    <dl>
        ...
        <table class="type1">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type="hidden" title="" placeholder="" class="" id='ddlDSCCode' name='ddlDSCCode' value='${BRANCH_ID}' />
              <input type="text" title="" placeholder="" class="readonly w100p" id='ddlDSCCodeText' name='ddlDSCCodeText' value='${BRANCH_NAME}' /></td>

              <th scope="row"><spring:message code='service.grid.CTCode' /><span id='m7' name='m7' class="must" style="display: none">*</span></th>
              <td><input type="hidden" title="" placeholder="ddlCTCode" class="" id='ddlCTCode' name='ddlCTCode' />
              <input type="text" title="" placeholder="" class="readonly w100p" id='ddlCTCodeText' name='ddlCTCodeText' /> </td>
                </select></td>
            </tr>
             <!-- <tr>
            ...
            <th scope="row">Product Genuine<span id='m5' name='m5' class="must" style="display: none">*</span></th>
              ...
              <th scope="row">Manufacturing Date <span id='m20' name='m20' class="must" style="display: none">*</span></th>
              <td><input type="text" title="Manufacturing Date" id='manufacDate' name='manufacDate' placeholder="DD/MM/YYYY" class="readonly j_date" onChange="fn_chkDt('#manufacDate')" /></td>
            </tr>
            <tr>
      ...
      <dd id='defEvt_div' style="display: none">
        ...
        <th scope="row"><spring:message code='service.text.defTyp' /><span id='m9' name='m9' class="must" style="display:none">*</span></th>
                <td><input type="text" title="" placeholder="" disabled="disabled" id='def_type' name='def_type'  class="" onblur="fn_getASReasonCode2(this, 'def_type' ,'387')" onkeyup="this.value = this.value.toUpperCase();"/><a class="search_btn" id="DT" name="DT" onclick="fn_dftTyp('DT')"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a> <input type="hidden" title="" placeholder="" id='def_type_id' name='def_type_id'  class="" /> <input type="text" title="" placeholder="" id='def_type_text' name='def_type_text' class="" disabled style="width:60%;"/></td>
         </tr>
      <tr>

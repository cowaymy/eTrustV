...
function fn_reqstSubmit() {
    ...
    /* console.log("checkMemCode: " + checkMemCode);
    console.log("checkMemCode_memCode: " + "${memCode}");
    console.log("checkMemCode_userName: " + "${userName}");
    console.log("checkMemCode_requestCategory: " + "${requestCategory}");
    console.log("checkMemCode_caseCategory: " + "${caseCategory}");
    console.log("checkMemCode_remark1: " + "${remark1}");
    console.log("checkMemCode_effectDt: " + "${effectDt}"); */
    if(checkMemCode) {
    	/* Common.ajax("POST", "/organization/checkExistMemCode.do?_cacheId=" + Math.random(), {memCode:"${memCode}", userName:"${userName}", caseCategory:"${caseCategory}"}, function(result) { */
            ...
            if(result.data > 0) {
            	...
            	Common.popupDiv("/organization/registrationMsgPop.do", requestResultM, null, true, "registrationMsgPop");
            	$("#popup_wrap").remove();
            }
        });
    }
    /* if(checkMemCode) {
        Common.popupDiv("/organization/registrationMsgPop.do", "memCode", null, true, "registrationMsgPop");
    } */
}
</script>
...
<ul class="right_btns">
    ...
    <li><p class="btn_grid"><a href="#" id="lineDel_btn"><spring:message code="sys.btn.delete" /></a></p></li>
</ul>
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a href="#" id="submit"><spring:message code="sys.btn.submit" /></a></p></li>
</ul>

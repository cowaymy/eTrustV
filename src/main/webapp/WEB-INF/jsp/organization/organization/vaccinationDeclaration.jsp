...
<form id="agreementForm" style="width: 100%">
    ...
    <div id="agreementPDF" style="height: 450px">
        <script>PDFObject.embed("/resources/report/prd/organization/NoticeofSafetyComplianceforNon-VaccinatedIndividual.pdf", "#agreementPDF");</script>
    </div>

    <div id="dlPDF" style="padding-left: 5%; padding-right: 5%">
        <b><font size="4">Please tap on the icon to view the declaration:</font></b>
        <a href="/resources/report/prd/organization/NoticeofSafetyComplianceforNon-VaccinatedIndividual.pdf">

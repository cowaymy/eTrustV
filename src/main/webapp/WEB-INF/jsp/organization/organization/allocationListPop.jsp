...
<div id="popup_wrap" class="popup_wrap">
 ...
 <section class="pop_body">
  ...
  <ul class="center_btns mt20">
   <li><p class="btn_blue2">
     <a href="#" onclick="javascript:fn_AllocationConfirm()">Allocation Confirm</a>
    </p></li>
  </ul>
 </section>
 <!-- pop_body end -->

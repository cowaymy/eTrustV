                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3"><select id="reportType" name="reportType" style="width:300px;">
                            ...
                            <option value="2">Loyalty HP Status HP - SM report (excel)</option>
                            <option value="3">Loyalty HP Status HP - HM report (excel)</option>
                        </select></td>
                    </tr>
                    <tr id="orgCodeSelect" name="orgCodeSelect" style="display: none;">
                        <th scope="row">Org Code</th>
                        <td colspan="2">
                            <select class="w50p" id="cmbOrgCode" name="cmbOrgCode" multiple="multiple"></select>
                        </td>
                    </tr>
                </tbody>
            </table>

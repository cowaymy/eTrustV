...
function fn_memberSave(){
                ...
                Common.ajax("POST", "/organization/memberBranchUpdate",  jsonObj, function(result) {
...
<tr>
    ...
    <td>
    <select class="w100p" id="memberType" name="memberType" disabled="disabled">
...
<tr>
    ...
    <td colspan="3">
    <input type="text" title="" id="memberNm" name="memberNm" placeholder="Member Name"  readonly class="w100p"  value="<c:out value="${memberView.name1}"/>"/>
    </td>
    <th scope="row">Joined Date<span class="must">*</span></th>
    <td>
    <input type="text" title="Create start Date" id="joinDate" name="joinDate" placeholder="DD/MM/YYYY" readonly class="j_date"  disabled="disabled" value="<c:out value="${memberView.c30}"/>"/>
    </td>
</tr>
<tr>
    <th scope="row">Gender<span class="must">*</span></th>
    <td>
    <label><input type="radio" name="gender" id="gender_m" value="M" disabled="disabled"/><span>Male</span></label>
    <label><input type="radio" name="gender" id="gender_f" value="F" disabled="disabled"/><span>Female</span></label>
    </td>
    <th scope="row">Date of Birth<span class="must">*</span></th>
    <td>
    <input type="text" title="Create start Date" id="Birth" name="Birth"placeholder="DD/MM/YYYY" class="j_date" disabled="disabled" value="<c:out value="${memberView.c29}"/>" />
    </td>
    <th scope="row">Race<span class="must">*</span></th>
    <td>
    <select class="w100p" id="cmbRace" name="cmbRace" disabled="disabled">
    </select>
    </td>
</tr>
<tr>
    ...
    <td>
    <input type="text" title="" placeholder="NRIC (New)" id="nric" name="nric" class="w100p" readonly/>
    </td>
    <th scope="row">Marrital Status<span class="must">*</span></th>
    <td>
    <select class="w100p" id="marrital" name="marrital" disabled="disabled">
    </select>
    </td>
</tr>
<%-- <tr>
...
<tr>
    <th scope="row">Email</th>
    <td colspan="5">
    <input type="text" title="" placeholder="Email" class="w100p" id="email" name="email" readonly/>
    </td>
</tr>
<tr>
    <th scope="row">Mobile No.</th>
    <td>
    <input type="text" title="" placeholder="Numberic Only" class="w100p" id="mobileNo" name="mobileNo" readonly/>
    </td>
    <th scope="row">Office No.</th>
    <td>
    <input type="text" title="" placeholder="Numberic Only" class="w100p"  id="officeNo" name="officeNo" readonly/>
    </td>
    <th scope="row">Residence No.</th>
    <td>
    <input type="text" title="" placeholder="Numberic Only" class="w100p" id="residenceNo"  name="residenceNo" readonly/>
    </td>
</tr>
<tr>
    ...
    <input type="text" title="" placeholder="Sponsor's Code" class="w100p" id="sponsorCd" name="sponsorCd" readonly/>
    ...
    <td>
    <input type="text" title="" placeholder="Sponsor's Name" class="w100p"  id="sponsorNm" name="sponsorNm" readonly/>
    </td>
    <th scope="row">Sponsor's NRIC</th>
    <td>
    <input type="text" title="" placeholder="Sponsor's NRIC" class="w100p" id="sponsorNric" name="sponsorNric" readonly/>
    </td>
</tr>
<tr>
    ...
    <td>
    <select class="w100p disabled"  id="transportCd" name="transportCd" disabled="disabled">
    </select>
    </td>
</tr>
<tr>
    ...
    <td colspan="5">
    <input type="text" title="" placeholder="e-Approval Status" class="w100p"  readonly/>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td colspan="2">
    <select class="w100p" id="course" name="course" disabled="disabled">
    </select>
    </td>
    <th scope="row">Total Vacation</th>
    <td colspan="2">
    <input type="text" title="" placeholder="Total Vacation" class="w100p"  readonly/>
    </td>
</tr>
<tr>
    ...
    <td colspan="2">
    <input type="text" title="" placeholder="Remain Vacation" class="w100p" readonly/>
    </td>
</tr>
<tr>
    ...
    <td colspan="2">
    <select class="w100p" id="inputSubDept" name="inputSubDept" disabled="disabled">
        <option selected>Choose One</option>
...
<tr>
    ...
    <td>
    <select class="w100p" id="issuedBank" name="issuedBank" disabled="disabled">
    </select>
    </td>
    <th scope="row">Bank Account No<span class="must">*</span></th>
    <td>
    <input type="text" title="" placeholder="Bank Account No" class="w100p" id="bankAccNo"  name="bankAccNo" readonly/>
    </td>
</tr>
</tbody>
</table><!-- table end -->
...
<tr>
    ...
    <td>
    <select class="w100p" id="educationLvl" name="educationLvl" disabled="disabled">
    </select>
    </td>
    <th scope="row">Language</th>
    <td>
    <select class="w100p" id="language" name="language" disabled="disabled">
    </select>
    </td>
</tr>
</tbody>
...
<tr>
    ...
    <td>
    <input type="text" title="" placeholder="TR No." class="w100p" id="trNo" name="trNo" readonly/>
    </td>
</tr>
</tbody>
</table><!-- table end -->
...
<tr>
    ...
    <span><c:out value="${PAExpired.agExprDt}" /></span> 
...
<tr>
    ...
    <td>
    <input type="text" readonly title="" placeholder="MCode" class="w100p" id="spouseCode" name="spouseCode"  value="<c:out value="${memberView.spouseCode}"/> "/>
    </td>
    <th scope="row">Spouse Name</th>
    <td>
    <input type="text" readonly title="" placeholder="Spouse Nam" class="w100p" id="spouseName" name="spouseName" value="<c:out value="${memberView.spouseName}"/> "/>
    </td>
    <th scope="row">NRIC / Passport No.</th>
    <td>
    <input type="text" readonly title="" placeholder="NRIC / Passport No." class="w100p" id="spouseNRIC" name="spouseNRIC" />
    </td>
</tr>
<tr>
    <th scope="row">Occupation</th>
    <td>
    <input type="text" readonly title="" placeholder="Occupation" class="w100p" id="spouseOcc" value="<c:out value="${memberView.spouseOcpat}"/> " />
    </td>
    <th scope="row">Date of Birth</th>
    <td>
    <input type="text" readonly title="" placeholder="DD/MM/YYYY" class="j_date" id="spouseDOB" name="spouseDOB" disabled="disabled" value="<c:out value="${memberView.c58}"/> " />
    </td>
    <th scope="row">Contact No.</th>
    <td>
    <input type="text" readonly title="" placeholder="Contact No. (Numberic Only)" class="w100p" id="spouseContat" name="spouseContat" value="<c:out value="${memberView.spouseTelCntc}"/> " />
    </td>
</tr>
</tbody>
</table><!-- table end -->
        ...
        <col style="width:*" />
         ...
         <tbody>
            <tr>
                ...
                <td colspan="3">
                <input type="text" readonly title="" id="searchSt" name="searchSt" placeholder="" class="" value="<c:out value="${memberView.areaId}"/> "/><a href="#" onclick="fn_addrSearch()" class="search_btn"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a>
                </td>
            </tr>
            <tr>
                <th scope="row" >Address Detail<span class="must">*</span></th>
                <td colspan="3">
                <input type="text" readonly title="" id="addrDtl" name="addrDtl" placeholder="Detail Address" class="w100p" value="<c:out value="${memberView.addrDtl}"/> " />
                </td>
            </tr>
            <tr>
                <th scope="row" >Street</th>
                <td colspan="3">
                <input type="text" readonly title="" id="streetDtl" name="streetDtl" placeholder="Detail Address" class="w100p" value="<c:out value="${memberView.street}"/> " />
                </td>
            </tr>
            <tr>
               <th scope="row">Area(4)<span class="must">*</span></th>
                <td colspan="3">
                <select class="w100p" id="mArea"  name="mArea" onchange="javascript : fn_getAreaId()" disabled="disabled"></select> 
                </td>
            </tr>
            <tr>
                 <th scope="row">City(2)<span class="must">*</span></th>
                <td>
                <select class="w100p" id="mCity"  name="mCity" onchange="javascript : fn_selectCity(this.value)" disabled="disabled"></select>  
                </td>
                <th scope="row">PostCode(3)<span class="must">*</span></th>
                <td>
                <select class="w100p" id="mPostCd"  name="mPostCd" onchange="javascript : fn_selectPostCode(this.value)" disabled="disabled"></select>
                </td>
            </tr>
            <tr>
                <th scope="row">State(1)<span class="must">*</span></th>
                <td>
                <select class="w100p" id="mState"  name="mState" onchange="javascript : fn_selectState(this.value)" disabled="disabled"></select>
                </td>
                <th scope="row">Country<span class="must">*</span></th>
                <td>

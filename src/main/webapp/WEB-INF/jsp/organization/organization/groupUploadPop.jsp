...
<ul class="right_opt">
    <li><p class="btn_blue2"><a id="groupFileUploadClose" href="#">CLOSE</a></p></li>
</ul>
...
<!-- <article class="grid_wrap">grid_wrap start
  ...
  <ul class="center_btns mt20">
            ...
            <li><p class="btn_blue2 big"><a href="${pageContext.request.contextPath}/resources/download/organization/MemberOrgBatchTrans_Template.csv">Template Download</a></p></li>
        </ul>

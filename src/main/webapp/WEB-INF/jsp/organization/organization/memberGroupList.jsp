 ...
 //  화면 초기화 함수 (jQuery 의 $(document).ready(function() {}); 과 같은 역할을 합니다.
    $(document).ready(function(){
        ...
        AUIGrid.bind(myGridID, "cellDoubleClick", function(event){
            ...
            Common.popupDiv("/organization/groupDetailViewPop.do", $("#searchForm").serializeJSON(), null, true, 'detailPop');
        });
...
function fn_searchLoyaltyHpListAjax(){
    Common.ajax("GET", "/organization/selectGroupMstList", $("#searchForm").serialize(), function(result) {
...
function fn_NewUpload(){
   // Common.popupDiv("/sales/customer/loyaltyHpUploadPop.do", $("#searchForm").serializeJSON(), null, true, 'savePop');
    ...
    Common.popupDiv("/organization/groupUploadPop.do", $("#searchForm").serializeJSON(), null, true, 'savePop');
}
...
<ul class="right_btns">
    <li><p class="btn_blue"><a href="#" onClick="fn_NewUpload()">New Upload</a></p></li>
...
<tr>
    ...
    <td>
    <input id ="groupBatchId" name="groupBatchId" type="text" title="groupBatchId" placeholder="" class="w100p" />
    </td>
    <th scope="row"><spring:message code="sal.title.text.batchStus" /></th>
    <td>
    <select id="groupBatchStus" name="groupBatchStus" class="w100p">
    ...
    <td>
    <input id ="crtUserName" name="crtUserName" type="text" title="crtUserName" placeholder="Upload (Username)" class="w100p" />
    </td>
    <th scope="row"></th>
    <td>
    </td>
...
<tr>
    ...
    <td>
    <input id ="uploadDateF" name="uploadDateF" type="text" title="Upload Date(From)" placeholder="DD/MM/YYYY" class="j_date" />
    </td>
    <th scope="row">Create Date(To)</th>
    <td>
    <input  id ="uploadDateT" name="uploadDateT" type="text" title="Upload Date(To)" placeholder="DD/MM/YYYY" class="j_date" />
    </td>
    <th scope="row">Member Type</th>
    <td>
    <select id="groupMemberType" name="groupMemberType" class="w100p">
        <option value="">--SELECT--</option>
         ...
         <option value="Homecare Delivery Technician">Homecare Delivery Technician</option>
    </select>
    </td>
    <th scope="row"></th>
    <td>
...
<article class="grid_wrap"><!-- grid_wrap start -->
    <div id="list_grid_wrap" style="width:100%; height:500px; margin:0 auto;"></div>

...
<tr>
	...
	<td><input type="text" title="기준년월" placeholder="MM/YYYY" class=" w100p readonly" readonly="readonly" id="newClmMonth" name="clmMonth" <c:if test="${appvPrcssNo ne null and appvPrcssNo ne ''}">disabled</c:if>/></td>

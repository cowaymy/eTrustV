...
function fn_approveLineSubmit() {
    ...
    Common.ajax("POST", "/eAccounting/codyClaim/approveLineSubmit.do", obj, function(result) {
        console.log(result);
        Common.popupDiv("/eAccounting/codyClaim/completedMsgPop.do", null, null, true, "completedMsgPop");
...
<h1><spring:message code="newRgistCodyClaim.title" /></h1>
<p class="pop_close"><a href="#"><spring:message code="newWebInvoice.btn.close" /></a></p>
</header><!-- pop_header end -->

<section class="pop_body"><!-- pop_body start -->
<p class="msg_txt"><spring:message code="newRgistCodyClaim.RgistMsg" /></p>

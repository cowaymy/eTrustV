...
#addExpenseGrid-aui-grid-drop-list-taxCode .aui-grid-drop-list-ul {
     text-align:left;
 }
</style>
<script  type="text/javascript">
    ...
    $(document).ready(function(){
        var expPopColumnLayout = [{     /* PK , rowid 용 칼럼*/
            ...
            renderer : {
                type : "IconRenderer",
                iconTableRef :  {"default" : "${pageContext.request.contextPath}/resources/images/common/search.png"},
                iconWidth : 16,
                iconHeight : 16,
            ...
            dataField : "cntrlExp",
            headerText : "Controlled Expenses",
            renderer : {
        ...
        CommonCombo.make("claimTypeCombo", "/eAccounting/expense/selectCodeList.do", {groupCode:'343', orderValue:'CODE'}, "", {id: "code", name: "codeName"});
                ...
                <table class="type1"><!-- table start -->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <select id="claimTypeCombo" name="claimTypeCombo"></select>
                            </td>
                        </tr>
                    </tbody>
                </table><!-- table end -->

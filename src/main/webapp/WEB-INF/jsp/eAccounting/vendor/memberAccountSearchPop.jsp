...
var supplierColumnLayout = [ {
    ...
    dataField : "memAccId",
    headerText : 'Member Account Code'
}, {
    ...
    headerText : 'Business Registration No.'
},{
    dataField : "bankCode",
    visible : false
},{
...
<ul class="right_btns mb10">
	<li><p class="btn_blue"><a href="#" onclick="javascript:fn_selectMember()"><span class="search"></span>Search</a></p></li>
</ul>

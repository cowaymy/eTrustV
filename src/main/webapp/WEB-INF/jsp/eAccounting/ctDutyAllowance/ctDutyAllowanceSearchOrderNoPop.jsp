...
$(document).ready(function() {
    ...
    $("#searchCtCode").val('${paramsList.newMemAccId}');
    $("#searchDutyDt").val('${paramsList.dutyAllDt}');
    $("#searchSvcType").val('${paramsList.svcType}');
    $("#searchSvcTypeName").val('${paramsList.svcTypeName}');
    //_search Order
...
<tr>
    ...
    <td><input type="text" title="" placeholder="CT Code" class="w100p readonly" name="searchCtCode" id="searchCtCode"  readonly="readonly" /></td>
    <th scope="row">Duty Allowance Date</th>
    <td><input type="text" title="" placeholder="Duty Allowance Date" class="w100p readonly" name="searchDutyDt" id="searchDutyDt"  readonly="readonly" /></td>
    <th scope="row">Service Type</th>
    <td><input type="text" title="" placeholder="Service Type" class="w100p readonly" name="searchSvcTypeName" id="searchSvcTypeName"  readonly="readonly" /></td>
</tr>
<input type="hidden" name="searchSvcType" id="searchSvcType">
</tbody>
</table><!-- table end -->
</form>

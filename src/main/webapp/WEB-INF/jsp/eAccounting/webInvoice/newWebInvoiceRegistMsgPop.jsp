...
<ul class="center_btns">
	<li><p class="btn_blue2"><a href="#"><spring:message code="newWebInvoRegistMsg.yes" /></a></p></li>
	<li><p class="btn_blue2"><a href="#"><spring:message code="newWebInvoRegistMsg.no" /></a></p></li>
</ul>

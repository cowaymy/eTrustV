...
function fn_approveLineSubmit() {
	...
	var newGridList = AUIGrid.getOrgGridData(hNewGridID);
    ...
    Common.ajax("POST", "/eAccounting/staffClaim/approveLineSubmit.do", obj, function(result) {
        console.log(result);
        Common.popupDiv("/eAccounting/staffClaim/completedMsgPop.do", {callType:"new", clmNo:result.data.clmNo}, null, true, "completedMsgPop");

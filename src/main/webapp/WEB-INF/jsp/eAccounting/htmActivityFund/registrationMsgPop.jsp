...
function fn_approveLineSubmit() {
    ...
    Common.ajax("POST", "/eAccounting/webInvoice/checkFinAppr.do", obj, function(resultFinAppr) {
        ...
        if(resultFinAppr.code == "99") {
            ...
            Common.ajax("POST", "/eAccounting/htmActivityFund/approveLineSubmit.do", obj, function(result) {
                console.log(result);
                Common.popupDiv("/eAccounting/htmActivityFund/completedMsgPop.do", {callType:callType, clmNo:result.data.clmNo}, null, true, "completedMsgPop");
            });
        }
    });
}

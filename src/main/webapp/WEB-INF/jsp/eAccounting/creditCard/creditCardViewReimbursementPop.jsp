...
<tr>
	...
	<td colspan="3"><input type="text" title="" placeholder="" class="w100p" id="maskingNo" maxlength="16" <c:if test="${appvPrcssNo ne null and appvPrcssNo ne ''}">readonly</c:if>/></td>
</tr>
<tr>
...
<tr>
	...
	<td colspan="3"><input type="text" title="기준년월" placeholder="MM/YYYY" class="j_date2 w100p" id="clmMonth" name="clmMonth" <c:if test="${appvPrcssNo ne null and appvPrcssNo ne ''}">disabled</c:if>/></td>
</tr>
</tbody>
</table><!-- table end -->

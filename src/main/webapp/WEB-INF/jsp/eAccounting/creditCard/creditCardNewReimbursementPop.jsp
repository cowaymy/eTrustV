...
function fn_tempSave() {
    fn_insertReimbursement(callType);
}
</script>
...
<h1><spring:message code="crditCardNewReim.title" /></h1>
<ul class="right_opt">
...
<tr>
	...
	<td><input type="text" title="" placeholder="" class="" id="newSupplyName" name="supplyName"/><a href="#" class="search_btn" id="supply_search_btn"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a></td>
...
<tr id="amt">
	...
	<td><input type="text" title="" placeholder="" class="w100p" id="netAmt" name="netAmt"/></td>
	<th scope="row"><spring:message code="pettyCashNewExp.gstRm" /></th>
	<td><input type="text" title="" placeholder="" class="readonly w100p" readonly="readonly" id="taxAmt" name="taxAmt"/></td>
</tr>
<tr>
    ...
    <td><input type="text" title="" placeholder="" class="readonly w100p" readonly="readonly" id="taxNonAmt" name="taxNonAmt" /></td>
</tr>
<tr>
...
<tr>
	...
	<td colspan="3"><textarea class="w100p" rows="2" style="height:auto" id="expDesc" name="expDesc"></textarea></td>
</tr>
</tbody>
</table><!-- table end -->

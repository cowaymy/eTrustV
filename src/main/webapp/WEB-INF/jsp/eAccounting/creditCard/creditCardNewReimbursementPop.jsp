...
<tr>
	...
	<td><input type="text" title="" placeholder="" class="w100p" id="newSupplyName" name="supplyName"/><a href="#" class="search_btn" id="supply_search_btn" style="display:none"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a></td>

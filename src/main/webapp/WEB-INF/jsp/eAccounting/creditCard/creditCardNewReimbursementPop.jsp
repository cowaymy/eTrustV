...
<tr>
	...
	<td><input type="text" title="" placeholder="" class="w100p" id="newSupplyName" name="supplyName"/></td>
...
<tr>
	...
	<td colspan="3"><textarea class="w100p" rows="2" style="height:auto" id="expDesc" name="expDesc" maxlength=100></textarea></td>
</tr>
</tbody>
</table><!-- table end -->

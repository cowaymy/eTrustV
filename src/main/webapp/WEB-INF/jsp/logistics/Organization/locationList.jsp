...
var columnLayout = [{dataField: "locid",headerText :"<spring:message code='log.head.whid'/>"               ,width:  "8%"      ,height:30 , visible:true},               
							{dataField: "loccd",headerText :"<spring:message code='log.head.code'/>"               ,width:  "12%"    ,height:30 , visible:true},                
							{dataField: "locdesc",headerText :"<spring:message code='log.head.locname'/>"       ,width: "40%"    ,height:30 , visible:true},                

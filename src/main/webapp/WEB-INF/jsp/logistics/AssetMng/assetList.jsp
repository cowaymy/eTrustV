...
var columnLayout = [{dataField: "assetid",headerText :"<spring:message code='log.head.assetid'/>"              ,width:  "5%"      ,height:30 , visible:true},               
								{dataField: "name2",headerText :"<spring:message code='log.head.status'/>"             ,width:  "8%"     ,height:30 , visible:true},                
								{dataField: "codename2",headerText :"<spring:message code='log.head.type'/>"        ,width: "12%"    ,height:30 , visible:true},                
								{dataField: "name",headerText :"<spring:message code='log.head.brand'/>"           ,width:120 ,height:30 , visible:true},                       
								{dataField: "name1",headerText :"<spring:message code='log.head.modelname'/>"          ,width:140 ,height:30 , visible:true},                       
								{dataField: "codename1",headerText :"<spring:message code='log.head.color'/>"          ,width:90 ,height:30 , visible:true},                        
								{dataField: "branch",headerText :"<spring:message code='log.head.branch'/>"         ,width:120 ,height:30 , visible:true},                          
								{dataField: "department",headerText :"<spring:message code='log.head.department'/>"         ,width:140 ,height:30 , visible:true},                          
								{dataField: "purchsdt",headerText :"<spring:message code='log.head.purchasedate'/>"         ,width:120 ,height:30 , visible:true},                          
								{dataField: "username2",headerText :"<spring:message code='log.head.currentuser'/>"         ,width:120  ,height:30 , visible:true},                         
								{dataField: "refno",headerText :"<spring:message code='log.head.refno'/>"           ,width:120  ,height:30 , visible:true},                         
								{dataField: "dealername",headerText :"<spring:message code='log.head.dealer'/>"         ,width:120  ,height:30 , visible:true},                         
								{dataField: "invcno",headerText :"<spring:message code='log.head.invno'/>"          ,width:120 ,height:30 , visible:true},                                              
								{dataField: "brandid",headerText :"<spring:message code='log.head.brandid'/>"        ,width:100 ,height:30 , visible:false},                        
								{dataField: "ctgryid",headerText :"<spring:message code='log.head.ctgryid'/>"           ,width:100 ,height:30 , visible:false},                                             
								{dataField: "codename",headerText :"<spring:message code='log.head.codename'/>"         ,width:100 ,height:30 , visible:false},                                             
								{dataField: "colorId",headerText :"<spring:message code='log.head.codename1'/>"       ,width:100 ,height:30 , visible:false},                                               
								{dataField: "crtdt",headerText :"<spring:message code='log.head.crtdt'/>"          ,width:100 ,height:30 , visible:false},                                              
								{dataField: "crtuserid",headerText :"<spring:message code='log.head.crtuserid'/>"             ,width:100 ,height:30 , visible:false},                       
								{dataField: "currbrnchid",headerText :"<spring:message code='log.head.currbrnchid'/>"             ,width:100 ,height:30 , visible:false},                                               
								{dataField: "currdeptid",headerText :"<spring:message code='log.head.currdeptid'/>"          ,width:100 ,height:30 , visible:false},                                            
								{dataField: "curruserid",headerText :"<spring:message code='log.head.curruserid'/>"          ,width:100 ,height:30 , visible:false},                                                
								{dataField: "username",headerText :"<spring:message code='log.head.username2'/>"               ,width:100 ,height:30 , visible:false},                                              
								{dataField: "imeino",headerText :"<spring:message code='log.head.imeino'/>"            ,width:100 ,height:30 , visible:false},                                              
								{dataField: "macaddr",headerText :"<spring:message code='log.head.macaddr'/>"         ,width:100 ,height:30 , visible:false},                                               
								{dataField: "purchsamt",headerText :"<spring:message code='log.head.purchsamt'/>"          ,width:100 ,height:30 , visible:false},                                              
								{dataField: "assetrem",headerText :"<spring:message code='log.head.assetrem'/>"          ,width:    "15%"    ,height:30 , visible:false},                                       
								{dataField: "serialno",headerText :"<spring:message code='log.head.serialno'/>"           ,width:100 ,height:30 , visible:false},                                               
								{dataField: "stusid",headerText :"<spring:message code='log.head.stusid'/>"           ,width:100 ,height:30 , visible:false},                                           
								{dataField: "typeid",headerText :"<spring:message code='log.head.typeid'/>"            ,width:  "15%"    ,height:30 , visible:false},                                   
								{dataField: "upddt",headerText :"<spring:message code='log.head.upddt'/>"            ,width:    "10%"    ,height:30 , visible:false},                                       
								{dataField: "upduserid",headerText :"<spring:message code='log.head.upd_user_id'/>"         ,width:100 ,height:30 , visible:false},                         
								{dataField: "username1",headerText :"<spring:message code='log.head.username1'/>"         ,width:100 ,height:30 , visible:false},                                               
								{dataField: "wrantyno",headerText :"<spring:message code='log.head.wrantyno'/>"       ,width:100 ,height:30 , visible:false},                                               
								{dataField: "dealerid",headerText :"<spring:message code='log.head.dealerid'/>"       ,width:100 ,height:30 , visible:false}
                       ];
    
    
var detailLayout = [ {dataField:    "codeName",headerText :"<spring:message code='log.head.type'/>"           ,width:   "12%"    ,height:30 , visible:true},                
                     {dataField: "name",headerText :"<spring:message code='log.head.brand'/>"               ,width:  "15%"    ,height:30 , visible:true},                
                     {dataField: "name1",headerText :"<spring:message code='log.head.modelname'/>"       ,width: "40%"    ,height:30 , visible:true},                
                     {dataField: "assetDRem",headerText :"<spring:message code='log.head.remark1'/>"         ,width: "15%"    ,height:30 , visible:true},                
                     {dataField: "name3",headerText :"<spring:message code='log.head.name'/>"             ,width:    "15%"    ,height:30 , visible:true},                
                     {dataField: "valu",headerText :"<spring:message code='log.head.value'/>"           ,width:  "15%"    ,height:30 , visible:true},                
                     {dataField: "assetDItmRem",headerText :"<spring:message code='log.head.remark2'/>"         ,width:120 ,height:30 , visible:true} 
                       ];
var insDetailLayout = [ {dataField: "codeName",headerText :"<spring:message code='log.head.type'/>"           ,width:   "12%"    ,height:30 , visible:true},                
                        {dataField: "name",headerText :"<spring:message code='log.head.brand'/>"               ,width:  "15%"    ,height:30 , visible:true},                
                        {dataField: "name1",headerText :"<spring:message code='log.head.modelname'/>"       ,width: "40%"    ,height:30 , visible:true},                
                        {dataField: "assetDRem",headerText :"<spring:message code='log.head.remark1'/>"         ,width: "15%"    ,height:30 , visible:true},                
                        {dataField: "typeid",headerText :"<spring:message code='log.head.type'/>"             ,width:   "12%"    ,height:30 , visible:false},                   
                        {dataField: "brandid",headerText :"<spring:message code='log.head.type'/>"            ,width:   "12%"    ,height:30 , visible:false}, 
                        {
                            dataField : "",
                            headerText : "",
                            renderer : {
...
/*     var updateLayout = [ {dataField: "codeName",headerText :"<spring:message code='log.head.type'/>"           ,width:   "12%"    ,height:30 , visible:true},                
{dataField: "name",headerText :"<spring:message code='log.head.brand'/>"               ,width:  "15%"    ,height:30 , visible:true},                
{dataField: "name1",headerText :"<spring:message code='log.head.modelname'/>"       ,width: "40%"    ,height:30 , visible:true},                
{dataField: "assetDRem",headerText :"<spring:message code='log.head.remark1'/>"         ,width: "15%"    ,height:30 , visible:true},                
{dataField: "name3",headerText :"<spring:message code='log.head.name'/>"             ,width:    "15%"    ,height:30 , visible:true},                
...
{dataField: "typeid",headerText :"<spring:message code='log.head.type'/>"             ,width:   "12%"    ,height:30 , visible:false},                   
{dataField: "brandid",headerText :"<spring:message code='log.head.type'/>"            ,width:   "12%"    ,height:30 , visible:false},               
{dataField: "assetDId",headerText :"<spring:message code='log.head.assetdid'/>"           ,width:   "12%"    ,height:30 , visible:true},                
{dataField: "assetDItmId",headerText :"<spring:message code='log.head.asset_d_itm_id'/>"              ,width:   "12%"    ,height:30 , visible:true}, 
                        {
                            dataField : "",
                            headerText : "",
                            renderer : {
...
var updateLayout = [ {dataField:    "codeName",headerText :"<spring:message code='log.head.type'/>"           ,width:120 ,height:30 , style :   "aui-grid-user-custom-left"   ,                   
                                      ...
                                      editRenderer : {
                                          ...
                                          valueField : "codeName"                                            
                                            ...
                                            {dataField: "name",headerText :"<spring:message code='log.head.brand'/>"               ,width:120 ,height:30 , style : "aui-grid-user-custom-left"   ,
                                                 labelFunction : function(rowIndex, columnIndex, value, headerText, item) {
                                                     var retStr = "";
                       ...
                       {dataField: "name1",headerText :"<spring:message code='log.head.modelname'/>"       ,width:120 ,height:30 , visible:true},                          
                       {dataField: "assetDRem",headerText :"<spring:message code='log.head.remark1'/>"         ,width:120 ,height:30 , visible:true},                          
                       {dataField: "name3",headerText :"<spring:message code='log.head.name'/>"             ,width:120 ,height:30 , visible:true},                         
                       {dataField: "valu",headerText :"<spring:message code='log.head.value'/>"           ,width:120 ,height:30 , visible:true},                       
                       {dataField: "assetDItmRem",headerText :"<spring:message code='log.head.remark2'/>"         ,width:120 ,height:30 , visible:true},                       
                       {dataField: "typeid",headerText :"<spring:message code='log.head.type'/>"             ,width:120 ,height:30 , visible:false},                           
                       {dataField: "brandid",headerText :"<spring:message code='log.head.type'/>"            ,width:120 ,height:30 , visible:false},                       
                       {dataField: "assetDId",headerText :"<spring:message code='log.head.assetdid'/>"           ,width:120 ,height:30 , visible:true},                        
                       {dataField: "assetDItmId",headerText :"<spring:message code='log.head.asset_d_itm_id'/>"              ,width:120 ,height:30 , visible:true}, 
                       {
                           dataField : "",
                           headerText : "",
                           renderer : {
    ...
    var additemLayout = [ {dataField:   "codeName",headerText :"<spring:message code='log.head.type'/>"           ,width:   "12%"    ,height:30 , visible:true},                
                          {dataField: "name",headerText :"<spring:message code='log.head.brand'/>"               ,width:  "15%"    ,height:30 , visible:true},                
                          {dataField: "name1",headerText :"<spring:message code='log.head.modelname'/>"       ,width: "40%"    ,height:30 , visible:true},                
                          {dataField: "assetDRem",headerText :"<spring:message code='log.head.remark1'/>"         ,width: "15%"    ,height:30 , visible:true},                
                          {dataField: "name3",headerText :"<spring:message code='log.head.name'/>"             ,width:    "15%"    ,height:30 , visible:true},                
                          ...
                          {dataField: "assetDItmRem",headerText :"<spring:message code='log.head.remark2'/>"         ,width:120 ,height:30 , visible:true},                       
                          {dataField: "typeid",headerText :"<spring:message code='log.head.type'/>"             ,width:   "12%"    ,height:30 , visible:false},                   
                          {dataField: "brandid",headerText :"<spring:message code='log.head.brandid'/>"             ,width:   "12%"    ,height:30 , visible:false},               
                          {dataField: "assetid",headerText :"<spring:message code='log.head.assetid'/>"              ,width:  "5%"      ,height:30 , visible:false},  
                        {
                            dataField : "",
                            headerText : "",
                            renderer : {
    ...
    var asstMoveTrnsLayout = [ {dataField:  "cardId",headerText :"<spring:message code='log.head.cardid'/>" ,width:120 ,height:30, visible:false},                          
                               {dataField: "crtDt",headerText :"<spring:message code='log.head.date'/>"    ,width: "15%"    ,height:30},               
                               {dataField: "userName",headerText :"<spring:message code='log.head.creator'/>"  ,width: "15%"    ,height:30},               
                               {dataField: "codeName",headerText :"<spring:message code='log.head.type'/>" ,width: "20%"    ,height:30},               
                               {dataField: "brnchId",headerText :"<spring:message code='log.head.branch'/>"    ,width:120 ,height:30, visible:false},                          
                               {dataField: "deptId",headerText :"<spring:message code='log.head.department'/>" ,width:120 ,height:30, visible:false},                          
                               {dataField: "assetId",headerText :"<spring:message code='log.head.assetid'/>"   ,width:120 ,height:30, visible:false},                          
                               {dataField: "c1",headerText :"<spring:message code='log.head.branch'/>" ,width: "15%"    ,height:30},               
                               {dataField: "cardDocNo",headerText :"<spring:message code='log.head.carddocno'/>"   ,width:120 ,height:30, visible:false},                          
                               {dataField: "cardTypeId",headerText :"<spring:message code='log.head.cardtypeid'/>" ,width:120 ,height:30, visible:false},                          
                               {dataField: "crtUserId",headerText :"<spring:message code='log.head.crtuserid'/>"   ,width:120 ,height:30, visible:false},                          
                               {dataField: "c2",headerText :"<spring:message code='log.head.department'/>" ,width: "20%"    ,height:30},               
                               {dataField: "qty",headerText :"<spring:message code='log.head.qty'/>"   ,width: "15%"    ,height:30}  
];
    
    var bulkLayout = [{dataField:   "assetid",headerText :"<spring:message code='log.head.assetid'/>"              ,width:80 ,height:30 , visible:true},                        
                      {dataField: "name2",headerText :"<spring:message code='log.head.status'/>"             ,width:80 ,height:30 , visible:true},                        
                      {dataField: "codename2",headerText :"<spring:message code='log.head.type'/>"        ,width:140 ,height:30 , visible:true},                          
                      {dataField: "name",headerText :"<spring:message code='log.head.brand'/>"           ,width:120 ,height:30 , visible:true},                       
                      {dataField: "name1",headerText :"<spring:message code='log.head.modelname'/>"          ,width:140 ,height:30 , visible:true},                       
                      {dataField: "codename1",headerText :"<spring:message code='log.head.color'/>"          ,width:90 ,height:30 , visible:true},                        
                      {dataField: "branch",headerText :"<spring:message code='log.head.branch'/>"         ,width:120 ,height:30 , visible:true},                          
                      ...
                      {dataField: "purchsdt",headerText :"<spring:message code='log.head.purchasedate'/>"         ,width:120 ,height:30 , visible:true},                          
                      {dataField: "username2",headerText :"<spring:message code='log.head.currentuser'/>"         ,width:120  ,height:30 , visible:true},                         
                      {dataField: "refno",headerText :"<spring:message code='log.head.refno'/>"           ,width:150  ,height:30 , visible:true},                         
                      {dataField: "dealername",headerText :"<spring:message code='log.head.dealer'/>"         ,width:120  ,height:30 , visible:false},                        
                      {dataField: "invcno",headerText :"<spring:message code='log.head.invno'/>"          ,width:120 ,height:30 , visible:false},                                             
                      {dataField: "brandid",headerText :"<spring:message code='log.head.brandid'/>"        ,width:100 ,height:30 , visible:false},                        
                      {dataField: "ctgryid",headerText :"<spring:message code='log.head.ctgryid'/>"           ,width:100 ,height:30 , visible:false},                                             
                      {dataField: "codename",headerText :"<spring:message code='log.head.codename'/>"         ,width:100 ,height:30 , visible:false},                                             
                      {dataField: "colorId",headerText :"<spring:message code='log.head.codename1'/>"       ,width:100 ,height:30 , visible:false},                                               
                      ...
                      {dataField: "macaddr",headerText :"<spring:message code='log.head.macaddr'/>"         ,width:100 ,height:30 , visible:false},                                               
                      {dataField: "purchsamt",headerText :"<spring:message code='log.head.purchsamt'/>"          ,width:100 ,height:30 , visible:false},                                              
                      {dataField: "assetrem",headerText :"<spring:message code='log.head.assetrem'/>"          ,width:120 ,height:30 , visible:false},                                                
                      {dataField: "serialno",headerText :"<spring:message code='log.head.serialno'/>"           ,width:100 ,height:30 , visible:false},                                               
                      {dataField: "stusid",headerText :"<spring:message code='log.head.stusid'/>"           ,width:100 ,height:30 , visible:false},                                       

...
var columnLayout = [
                    ...
                    {dataField: "hsLoseItemDeliverQty",headerText :"Deliver Q'ty"          ,width:180   ,height:30 , visible:false,editable : true},
...
createAUIGrid =function(columnLayout ){
   ...
   $(document).ready(function() {
       ...
       AUIGrid.bind(mstGridID, ["cellEditBegin"], function(event) {
           if(event.dataField == "hsLoseItemDeliverQty" ) {
               if(event.item.hsLoseItemTypeId == "62") {
   ...
   fn_getDataListAjax  = function () {
         ...
         Common.ajax("GET", "/logistics/HsFilterLoose/selectHSFilterLooseList.do", $("#hsFilterForm").serialize(), function(result) {
            console.log("성공.");
            //console.log( result);
           // console.log(result);
...
*/
		...
		console.log(GridCommon.getEditData(mstGridID));
	     ...
	     // var prams ={data:GridCommon.getEditData(mstGridID)};
            ...
            Common.ajax("POST", "/logistics/HsFilterLoose/insertHSFilterLooseList.do",
 ...
 function createExcelAUIGrid(jsonData) {
   ...
   $.each(firstRow, function(n,v) {
    ...
    mstGridID = AUIGrid.create("#main_grid_wrap", columnLayout);
     ...
     var cvtJsonData  = JSON.stringify(jsonData).replace(/Code/g, 'hsLoseItemCode' );
...
<h2>HS Filter Loose Operation</h2>

...
var rescolumnLayout=[
							...
							{dataField: "whLocDesc",headerText :"<spring:message code='log.head.port'/>"    ,width:250 ,height:30,editable:false 
                              ...
                              {dataField: "itmSeq",headerText :"<spring:message code='log.head.seq'/>"    ,width:120 ,height:30,editable:false},                          
                              {dataField: "stkid",headerText :"<spring:message code='log.head.stkid'/>"   ,width:120 ,height:30,editable:false, visible:false},                       
                              {dataField: "matrlNo",headerText :"<spring:message code='log.head.materialcd'/>"    ,width:120 ,height:30,editable:false},                          
                              ...
                              {dataField: "qty",headerText :"<spring:message code='log.head.blqty'/>" ,width:120 ,height:30,editable:false,dataType :     "numeric"   ,style: "aui-grid-user-custom-right"    },          
                              {dataField: "avrqty",headerText :"<spring:message code='log.head.remainqty'/>"  ,width:120 ,height:30,editable:false ,dataType :    "numeric"   ,style: "aui-grid-user-custom-right"    },          
                              {dataField: "reqedQty",headerText :"<spring:message code='log.head.movedqty'/>" ,width:120 ,height:30,editable:false ,dataType :    "numeric"   ,style: "aui-grid-user-custom-right"    },          
                              {dataField: "reqQty",headerText :"<spring:message code='log.head.reqqty'/>" ,width:120 ,height:30,dataType :    "numeric"   ,style: "aui-grid-user-custom-right"    }
							];

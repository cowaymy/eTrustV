...
//btn clickevent
  $(function(){
      ...
      $('#searchMatName').keypress(function(event) {
          ...
          if (event.which == '13') {
              ...
              Common.searchpopupWin("sroForecastHistoryForm", "/common/searchPopList.do","stock");
          }
      });
  ...
  function sroForecastHistoryGrid() {
    ...
    myGridID = AUIGrid.create("#grid_wrap_sroForecastHistoryList", columnLayout, gridPros);
  }

  function fn_searchSroForecastHistortList() {
        Common.ajax("GET", "/logistics/stockReplenishment/selectSroForecastHistoryList.do", $("#sroForecastHistoryForm").serialize(), function(result) {
  ...
  function fn_excelDown() {
    ...
    GridCommon.exportTo("grid_wrap_sroForecastHistoryList", "xlsx", "SroForecastHistory_" + day + month + date.getFullYear());
  }

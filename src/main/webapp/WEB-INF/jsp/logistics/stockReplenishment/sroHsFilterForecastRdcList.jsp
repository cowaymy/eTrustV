...
//btn clickevent
  $(function(){
      $('#search_sroHsFilterForecastRdcForm').click(function() {
          if (f_validatation()){
      ...
      $('#searchMatName').keypress(function(event) {
          ...
          if (event.which == '13') {
              ...
              Common.searchpopupWin("sroHsFilterForecastRdcForm", "/common/searchPopList.do","stock");
          }
      });


      $("#sroHsFilterForecastRdcFormBranch").change(function(){
  ...
  function sroForecastHistoryGrid() {
    ...
    myGridID = AUIGrid.create("#grid_wrap_sroHsFilterForecastRdcForm", columnLayout, gridPros);
  }

  function fn_searchSroForecastHistortList() {

        console.log($("#sroHsFilterForecastRdcForm").serialize());
        Common.ajax("GET", "/logistics/stockReplenishment/selectSroForecastHistoryList.do", $("#sroHsFilterForecastRdcForm").serialize(), function(result) {
        console.log(result);
  ...
  function fn_excelDown() {
    ...
    GridCommon.exportTo("grid_wrap_sroHsFilterForecastRdcForm", "xlsx", "SroHsFilterForecastRdc_" + day + month + date.getFullYear());
  }
...
<section id="content">
 ...
 <aside class="title_line">
  ...
  <h2>HS Filter SRO (RDC)</h2>

  <ul class="right_btns">
   <c:if test="${PAGE_AUTH.funcView == 'Y'}">
    <li><p class="btn_blue"><a href="#" id="search_sroHsFilterForecastRdcForm"><span class="search"></span><spring:message code='sys.btn.search'/></a></p></li>
   </c:if>
   <li><p class="btn_blue"><a href="#" onclick="javascript:$('#sroHsFilterForecastRdcForm').clearForm();"><span class="clear"></span><spring:message code='service.btn.Clear'/></a></p></li>
  </ul>
 </aside>
 <!-- title_line end -->
 <section class="search_table">
  <!-- search_table start -->
  <form action="#" method="post" id="sroHsFilterForecastRdcForm">
   ...
   <article class="grid_wrap">
    <!-- grid_wrap start -->
    <div id="grid_wrap_sroHsFilterForecastRdcForm" style="width: 100%; height: 500px; margin: 0 auto;"></div>
   </article>
   <!-- grid_wrap end -->
  </form>

  ...
  //$("#gradeGrid").hide();
    ...
    $("#btnPopIssueSave").click(function(){
      ...
      //var addedItems = AUIGrid.getColumnValues(gradeGridId,"lastLocStkGrad");
       ...
       if(Common.confirm("Do you want to save?", function(){
           ...
           Common.ajax("POST", "/logistics/returnusedparts/saveReturnUsedSerial.do", obj, function(result) {
    ...
    $("#btnPopSerial").click(function(){
      ...
      /* if(Common.checkPlatformType() == "mobile") {
            ...
            Common.popupDiv("/logistics/returnusedparts/serialScanCommonPop.do", param, null, true, '_serialScanPop');
        //}
    });
...
function fn_serialScanInListAjax() {
  ...
  var url = "/logistics/returnusedparts/selectScanSerialInList.do";

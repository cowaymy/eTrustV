...
<script type="text/javaScript" language="javascript">
    ...
    var columnMainLayout = [
                                                ...
                                                {dataField:"currqty", headerText:"End Qty", width:100, height:30},
                                                {dataField:"qtyy", headerText:"(B-E)Qty", width:100, height:30},
    ...
    $(document).ready(function() {
	    ...
	    **********************************/
	    ...
	    $("#currmth").val(baseYear.toString() + baseMth.toString()+'01');
        ...
        $("#prvmth").val(prvBaseYear.toString() + prvBaseMth.toString()+'01' );
    ...
    function SearchListAjax()
    {
        ...
        var url = "/logistics/giandgrStock/stockBalanceSearchList.do";
...
<section id="content">
	...
	<ul class="path">
	    ...
	    <li>Logistics</li>
	    <li>Report</li>
	    <li>GR/GI Stock Report</li>
	</ul>

	<aside class="title_line">
		<p class="fav"><a href="#" class="click_add_on">My menu</a></p>
		<h2>GR/GI Stock Report</h2>
            ...
            <table summary="search table" class="type1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                             <select id="tobasedt" name="tobasedt" class="w100p" >
                                <option id="tocurrmth" selected></option>
                                <option id="toprvmth"></option>
                             </select>
                        </td>
	                </tr>
 	                <tr>

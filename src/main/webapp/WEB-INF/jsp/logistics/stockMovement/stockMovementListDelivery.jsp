...
var rescolumnLayout=[{dataField:    "rnum",headerText :"<spring:message code='log.head.rownum'/>",width:120    ,height:30 , visible:false},
                     ...
                     {dataField: "indelyqty",headerText :"<spring:message code='log.head.deliveredqty'/>"                    ,width:120    ,height:30 , editable:true
                     ...
                     {dataField: "ttype",headerText :"Trans. Type"          ,width:120    ,height:30 , visible:false},
...
var serialcolumnLayout =[{dataField:    "rnum",headerText :"<spring:message code='log.head.rownum'/>",width:120    ,height:30 , visible:false},
                         {dataField: "status",headerText :"<spring:message code='log.head.status'/>",width:120    ,height:30 , visible:false},
                         {dataField: "reqstno",headerText :"<spring:message code='log.head.stockmovementrequest'/>"        ,width:   "20%"       ,height:30   ,cellMerge : true            },
                         {dataField: "staname",headerText :"<spring:message code='log.head.status'/>",width:120    ,height:30 , visible:false                },
                         {dataField: "reqitmno",headerText :"<spring:message code='log.head.stockmovementrequestitem'/>"  ,width:120    ,height:30 , visible:false},
                         ...
                         {dataField: "mtype",headerText :"<spring:message code='log.head.movementtype'/>"                   ,width:120    ,height:30 , visible:false},
                         {dataField: "mtext",headerText :"<spring:message code='log.head.movementtext'/>"                   ,width:120    ,height:30  , visible:false               },
                         {dataField: "froncy",headerText :"<spring:message code='log.head.auto/manual'/>"                   ,width:120    ,height:30  , visible:false               },
                         {dataField: "crtdt",headerText :"<spring:message code='log.head.requestcreatedate'/>"            ,width:120    ,height:30    , visible:false             },
                         ...
                         {dataField: "itmcd",headerText :"<spring:message code='log.head.materialcode'/>"                   ,width:  "20%"       ,height:30 ,cellMerge : true  },
                         {dataField: "itmname",headerText :"<spring:message code='log.head.materialname'/>"                 ,width:  "25%"       ,height:30 ,cellMerge : true                 },
                          {dataField:    "num",headerText :"<spring:message code='log.head.seq'/>"                    ,width:    "5%"        ,height:30   ,style :   "aui-grid-user-custom-right"              },
                          {dataField:    "reqstqty",headerText :"<spring:message code='log.head.requestedqty'/>"                  ,width:120    ,height:30   , visible:false              },
                          {dataField:    "rmqty",headerText :"<spring:message code='log.head.remainqty'/>"                    ,width:120    ,height:30    , visible:false             },
                          {dataField:    "delvno",headerText :"<spring:message code='log.head.delvno'/>",width:120    ,height:30 , visible:false},
                          {dataField:    "delyqty",headerText :"<spring:message code='log.head.delvno'/>",width:120    ,height:30 , visible:false},
                          {dataField:    "indelyqty",headerText :"<spring:message code='log.head.deliveredqty'/>"                    ,width:120    ,height:30 , editable:true
                             ,dataType : "numeric" ,editRenderer : {
                         ...
                         {dataField:    "uom",headerText :"<spring:message code='log.head.unitofmeasure'/>"              ,width:120    ,height:30 , visible:false},
                         {dataField:    "uomnm",headerText :"<spring:message code='log.head.unitofmeasure'/>"                ,width:120    ,height:30  , visible:false              },

...
var rescolumnLayout=[{dataField:"A"     ,headerText:"ITEM TYPE"          ,width:120    ,height:30},
                     {dataField:"B"     ,headerText:"ITEM CD"            ,width:120    ,height:30},
                     {dataField:"C"     ,headerText:"ITEM NAME"          ,width:120    ,height:30},
                     {dataField:"D"     ,headerText:"Available Qty"      ,width:120    ,height:30}
                    ];
var reqcolumnLayout;

var resop = {usePaging : true,useGroupingPanel : false , Editable:false};
...
<ul class="btns">
    <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/common/btn_right2.gif" alt="right" /></a></li>

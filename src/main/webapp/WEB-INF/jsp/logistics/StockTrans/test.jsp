...
function gridFunc(data){
	rescolumnLayout = [];
//	console.log(data.data);
//  	for (var i = 0 ; i < data.data.length ; i++){
// // 		rescolumnLayout[i] = {dataField:"rnum"         ,headerText:"rownum"                      ,width:120    ,height:30 , visible:false}
...
//  	}
    if (data.data.length > 0)
	    ...
	    for (var key in data.data[0]){
	    	...
	    	rescolumnLayout.push({dataField:key         ,headerText:key                      ,width:120    ,height:30 , visible:true});
	    	j++;
	    	console.log(j);
	    }

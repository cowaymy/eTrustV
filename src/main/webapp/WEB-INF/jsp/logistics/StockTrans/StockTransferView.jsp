...
var rescolumnLayout=[{dataField:    "locid",headerText :"<spring:message code='log.head.location'/>"              ,width:120    ,height:30 ,visible:false},                         
                     ...
                     {dataField: "stkcd",headerText :"<spring:message code='log.head.itemcd'/>"             ,width:120    ,height:30},                       
                     {dataField: "stknm",headerText :"<spring:message code='log.head.itemname'/>"             ,width:120    ,height:30},                         
                     {dataField: "typeid",headerText :"<spring:message code='log.head.typeid'/>"            ,width:120    ,height:30,visible:false},                         
                     {dataField: "typenm",headerText :"<spring:message code='log.head.typename'/>"            ,width:120    ,height:30},                         
                     {dataField: "cateid",headerText :"<spring:message code='log.head.cateid'/>"            ,width:120    ,height:30,visible:false},                         
                     {dataField: "catenm",headerText :"<spring:message code='log.head.category'/>"             ,width:120    ,height:30},                        

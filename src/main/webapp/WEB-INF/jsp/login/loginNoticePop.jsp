...
$(document).ready(function() {
	console.log("loginNoticePop.jsp");
    ...
    console.log("inQueue: " + $("#inQueue").val());
...
.btn_blue2 a{display:inline-block; min-width:57px; height:28px; line-height:28px; padding:0 10px; background:#25527c; color:#fff; font-size:11px; border-radius:3px; text-align:center; font-weight:bold;}
.login_pop .right_opt{float:right;}
...
<div id="login_pop" class="login_pop"><!-- login_pop start -->
	<section id="content"><!-- content start -->
        ...
        <input type="hidden" id="inQueue" name="inQueue" value="${inQueue }"/>
		...
		<form id="popForm" style="width: 100%">
	       ...
	       <div id="PDF" style="height: 500px">
		    ...
		    <ul class="right_opt" id="memoButton" style="padding: 10px">

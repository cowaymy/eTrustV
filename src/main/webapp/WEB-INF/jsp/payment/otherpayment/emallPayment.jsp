...
$(document).ready(function(){
    ...
    $('#excelDown').click(function() {
        GridCommon.exportTo("fileItem_grid_wrap", 'xlsx', "Emall_" + fileId);
     });
});
...
var detailsColumnLayout= [
    ...
    {dataField : "emallOrdNo", headerText : "E-mall Order Number", width : '15%'},
    {dataField : "refNo", headerText : "Delivery Order Number", width : '15%'},
    {dataField : "cardNo", headerText : "Card Number", width : '15%'},
    {dataField : "apprCode", headerText : "Approval Code", width : '15%'},
    {dataField : "transDt", headerText : "Transaction Date", width : '15%'},
    {dataField : "appType", headerText : "Application Type", width : '15%'},
...
function fn_getEmallListAjax() {
    Common.ajax("GET", "/payment/selectEmallList.do", $("#searchForm").serialize(), function(result) {
        AUIGrid.setGridData(myGridID, result);
    });
}

function fn_getEmallDetailsList(){
	    ...
	    if (selectedItem[0] > -1){
	        ...
	        Common.ajax("GET", "/payment/selectEmallDetailsList.do", {fileId : fileId}, function(result) {
...
function fn_getItmStatus(val){
	...
	Common.ajax("GET", "/payment/selectEmallDetailsList.do", {"fileId":fileId,"status":val}, function(result) {
        AUIGrid.setGridData(fileItemID, result);
    });
}
</script>
...
<section id="content">
  ...
  <aside class="title_line">
    ...
    <h2>E-mall Payment</h2>
    <ul class="right_btns">
      <c:if test="${PAGE_AUTH.funcView == 'Y'}">
      <li><p class="btn_blue">
          <a href="javascript:fn_getEmallListAjax();"><span class="search"></span>Search</a>
        </p></li>
      <li><p class="btn_blue">
    ...
    <form name="searchForm" id="searchForm" method="post">
      ...
      <aside class="link_btns_wrap">
                ...
                <dl class="link_list">
                    ...
                    <dd>
                    <ul class="btns">
                        <li><p class="link_btn"><a href="javascript:fn_getEmallDetailsList();">View Details</a></p></li>
                    </ul>
                    <ul class="btns">
                    </ul>
...
<div class="popup_wrap" id="view_wrap" style="display: none;">
  ...
  <header class="pop_header" id="pop_header">
    <h1>E-mall transaction details</h1>
    <ul class="right_opt">

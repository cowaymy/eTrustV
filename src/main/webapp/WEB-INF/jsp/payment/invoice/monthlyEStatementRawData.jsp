...
var columnLayout=[
    ...
    {dataField:"taxInvcChrg", headerText:"<spring:message code='pay.head.currcharges'/>", width : 150},
    {dataField:"taxInvcOverdu", headerText:"<spring:message code='pay.head.prevBal'/>", width : 150},
    {dataField:"taxInvcAmtDue", headerText:"<spring:message code='pay.head.totOut'/>", width : 150},

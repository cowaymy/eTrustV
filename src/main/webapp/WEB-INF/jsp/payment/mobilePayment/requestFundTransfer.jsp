...
[
    ...
    ,   { dataField : "curOrdNo", width:140, headerText : "<spring:message code='pay.head.curOrdNo'/>" }
    ,   { dataField : "curCustName", width:200, headerText : "<spring:message code='pay.head.curCustName'/>", style : "aui-grid-user-custom-left" }
    ,   { dataField : "curWorNo", width:120, headerText : "<spring:message code='pay.head.worNo'/>" }
    ,   { dataField : "curAmt", width:100, headerText : "<spring:message code='pay.head.amount'/>", dataType : "numeric", style : "aui-grid-user-custom-right", formatString : "#,##0.00" }
    ,   { dataField : "newOrdNo", width:140, headerText : "<spring:message code='pay.head.newOrdNo'/>" }
    ,   { dataField : "newCustName", width:200, headerText : "<spring:message code='pay.head.newCusoomerName'/>", style : "aui-grid-user-custom-left" }
    ,   { dataField : "ftResnName", width:140, headerText : "<spring:message code='pay.head.reason'/>", style : "aui-grid-user-custom-left" }
    ,   {
    ...
    ,   { dataField : "ftRem", width:100, headerText : "<spring:message code='pay.head.remark'/>", style : "aui-grid-user-custom-left"}
    ...
    ,   { dataField : "ftReqId", visible : false }
    ,   { dataField : "ftStusId", visible : false }
    ,   { dataField : "ticketStusId", visible : false }
    ,   { dataField : "newAmt", visible : false }
    ,   { dataField : "ftResn", visible : false }
...
$(document).ready(function () {
    ...
    CommonCombo.make("ticketStusId", "/payment/requestFundTransfer/selectTicketStatusCode.do", null, "", { id: "code", name: "codeName",  type:"S" });
...
function fn_searchPage(pageNo){
    Common.ajax("POST", "/payment/requestFundTransfer/selectRequestFundTransferList.do",  $.extend($("#searchForm").serializeObject(), {"pageNo":pageNo, "pageSize":20, "gu" : "LIST"}), function(result) {
        ...
        if( ticketStusId != 1 ){
            ...
            Common.prompt("<spring:message code='pay.prompt.reject'/>", "", function(){
            	if( FormUtil.isEmpty($("#promptText").val()) ){
                    ...
                    Common.ajaxSync("POST", "/payment/requestFundTransfer/saveRequestFundTransferReject.do", rejectData, function(result) {
                        if(result !=""  && null !=result ){
...
<!--[2.Start]  -->
                    <tr>
                        ...
                        <td>
                            <input type="text" title="Order No." placeholder="Order No." class="w100p" id="curOrdNo" name="curOrdNo"/>
                        </td>

...
[
    ...
    ,   { dataField : "invcItmDiscRate", cellMerge : true, mergeRef : "mobTicketNo", mergePolicy : "restrict", width:120, headerText : "<spring:message code='pay.head.discountRate'/>", dataType : "numeric" }
    ,   { dataField : "invcItmExgAmt", cellMerge : true, mergeRef : "mobTicketNo", mergePolicy : "restrict", width:140, headerText : "<spring:message code='pay.head.existingAmount'/>", dataType : "numeric" }

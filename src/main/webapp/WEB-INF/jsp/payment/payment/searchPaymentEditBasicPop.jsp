...
<div id="edit_popup_wrap" class="popup_wrap" style="display:;">
  ...
  <section class="pop_body"><!-- pop_body start -->
              ...
              <caption>table</caption>
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td id="">
                              <input type="text" name="edit_txtCollectorCode" id="edit_txtCollectorCode" style="width:80px" disabled/>
                              <p class="btn_sky"  id="sale_confirmbt" ><a href="#" onclick="this.disabled=true"><spring:message code='pay.btn.confirm'/></a></p>
                              <p class="btn_sky"  id="sale_searchbt"><a href="#" onclick="this.disabled=true"><spring:message code='sys.btn.search'/></a></p>
                              <p class="btn_sky"  id="sale_resetbt"><a href="#" onclick="this.disabled=true">Remove</a></p>
                           </td>
      ...
      <ul class="left_btns">
          <li><label><input name="btnAllowComm" id="btnAllowComm" type="checkbox"  disabled = "disabled"  /><span>Allow commission for this payment </span></label></li>
      </ul>

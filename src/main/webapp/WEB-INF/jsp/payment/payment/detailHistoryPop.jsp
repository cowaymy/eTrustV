...
function showViewDetailHistory(payItemId){
	  ...
	  Common.ajax("GET", "/payment/selectDetailHistoryList", {"payItemId" : payItemId} , function(result) {
		  viewHistoryGridID_V = GridCommon.createAUIGrid("grid_detail_history_v", viewHistoryLayout,null,gridPros);   
...
<div id="view_detail_wrap_v" class="popup_wrap size_small" style="display:;">
    ...
    <section class="pop_body">
        ...
        <!-- grid_wrap start -->
        <article id="grid_detail_history_v" class="grid_wrap"></article>
        <!-- grid_wrap end -->
    </section>
    <!-- pop_body end -->
</div>

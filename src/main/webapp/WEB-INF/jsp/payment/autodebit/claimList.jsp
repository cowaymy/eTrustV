  ...
  function fn_openDivPopDown() {
    ...
    if (selectedItem[0] > -1) {
      ...
      var stusName = AUIGrid.getCellValue(myGridID, selectedGridValue,
          "stusName");
      var bankCode = AUIGrid.getCellValue(myGridID, selectedGridValue,
    	  "bankCode");
     ...
     <dl class="link_list">
      ...
      <dd>
       <ul class="btns">
        ...
        <li><p class="link_btn">
          <a href="javascript:fn_openDivPop('SMS');"><spring:message
            code='pay.btn.failDeductionSMS' /></a>
         </p></li>
       </ul>
       <ul class="btns">
        ...
        <li><p class="link_btn type2">
          <a href="javascript:fn_openDivScheduleSettingPop();"><spring:message
            code='pay.btn.scheduleSetting' /></a>
         </p></li>
        <li><p class="link_btn type2">
          <a href="javascript:fn_openDivScheduleBatchPop();"><spring:message
            code='pay.btn.scheduleClaimBatch' /></a>
         </p></li>
       </ul>
       <p class="hide_btn">
        <a href="#"><img

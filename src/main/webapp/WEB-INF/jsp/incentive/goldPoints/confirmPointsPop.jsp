...
function fn_confirm(){
    if ('${pointsBatchInfo.stusName}' == 'Completed' || '${pointsBatchInfo.stusName}' == 'Inactive') {
        Common.alert("Batch is Completed/Inactive. Confirmation not allowed.");
    } else {
        Common.ajax("GET", "/incentive/goldPoints/pointsUploadConfirm", $("#form_pointsDtlView").serializeJSON() , function(result) {
...
function fn_reject() {
       if ('${pointsBatchInfo.stusName}' == 'Completed' || '${pointsBatchInfo.stusName}' == 'Inactive') {
            ...
            Common.ajax("GET", "/incentive/goldPoints/pointsUploadReject", $("#form_pointsDtlView").serializeJSON() , function(result) {

...
<script type="text/javaScript">
	var myGridID_7002CDG;
	var today = "${today}";
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002CDG, "cellClick", function(event) {
		...
		$("#search_7002CD").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7002CD", $("#form7002CD").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002CDG, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7002CDG = AUIGrid.create("#grid_wrap_7002CDG", columnLayout_7002CD,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002CDG" style="width: 100%; height: 334px; margin: 0 auto;"></div>

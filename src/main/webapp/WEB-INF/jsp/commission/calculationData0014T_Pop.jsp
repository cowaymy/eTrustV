...
<script type="text/javaScript">
  ...
  $(document)
      .ready(
          function() {
            ...
            // ready 이벤트 바인딩
            AUIGrid.bind(myGridID_14T, "ready",
                function(event) {
                  gridDataLength = AUIGrid
                      .getGridData(myGridID_14T).length; // 그리드 전체 행수 보관
                });

            // cellClick event.
            AUIGrid.bind(myGridID_14T, "cellClick",
                function(event) {
                ...
                .click(
                    function() {
                      ...
                      Common
                          .ajax(
                              "GET",
                              "/commission/calculation/selectDataCMM014T",
                              $("#form_14T")
                                  .serialize(),
                              function(result) {
                                console
  ...
  function fn_saveExculde() {
    Common.ajax("POST", "/commission/calculation/updatePrdData_14T.do",
        GridCommon.getEditData(myGridID_14T), function(result) {
          // 공통 메세지 영역에 메세지 표시.
  ...
  function createAUIGrid() {
    ...
    myGridID_14T = AUIGrid
        .create("#grid_wrap_14T", columnLayout3, gridPros);
  }
  ...
  function fn_downFile() {
    Common
        .ajax(
            "GET",
            "/commission/calculation/cntCMM0014T",
            $("#form_14T").serialize(),
            function(result) {
              var cnt = result;
              if (cnt > 0) {
  ...
  function fn_AlldownFile() {
    var data = {
      "searchDt" : $("#CMM0014T_Dt").val(),
      "code" : $("#code_14T").val(),
      "codeId" : $("#orgGroup_14").val()
    };
    Common
        .ajax(
            "GET",
...
<div id="popup_wrap2" class="popup_wrap">
 ...
 <section class="pop_body" style="max-height: 600px;">
  ...
  <!-- title_line end -->
  <form id="form_14T">
   <input type="hidden" name="code" id="code_14T" value="${code}" /> <input
    type="hidden" id="fileName" name="fileName"
    value="gatherNcompileIntroduction.xlsx" />
   <ul class="right_btns">
    <li><p class="btn_blue">
      <a href="#" id="search_14T"><span class="search"></span>
   ...
   <table class="type1 mt10">
    ...
    <tbody>
     <tr>
      ...
      <td><input type="text" id="emplyCd_14T" name="emplyCd"
     ...
     <!-- <tr>
      ...
      <td colspan=5><select id="useYnCombo_14T" name="useYnCombo"
       style="width: 100px;">

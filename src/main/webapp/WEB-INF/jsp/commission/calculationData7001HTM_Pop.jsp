...
<script type="text/javaScript">
	var myGridID_7001HTM;
	var today = "${today}";

	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001HTM, "cellClick", function(event) {
		...
		$("#search_7001HT").click(function(){
			Common.ajax("GET", "/commission/calculation/selectData7001HT", $("#form7001HT").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001HTM, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7001HT = [ {
        ...
        dataField : "v10",
        headerText : "<spring:message code='commissiom.text.excel.grpSalesPro'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v11",
        ...
        dataField : "v12",
        headerText : "<spring:message code='commissiom.text.excel.dropRate'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v13",
        ...
        dataField : "v16",
        headerText : "<spring:message code='commissiom.text.excel.rcAmt'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v17",
        ...
        dataField : "v18",
        headerText : "<spring:message code='commissiom.text.excel.completBsCnt'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v19",
        ...
        dataField : "v24",
        headerText : "<spring:message code='commissiom.text.excel.shiRenCmmRate'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v25",
	...
	myGridID_7001HTM = AUIGrid.create("#grid_wrap_7001HTM", columnLayout_7001HT,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001HTM" style="width: 100%; height: 334px; margin: 0 auto;"></div>

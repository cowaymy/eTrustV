    ...
    $(document).ready(function() {
        ...
        $("#save_26T").click(function(){  
            ...
            if(emplyId == "" || emplyId == null){
	        	...
	        	var checkdata = AUIGrid.getCheckedRowItemsAll(myGridID_26T);
	            var check     = AUIGrid.getCheckedRowItems(myGridID_26T);
	            var formList = $("#form_26").serializeJSON();       //폼 데이터
	            ...
	            Common.ajax("POST", "/commission/calculation/updatePrdData_26T.do", data , function(result) {
	                // 공통 메세지 영역에 메세지 표시.
	   ...
	   Common.ajax("GET", "/commission/calculation/cntCMM0026T", $("#form_26").serialize(), function(result) {
           ...
           if(cnt > 0){
               ...
               if(emplyId == "" || emplyId == null){
			       ...
			       var ordId = $("#emplyId_26T").val();
			       //window.open("<c:url value='/sample/down/excel-xls.do?aaa=" + fileName + "'/>");
			       //window.open("<c:url value='/sample/down/excel-xlsx.do?aaa=" + fileName + "'/>");
			       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&ordId="+ordId+"&memCode="+memCode+"'/>");
		       //}
		   }else{

	   ...
	   Common.ajax("GET", "/commission/calculation/cntCMM0026T", $("#form_26").serialize(), function(result) {
           ...
           if(cnt > 0){
               ...
               if(emplyId == "" || emplyId == null){
			       ...
			       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&emplyId="+emplyId+"&useYnCombo="+useYnCombo+"'/>");
		       //}
		   }else{

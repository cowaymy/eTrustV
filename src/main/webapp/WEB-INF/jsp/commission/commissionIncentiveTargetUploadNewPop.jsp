...
<script type="text/javaScript">
	...
	function fn_sampleFormat(val){
		if(val == null || val ==""){
			...
			if (val == "1062")
	        {
				Common.popupDiv("/commission/calculation/commIncentiveUploadSamplePop.do");
	        }
	        else
	        {
	        	Common.alert('No Sample to show for this upload type.');
	...
	function fn_uploadCsvFile(){
		Common.ajax("GET", "/commission/calculation/ValiUploadBatch", $("#newForm").serialize(), function(result) {
			if(result>0){

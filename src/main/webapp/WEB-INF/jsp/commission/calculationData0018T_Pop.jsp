   ...
   function fn_downFile() {
	   Common.ajax("GET", "/commission/calculation/cntCMM0018T", $("#form_18T").serialize(), function(result) {
           ...
           if(cnt > 0){
		       ...
		       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&ordId="+ordId+"&instPersonId="+instPersonId+"&useYnCombo="+useYnCombo+"'/>");
	       }else{

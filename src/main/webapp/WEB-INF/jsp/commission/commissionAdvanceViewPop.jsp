...
<script type="text/javaScript">
	...
	function fn_itemDetailSearch(val){
	    var uploadId = $('#uploadBatchId').val();

	    if(val == "0"){
	        var valTemp = {"uploadId" : uploadId};
	        Common.ajax("GET", "/commission/calculation/advIncentiveItemList", valTemp, function(result) {
...
<input type="hidden" name="uploadId" id="uploadBatchId" value="${uploadId }">

...
var cdGridID;
    ...
    $(document).ready(function() {
    	...
    	Common.ajax("GET","/commission/calculation/commIncentiveUploadSampleHpList","", function(result) {
            console.log("성공.");
    	...
    	Common.ajax("GET","/commission/calculation/commIncentiveUploadSampleCdList","", function(result) {
            console.log("성공.");
            console.log("data : " + result);

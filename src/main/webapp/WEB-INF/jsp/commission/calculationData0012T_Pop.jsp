	   ...
	   Common.ajax("GET", "/commission/calculation/cntCMM0012T", $("#form_12T").serialize(), function(result) {
           ...
           if(cnt > 0){
		       ...
		       if(ordId == "" || ordId == null){
			       ...
			       window.location.href="<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&clctrId="+clctrId+"&ordId="+ordId+"&useYnCombo="+useYnCombo+"'/>";
		       //}
		   }else{

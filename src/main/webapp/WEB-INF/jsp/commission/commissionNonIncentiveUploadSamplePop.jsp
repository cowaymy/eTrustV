...
var htGridID;
    ...
    $(document).ready(function() {
    	...
    	Common.ajax("GET","/commission/calculation/nonIncntivSampleHpList","", function(result) {
            //console.log("성공.");
            console.log("data : " + result);
            AUIGrid.setGridData(hpGridID, result);
        });

    	Common.ajax("GET","/commission/calculation/nonIncntivSampleCdList","", function(result) {
            //console.log("성공.");
            console.log("data : " + result);
            AUIGrid.setGridData(cdGridID, result);
        });

    	Common.ajax("GET","/commission/calculation/nonIncntivSampleHtList","", function(result) {
            //console.log("성공.");
            console.log("data : " + result);
...
<h1><spring:message code='commission.title.pop.head.nonIncentiveSample'/></h1>
<ul class="right_opt">

	   ...
	   Common.ajax("GET", "/commission/calculation/cntCMM0008T", $("#form_08T").serialize(), function(result) {
           ...
           if(cnt > 0){
		       ...
		       if(svcPersonId == "" || svcPersonId == null){
			       ...
			       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&svcPersonId="+svcPersonId+"&cmpltUserId="+cmpltUserId+"&useYnCombo="+useYnCombo+"'/>");
		       //}
		   }else{

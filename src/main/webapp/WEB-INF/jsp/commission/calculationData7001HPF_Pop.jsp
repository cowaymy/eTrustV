...
<script type="text/javaScript">
	var myGridID_7001HPF;
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001HPF, "cellClick", function(event) {
		...
		$("#search_7001HP").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7001HP", $("#form7001HP").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001HPF, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7001HPF = AUIGrid.create("#grid_wrap_7001HPF", columnLayout_7001HP,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001HPF" style="width: 100%; height: 334px; margin: 0 auto;"></div>

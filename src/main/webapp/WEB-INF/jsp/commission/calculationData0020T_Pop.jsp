...
<script type="text/javaScript">
    ...
    function fn_saveExculde(){
        ...
        var formList = $("#form_20T").serializeJSON();       //폼 데이터
        ...
        Common.ajax("POST", "/commission/calculation/updatePrdData_20T.do", data , function(result) {
            // 공통 메세지 영역에 메세지 표시.
   ...
   function fn_downFile() {
	   Common.ajax("GET", "/commission/calculation/cntCMM0020T", $("#form_20T").serialize(), function(result) {
           ...
           if(cnt > 0){
		       ...
		       window.location.href="<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&ordId="+ordId+"&asEntryId="+asEntryId+"&useYnCombo="+useYnCombo+"'/>";
	       }else{

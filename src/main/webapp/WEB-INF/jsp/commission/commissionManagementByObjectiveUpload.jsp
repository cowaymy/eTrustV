...
<script type="text/javaScript">
	...
	$(document).ready(function() {
        ...
        doGetCombo('/common/selectCodeList.do', '406', '', 'typeList', 'M' ,'type_multiCombo');
        ...
        $("#search").click(function(){
            Common.ajax("POST", "/commission/calculation/selectMBOTargetList", $("#myForm").serializeJSON(), function(result) {
                uploadId = "";
                stusId = "";
	...
	function newUploadPop(){
		Common.popupDiv("/commission/calculation/commMBOUploadNewPop.do");
	}
	...
	function confirmUploadPop(){
		if(uploadId == null || uploadId == ""){
			...
			if(stusId != "1"){
	            ...
	            Common.popupDiv("/commission/calculation/commMboConfirmPop.do",valTemp);
	        }
		}
	}
	...
	function uploadViewPop(){
        if(uploadId == null || uploadId == ""){
            ...
            Common.popupDiv("/commission/calculation/commMboViewPop.do",valTemp);
        }
    }
...
<section id="content">
	...
	<ul class="path">
		...
		<li>Commission</li>
		<li><spring:message code='commission.title.mboTarget'/></li>
	</ul>
	...
	<aside class="title_line">
		...
		<h2><spring:message code='commission.title.mboTarget'/></h2>
		<ul class="right_btns">

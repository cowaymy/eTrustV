...
<script type="text/javaScript">
	...
	function fn_nonIncenItemSavs(){
		if(fn_ValidIncenItem()){
			Common.ajax("GET", "/commission/calculation/nonIncentiveItemValid", $("#addForm").serializeJSON(), function(result) {
				if(result.code != "00"){
					...
					$("#hiddenMemberTypeID").val(result.data.MEM_TYPE);
			 		 ...
			 		 Common.ajaxSync("GET", "/commission/calculation/nonIncentiveItemInsert", $("#addForm").serializeJSON(), function(result2) {
...
<h1><spring:message code='commission.title.pop.head.nonIncentiveUpload'/></h1>
<ul class="right_opt">

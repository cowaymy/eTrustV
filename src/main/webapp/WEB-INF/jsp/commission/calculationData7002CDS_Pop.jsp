...
<script type="text/javaScript">
	...
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002CDS, "cellClick", function(event) {
		...
		$("#search_7002CD").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7002CD", $("#form7002CD").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002CDS, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7002CDS = AUIGrid.create("#grid_wrap_7002CDS", columnLayout_7002CD,gridPros);
   }
	   ...
	   <aside class="title_line"><!-- title_line start -->
		...
		<form id="form7002CD">
		  <input type="hidden" name="actionType" id="actionType_7002" value="${actionType }"/>
		   ...
		   <input type="hidden" id="fileName" name="fileName" value="cody_CDS_basic.xlsx"/>
		   <ul class="right_btns">
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002CDS" style="width: 100%; height: 334px; margin: 0 auto;"></div>

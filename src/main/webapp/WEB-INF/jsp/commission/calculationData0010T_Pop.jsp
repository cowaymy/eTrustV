           ...
           if(cnt > 0){
			  /*  var ordId = $("#ordId_10T").val();
		       ...
		       if(ordId == "" || ordId == null){
			       ...
			       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&salesPersonId="+salesPersonId+"&ordId="+ordId+"'/>");
		       //}
		   }else{

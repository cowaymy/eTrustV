...
<script type="text/javaScript">
    ...
    function fn_loadOrderSalesman(memId, memCode) {
        $("#salesPersonId_10T").val(memId);
        console.log('fn_loadOrderSalesman memId:'+memId);
        console.log('fn_loadOrderSalesman memCd:'+memCode);
    }
    
    function fn_saveExculde(){
    	var checkdata = AUIGrid.getCheckedRowItemsAll(myGridID_10T);
        var check     = AUIGrid.getCheckedRowItems(myGridID_10T);
        var formList = $("#form_10T").serializeJSON();       //폼 데이터
      ...
      //param data array
        ...
        Common.ajax("POST", "/commission/calculation/updatePrdData_10T.do", data , function(result) {
            // 공통 메세지 영역에 메세지 표시.
           ...
           if(cnt > 0){
			  /*  var ordId = $("#ordId_10T").val();
		       ...
		       if(ordId == "" || ordId == null){
			       ...
			       var salesPersonId = $("#salesPersonId_10T").val();
			       var ordId = $("#ordId_10T").val();
			       var useYnCombo = $("#useYnCombo_10T").val();
			       //window.open("<c:url value='/sample/down/excel-xls.do?aaa=" + fileName + "'/>");
			       //window.open("<c:url value='/sample/down/excel-xlsx.do?aaa=" + fileName + "'/>");
		         
			       window.location.href="<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&salesPersonId="+salesPersonId+"&ordId="+ordId+"&useYnCombo="+useYnCombo+"'/>";
		       //}
		   }else{
            ...
            <table class="type1 mt10"><!-- table start -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                              <input type="text" id="salesPersonId_10T" name="salesPersonId" style="width: 100px;" maxlength="10" onkeydown="onlyNumber(this)">

...
<script type="text/javaScript">
	var myGridID_7001CDG;
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001CDG, "cellClick", function(event) {
		...
		$("#search_7001CD").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7001CD", $("#form7001CD").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001CDG, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7001CD = [ {
        ...
        dataField : "v1",
        headerText : "GCM PE calculation revised",
        style : "my-column",
        editable : false
    },{
        dataField : "v2",
        ...
        dataField : "v18",
        headerText : "PV total of out/inst",
        style : "my-column",
        editable : false
    },{
        dataField : "v19",
	...
	myGridID_7001CDG = AUIGrid.create("#grid_wrap_7001CDG", columnLayout_7001CD,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001CDG" style="width: 100%; height: 334px; margin: 0 auto;"></div>

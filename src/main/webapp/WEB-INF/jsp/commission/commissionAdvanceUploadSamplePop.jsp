...
var htGridID;
    ...
    $(document).ready(function() {
    	...
    	Common.ajax("GET","/commission/calculation/advanceSampleHpList","", function(result) {
            //console.log("성공.");
            console.log("data : " + result);
            AUIGrid.setGridData(hpGridID, result);
        });

    	Common.ajax("GET","/commission/calculation/advanceSampleCdList","", function(result) {
            //console.log("성공.");
            console.log("data : " + result);
            AUIGrid.setGridData(cdGridID, result);
        });

    	Common.ajax("GET","/commission/calculation/advanceSampleHtList","", function(result) {
            //console.log("성공.");
            console.log("data : " + result);
...
<h1>ADVANCE UPLOAD - REF CODE SAMPLE</h1>
<ul class="right_opt">

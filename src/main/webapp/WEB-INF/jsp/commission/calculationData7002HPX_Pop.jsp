...
<script type="text/javaScript">
	var myGridID_7002HPX;
	var today = "${today}";

	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002HPX, "cellClick", function(event) {
		...
		$("#search_7002HP").click(function(){
			Common.ajax("GET", "/commission/calculation/selectData7002HP", $("#form7002HP").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002HPX, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7002HP = [ {
        ...
        dataField : "r1",
        headerText : "<spring:message code='commissiom.text.excel.performIncenNeo'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r2",
        ...
        dataField : "r5",
        headerText : "performance allowance",
        style : "my-column",
        editable : false
    },{
        dataField : "r13",
        ...
        dataField : "r19",
        headerText : "<spring:message code='commissiom.text.excel.smOveridding'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r22",
        headerText : "<spring:message code='commissiom.text.excel.hmOveridding'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r25",
        headerText : "<spring:message code='commissiom.text.excel.tbbAmt'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r28",
        ...
        dataField : "r39",
        headerText : "<spring:message code='commissiom.text.excel.PersonOutPlusCmm'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r40",
        ...
        dataField : "r50",
        headerText : "<spring:message code='commissiom.text.excel.ws'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r100",
	...
	myGridID_7002HPX = AUIGrid.create("#grid_wrap_7002HPX", columnLayout_7002HP,gridPros);
   }

   function fn_downFile() {
	   Common.ajax("GET", "/commission/calculation/cntData7002HPX", $("#form7002HP").serialize(), function(result) {
           var cnt = result;
           if(cnt > 0){
   ...
   function fn_AlldownFile() {
	   var data = { "searchDt" : $("#7002HP_Dt").val() , "code": $("#code").val() ,"actionType":$("#actionType_7002").val()};
	   Common.ajax("GET", "/commission/calculation/cntData7002HPX", data, function(result) {
           var cnt = result;
           if(cnt > 0){
        	   var fileName = $("#fileName").val() +"_"+today;
               fileName=fileName+".xlsx";
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<form id="form7002HP">
			...
			<input type="hidden" id="fileName" name="fileName" value="hp_full_basic.xlsx"/>
		   <ul class="right_btns">
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002HPX" style="width: 100%; height: 334px; margin: 0 auto;"></div>

...
<div id="popup_wrap" class="popup_wrap size_mid">
	...
	<header class="pop_header">
		<h1><spring:message code='commission.title.pop.head.NonMonetaryIncentiveNew'/></h1>
		<ul class="right_opt">
	...
	<section class="pop_body">
				...
				<tr>
					...
					<td>
						<select class="" name="cmbType" id="cmbType">
						   <option value=""></option>
							<option value="6465">Cody/HP/HT Non-Monetary Incentive</option>
						</select>
					</td>
				</tr>
				<tr>
		...
		<ul class="center_btns">
			...
			<li><p class="btn_blue"><a href="${pageContext.request.contextPath}/resources/download/NonMonetaryIncentiveUploadFormat.csv"><spring:message code='commission.button.dwCsvFormat'/></a></p></li>
		</ul>

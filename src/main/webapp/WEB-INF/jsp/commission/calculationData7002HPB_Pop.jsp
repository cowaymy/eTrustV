...
<script type="text/javaScript">
	var myGridID_7002HPB;
	var today = "${today}";
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002HPB, "cellClick", function(event) {
		...
		$("#search_7002HP").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7002HP", $("#form7002HP").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002HPB, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7002HP = [ {
        ...
        dataField : "r5",
        headerText : "<spring:message code='commissiom.text.excel.pa'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r13",
        ...
        dataField : "r35",
        headerText : "<spring:message code='commissiom.text.excel.rentalmembershipShiAmt'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r36",
	...
	myGridID_7002HPB = AUIGrid.create("#grid_wrap_7002HPB", columnLayout_7002HP,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002HPB" style="width: 100%; height: 334px; margin: 0 auto;"></div>

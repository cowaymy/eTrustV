...
<script type="text/javaScript">
	var myGridID_7001CTM;
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001CTM, "cellClick", function(event) {
		...
		$("#search_7001CT").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7001CT", $("#form7001CT").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001CTM, result);
			});
		});
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001CTM" style="width: 100%; height: 334px; margin: 0 auto;"></div>

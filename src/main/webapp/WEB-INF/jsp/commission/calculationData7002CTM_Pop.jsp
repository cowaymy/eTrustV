...
<script type="text/javaScript">
	var myGridID_7002CTM;
	var today = "${today}";
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002CTM, "cellClick", function(event) {
		...
		$("#search_7002CT").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7002CT", $("#form7002CT").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002CTM, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7002CTM = AUIGrid.create("#grid_wrap_7002CTM", columnLayout_7002CT,gridPros);
   }
	   ...
	   <aside class="title_line"><!-- title_line start -->
		...
		<form id="form7002CT">
		  <input type="hidden" name="actionType" id="actionType_7002" value="${actionType }"/>
		   ...
		   <input type="hidden" id="fileName" name="fileName" value="ct_Manager_basic.xlsx"/>
		   <ul class="right_btns">
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002CTM" style="width: 100%; height: 334px; margin: 0 auto;"></div>

...
<script type="text/javaScript">
  ...
  $(document)
      .ready(
          function() {
            ...
            // ready 이벤트 바인딩
            AUIGrid.bind(myGridID_22T, "ready",
                function(event) {
                  gridDataLength = AUIGrid
                      .getGridData(myGridID_22T).length; // 그리드 전체 행수 보관
                });

            // cellClick event.
            AUIGrid.bind(myGridID_22T, "cellClick",
                function(event) {
                ...
                .click(
                    function() {
                      Common
                          .ajax(
                              "GET",
                              "/commission/calculation/selectDataCMM022T",
                              $("#form_22")
                                  .serialize(),
                              function(result) {
                                console
  ...
  function fn_saveExculde() {
    Common.ajax("POST", "/commission/calculation/updatePrdData_22T.do",
        GridCommon.getEditData(myGridID_22T), function(result) {
          // 공통 메세지 영역에 메세지 표시.
  ...
  function createAUIGrid() {
    var columnLayout3 = [
        ...
        },
        {
          ...
          headerText : "<spring:message code='commissiom.text.excel.rcvCntrctId'/>",
          style : "my-column",
          editable : false
        },
        {
  ...
  function checkAll(isChecked) {
    ...
    if (isChecked) { // checked == true == 1
      for (var i = 0; i < rowCount; i++) {
        AUIGrid.updateRow(myGridID_22T, {
          "isExclude" : 1
        }, i);
      }
  ...
  function fn_downFile() {
    Common
        .ajax(
            "GET",
            "/commission/calculation/cntCMM0022T",
            $("#form_22").serialize(),
            function(result) {
              var cnt = result;
              if (cnt > 0) {
                ...
                var salesPersonCd = $("#salesPersonCd_22T")
                    .val();
  ...
  function fn_AlldownFile() {
    var data = {
      "searchDt" : $("#CMM0022T_Dt").val(),
      "code" : $("#code_22T").val(),
      "codeId" : $("#orgGroup_22").val()
    };
    Common
        .ajax(
            "GET",
...
<div id="popup_wrap2" class="popup_wrap">
 ...
 <section class="pop_body" style="max-height: 600px;">
  ...
  <!-- title_line end -->
  <form id="form_22">
   <input type="hidden" name="code" id="code_22T" value="${code}" /> <input
    type="hidden" id="fileName" name="fileName"
    value="RentalMembership.xlsx" />
   <ul class="right_btns">
    <li><p class="btn_blue">
      <a href="#" id="search_22T"><span class="search"></span>
   ...
   <table class="type1 mt10">
    ...
    <tbody>
     <tr>
      ...
      <td><input type="text" id="salesPersonCd_22T"
     ...
     <tr>
      ...
      <td colspan='5'><input type="text" id="ordId_22T" name="ordId"
       style="width: 100px;" maxlength="10" onkeydown="onlyNumber(this)">
      </td>
      <!-- <th scope="row"><spring:message
        code='commission.text.isExclude' /></th>
      <td colspan=3><select id="useYnCombo_22T" name="useYnCombo"
       style="width: 100px;">
  ...
  <article class="grid_wrap3">
   ...
   <ul class="right_btns">
    ...
    <!-- <li><p class="btn_grid">
      <a href="#" id="save_22T"><spring:message code='sys.btn.save' /></a>
     </p></li> -->
   </ul>
   <!-- grid_wrap start -->
   <div id="grid_wrap3"

	   ...
	   Common.ajax("GET", "/commission/calculation/cntCMM0009T", $("#form_09T").serialize(), function(result) {
           ...
           if(cnt > 0){
		       ...
		       if(ordId == "" || ordId == null){
			       ...
			       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&svcPersonId="+svcPersonId+"&custRespnsId="+custRespnsId+"&ordId="+ordId+"'/>");
		       //}
		   }else{

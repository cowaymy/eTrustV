...
<script type="text/javaScript">
	var myGridID_7001HTS;
	var today = "${today}";

	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001HTS, "cellClick", function(event) {
		...
		$("#search_7001HT").click(function(){
			Common.ajax("GET", "/commission/calculation/selectData7001HT", $("#form7001HT").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001HTS, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7001HTS = AUIGrid.create("#grid_wrap_7001HTS", columnLayout_7001HT,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001HTS" style="width: 100%; height: 334px; margin: 0 auto;"></div>

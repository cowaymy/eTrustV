...
<script type="text/javaScript">
	...
	$(document).ready(function() {
      ...
      //incentive List search
        $("#search").click(function(){
            Common.ajax("POST", "/commission/calculation/selectNonIncentiveTargetList", $("#myForm").serializeJSON(), function(result) {
                console.log("성공.");
	...
	function newUploadPop(){
		Common.popupDiv("/commission/calculation/nonIncntivUploadNewPop.do");
	}
	...
	function confirmUploadPop(){
		if(uploadId == null || uploadId == ""){
			...
			if(stusId != "1"){
	            ...
	            Common.popupDiv("/commission/calculation/commNonIncntiveConfirmPop.do",valTemp);
	        }
		}
	}
	...
	function uploadViewPop(){
        if(uploadId == null || uploadId == ""){
            ...
            Common.popupDiv("/commission/calculation/commNonIncntivViewPop.do",valTemp);
        }
    }
...
<section id="content">
	...
	<aside class="title_line">
		...
		<h2><spring:message code='commission.title.NonMonetaryIncentive'/></h2>
		<ul class="right_btns">

...
<script type="text/javaScript">
	var myGridID_7002CDTX;
	var today = "${today}";

	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002CDTX, "cellClick", function(event) {
		...
		$("#search_7002CD").click(function(){
			Common.ajax("GET", "/commission/calculation/selectData7002CD", $("#form7002CD").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002CDTX, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7002CD = [ {
        ...
        dataField : "r30",
        headerText : "<spring:message code='commission.text.grid.salesComm'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r34",
        ...
        dataField : "r36",
        headerText : "<spring:message code='commission.text.grid.renMemSalesCmm'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r38",
	...
	myGridID_7002CDTX = AUIGrid.create("#grid_wrap_7002CDTX", columnLayout_7002CD,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002CDTX" style="width: 100%; height: 334px; margin: 0 auto;"></div>

...
<script type="text/javaScript">
  ...
  $(document).ready( function() {
                      ...
                      if (valid) {
                        ...
                        Common.ajax("GET","/commission/report/commSHIMemSearch",$("#myForm").serializeJSON(),function(result) {
                                  if (result != null) {
                                    ...
                                    Common.ajaxSync("GET","/commission/report/commSPCRgenrawSHIIndex2",$("#myForm").serializeJSON(),function(result) {
            ...
            AUIGrid.bind(myGridID2,"cellDoubleClick",function(event) {
                      ...
                      if($('#level').val() <= level){
                    	  Common.popupDiv("/commission/report/commSHIIndexViewDetailsPop2.do", data);
                      }
                    });
            ...
            $("#generate").click(function() {
                      ...
                      if (valid <= 0) {
                        ...
                        var reportFileName = "/commission/SHIIndexExcelRaw2.rpt"; //reportFileName

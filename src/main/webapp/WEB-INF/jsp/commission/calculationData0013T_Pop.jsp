...
<script type="text/javaScript">
  ...
  $(document)
      .ready(
          function() {
            ...
            // ready 이벤트 바인딩
            AUIGrid.bind(myGridID_13T, "ready",
                function(event) {
                  gridDataLength = AUIGrid
                      .getGridData(myGridID_13T).length; // 그리드 전체 행수 보관
                });

            // cellClick event.
            AUIGrid.bind(myGridID_13T, "cellClick",
                function(event) {
                    ...
                    function() {
                      ...
                      if (clctrCd == ""
                        ...
                        Common
                            .ajax(
                                "GET",
                                "/commission/calculation/selectDataCMM013T",
                                $("#form_13T")
                                    .serialize(),
                                function(result) {
                                  console
  ...
  function fn_saveExculde() {
    Common.ajax("POST", "/commission/calculation/updatePrdData_13T.do",
        GridCommon.getEditData(myGridID_13T), function(result) {
          // 공통 메세지 영역에 메세지 표시.
  ...
  function createAUIGrid() {
    ...
    myGridID_13T = AUIGrid
        .create("#grid_wrap_13T", columnLayout3, gridPros);
  }
  ...
  function checkAll(isChecked) {
    ...
    if (isChecked) { // checked == true == 1
      for (var i = 0; i < rowCount; i++) {
        AUIGrid.updateRow(myGridID_13T, {
          "isExclude" : 1
        }, i);
      }
  ...
  function fn_downFile() {
    ...
    if (clctrCd == "" || clctrCd == null) {
      ...
      Common
          .ajax(
              "GET",
              "/commission/calculation/cntCMM0013T",
              $("#form_13T").serialize(),
              function(result) {
                var cnt = result;
                if (cnt > 0) {
  ...
  function fn_AlldownFile() {
    var data = {
      "searchDt" : $("#CMM0013T_Dt").val(),
      "code" : $("#code_13T").val(),
      "codeId" : $("#orgGroup_13").val()
    };
    Common
        .ajax(
            "GET",
...
<div id="popup_wrap2" class="popup_wrap">
 ...
 <section class="pop_body" style="max-height: 600px;">
  ...
  <!-- title_line end -->
  <form id="form_13T">
   <input type="hidden" name="code" id="code_13T" value="${code}" /> <input
    type="hidden" id="fileName" name="fileName"
    value="customerRetentionRate.xlsx" />
   <ul class="right_btns">
    <li><p class="btn_blue">
      <a href="#" id="search_13T"><span class="search"></span>
   ...
   <table class="type1 mt10">
    ...
    <tbody>
     <tr>
      ...
      <td><input type="text" id="clctrCd_13T" name="clctrCd"
     ...
     <tr>
      ...
      <td colspan='5'><input type="text" id="ordId_13T" name="ordId"
       style="width: 100px;" maxlength="10" onkeydown="onlyNumber(this)">
      </td>
      <!-- <th scope="row"><spring:message
        code='commission.text.isExclude' /></th>
      <td colspan=3><select id="useYnCombo_13T" name="useYnCombo"
       style="width: 100px;">

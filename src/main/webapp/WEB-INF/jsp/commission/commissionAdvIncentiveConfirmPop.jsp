...
var itemGridID;
	...
	function fn_itemDetailSearch(val){
		if(val == "0"){
			$("#vStusId").val("");
			Common.ajax("GET", "/commission/calculation/advIncentiveItemList", $("#conForm").serializeJSON(), function(result) {
	...
	//item Add Pop
	function fn_itemAdd(){
		Common.popupDiv("/commission/calculation/commAdvInctivItemAddPop.do",$("#conForm").serializeJSON());
	}

	//item RemoveAjax
	function fn_removeItem(){
		Common.ajax("POST", "/commission/calculation/removeAdvIncentiveItem.do", GridCommon.getEditData(itemGridID) , function(result) {
	...
	function fn_deactivate(){
		...
		Common.ajax("GET", "/commission/calculation/advIncentiveDeactivateCheck", $("#conForm").serializeJSON() , function(result) {
			if(result > 0){
				Common.ajax("GET", "/commission/calculation/advIncentiveDeactivate", $("#conForm").serializeJSON() , function(result) {
	...
	function fn_confirm(){
		if(Number($("#cntValid").val()) < 1){
			...
			Common.ajax("GET", "/commission/calculation/advIncentiveConfirm", $("#conForm").serializeJSON() , function(result) {

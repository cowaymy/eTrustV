    ...
    $(document).ready(function() {
        ...
        $("#search_23T").click(function(){
            ...
            if(ordId == "" || ordId == null){
                ...
                return false;
            }else if(memCode == "" || memCode == null){
            	Common.alert("<spring:message code='sys.msg.necessary' arguments='member code' htmlEscape='false'/>");
                return false;
            }else{ */
        ...
        $("#save_23T").click(function(){  
        	/* if(ordId == "" || ordId == null){
	            ...
	            Common.ajax("POST", "/commission/calculation/updatePrdDataCMM0023T.do", data , function(result) {
	                // 공통 메세지 영역에 메세지 표시.

...
<script type="text/javaScript">
	var myGridID_7001CDS;
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001CDS, "cellClick", function(event) {
		...
		$("#search_7001CD").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7001CD", $("#form7001CD").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001CDS, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7001CDS = AUIGrid.create("#grid_wrap_7001CDS", columnLayout_7001CD,gridPros);
   }
   ...
   function fn_AlldownFile() {
	   var data = { "searchDt" : $("#7001CD_Dt").val() , "code": $("#code").val() };
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001CDS" style="width: 100%; height: 334px; margin: 0 auto;"></div>

...
<script type="text/javaScript">
  ...
  $(document)
      .ready(
          function() {
            ...
            // ready 이벤트 바인딩
            AUIGrid.bind(myGridID_15T, "ready",
                function(event) {
                  gridDataLength = AUIGrid
                      .getGridData(myGridID_15T).length; // 그리드 전체 행수 보관
                });

            // cellClick event.
            AUIGrid.bind(myGridID_15T, "cellClick",
                function(event) {
                ...
                .click(
                    function() {
                      Common
                          .ajax(
                              "GET",
                              "/commission/calculation/selectDataCMM015T",
                              $("#form_15T")
                                  .serialize(),
                              function(result) {
                                console
  ...
  function fn_saveExculde() {
    Common.ajax("POST", "/commission/calculation/updatePrdData_15T.do",
        GridCommon.getEditData(myGridID_15T), function(result) {
          // 공통 메세지 영역에 메세지 표시.
  ...
  function createAUIGrid() {
    var columnLayout3 = [
        ...
        {
          dataField : "payId",
          headerText : "<spring:message code='commission.text.grid.payId'/>",
          style : "my-column",
          editable : false
        },
        {
    ...
    myGridID_15T = AUIGrid
        .create("#grid_wrap_15T", columnLayout3, gridPros);
  }
  ...
  function fn_downFile_15T() {
    Common
        .ajax(
            "GET",
            "/commission/calculation/cntCMM0015T",
            $("#form_15T").serialize(),
            function(result) {
              var cnt = result;
              if (cnt > 0) {
  ...
  function fn_AlldownFile() {
    var data = {
      "searchDt" : $("#CMM0015T_Dt").val(),
      "code" : $("#code_15T").val(),
      "codeId" : $("#orgGroup_15").val()
    };
    Common
        .ajax(
            "GET",
...
<div id="popup_wrap2" class="popup_wrap">
 ...
 <section class="pop_body" style="max-height: 600px;">
  ...
  <!-- title_line end -->
  <form id="form_15T">
   <input type="hidden" name="code" id="code_15T" value="${code}" /> <input
    type="hidden" id="fileName" name="fileName"
    value="PaymentCollection.xlsx" />
   <ul class="right_btns">
    <li><p class="btn_blue">
      <a href="#" id="search_15T"><span class="search"></span>
   ...
   <table class="type1 mt10">
    ...
    <tbody>
     <tr>
      ...
      <td><input type="text" id="emplyCd_15T" name="emplyCd"
     ...
     <tr>
      ...
      <td colspan='5'><input type="text" id="ordId_15T" name="ordId"
       style="width: 100px;" onkeydown="onlyNumber(this)"></td>
      <!-- <th scope="row"><spring:message
        code='commission.text.isExclude' /></th>
      <td colspan="3"><select id="useYnCombo_15T" name="useYnCombo"
       style="width: 100px;">
  ...
  <article class="grid_wrap3">
   ...
   <ul class="right_btns">
    ...
    <li><p class="btn_grid">
      <a href="javascript:fn_downFile_15T()" id="addRow"><spring:message

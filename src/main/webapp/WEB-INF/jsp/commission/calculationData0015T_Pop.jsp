           ...
           if(cnt > 0){
			  /*  var ordId = $("#ordId_15T").val();
		       ...
		       if(ordId == "" || ordId == null){
			       ...
			       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&payId="+payId+"&ordId="+ordId+"&useYnCombo="+useYnCombo+"'/>");
		      // }
		   }else{

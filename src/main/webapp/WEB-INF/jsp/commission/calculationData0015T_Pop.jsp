...
<script type="text/javaScript">
    ...
    function fn_saveExculde(){
    	var checkdata = AUIGrid.getCheckedRowItemsAll(myGridID_15T);
        var check     = AUIGrid.getCheckedRowItems(myGridID_15T);
        var formList = $("#form_15T").serializeJSON();       //폼 데이터
        ...
        Common.ajax("POST", "/commission/calculation/updatePrdData_15T.do", data , function(result) {
            // 공통 메세지 영역에 메세지 표시.
           ...
           if(cnt > 0){
			  /*  var ordId = $("#ordId_15T").val();
		       ...
		       if(ordId == "" || ordId == null){
			       ...
			       var payId = $("#payId_15T").val();
			       var ordId = $("#ordId_15T").val();
			       var useYnCombo = $("#useYnCombo_15T").val();
			       //window.open("<c:url value='/sample/down/excel-xls.do?aaa=" + fileName + "'/>");
			       //window.open("<c:url value='/sample/down/excel-xlsx.do?aaa=" + fileName + "'/>");
			       window.location.href="<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&payId="+payId+"&ordId="+ordId+"&useYnCombo="+useYnCombo+"'/>";
		      // }
		   }else{
    ...
    <section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
       <aside class="title_line"><!-- title_line start -->
            ...
            <table class="type1 mt10"><!-- table start -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                              <input type="text" id="payId_15T" name="payId" style="width: 100px;" maxlength="10" onkeydown="onlyNumber(this)">
                        </td>
        ...
        <article class="grid_wrap3"><!-- grid_wrap start -->
            ...
            <ul class="right_btns">
                <li><p class="btn_grid">
                    <a href="javascript:fn_downFile_15T()" id="addRow"><span class="search"></span><spring:message code='sys.btn.excel.dw' /></a>
                </p></li>
                <li><p class="btn_grid">

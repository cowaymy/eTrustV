...
<script type="text/javaScript">
	var myGridID_7002HTM;
	var today = "${today}";

	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002HTM, "cellClick", function(event) {
		...
		$("#search_7002HT").click(function(){
			Common.ajax("GET", "/commission/calculation/selectData7002HT", $("#form7002HT").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002HTM, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7002HT = [ {
        ...
        dataField : "r26",
        headerText : "<spring:message code='commissiom.text.excel.telephoneDeduct'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r27",
	...
	myGridID_7002HTM = AUIGrid.create("#grid_wrap_7002HTM", columnLayout_7002HT,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002HTM" style="width: 100%; height: 334px; margin: 0 auto;"></div>

	   ...
	   Common.ajax("GET", "/commission/calculation/cntCMM0007T", $("#form_07T").serialize(), function(result) {
           ...
           if(cnt > 0){
		       ...
		       if(ordId == "" || ordId == null){
			       ...
			       window.open("<c:url value='/commission/down/excel-xlsx-streaming.do?fileName=" + fileName + "&year="+year+"&month="+month+"&code="+code+"&codeId="+codeId+"&memberId="+memberId+"&ordId="+ordId+"'/>");
		       //}
		   }else{

...
<script type="text/javaScript">
    var myGridID_7002HTX;
    var today = "${today}";

    $(document).ready(function() {
        createAUIGrid();
        // cellClick event.
        AUIGrid.bind(myGridID_7002HTX, "cellClick", function(event) {
              console.log("rowIndex : " + event.rowIndex + ", columnIndex : " + event.columnIndex + " clicked");
        });

        //Rule Book Item search
        $("#search_7002HT").click(function(){
            Common.ajax("GET", "/commission/calculation/selectData7002HT", $("#form7002HT").serialize(), function(result) {
                console.log("성공.");
                console.log("data : " + result);
                AUIGrid.setGridData(myGridID_7002HTX, result);
            });
        });

        $('#memBtn').click(function() {
            //Common.searchpopupWin("searchForm", "/common/memberPop.do","");
            Common.popupDiv("/common/memberPop.do", $("#form7002HT").serializeJSON(), null, true);
        });
    });

    function fn_loadOrderSalesman(memId, memCode) {
        $("#memberCd_7002HT").val(memCode);
        console.log(' memId:'+memId);
        console.log(' memCd:'+memCode);
    }

   function createAUIGrid() {
    var columnLayout_7002HT = [ {
        dataField : "runId",
        style : "my-column",
        editable : false,
        visible : false
        ...
        dataField : "r66",
        headerText : "<spring:message code='commissiom.text.excel.csCommKing'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r67",
        headerText : "<spring:message code='commissiom.text.excel.csCommQueen'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r68",
        headerText : "<spring:message code='commissiom.text.excel.csCommSingle'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r100",
        headerText : "Withholding Tax",
        style : "my-column",
        editable : false
    }];
    // 그리드 속성 설정
    ...
    myGridID_7002HTX = AUIGrid.create("#grid_wrap_7002HTX", columnLayout_7002HT,gridPros);
   }

   function fn_downFile() {
       Common.ajax("GET", "/commission/calculation/cntData7002HT", $("#form7002HT").serialize(), function(result) {
           var cnt = result;
           if(cnt > 0){
               //excel down load name 형식 어떻게 할지?
               var fileName = $("#fileName").val() +"_"+today;
                fileName=fileName+".xlsx";
               var searchDt = $("#7002HT_Dt").val();
               var year = searchDt.substr(searchDt.indexOf("/")+1,searchDt.length);
               var month = searchDt.substr(0,searchDt.indexOf("/"));
               var code = $("#code").val();
               var memberCd = $("#memberCd_7002HT").val();
   ...
   function fn_AlldownFile() {
       var data = { "searchDt" : $("#7002HT_Dt").val() , "code": $("#code").val() ,"actionType":$("#actionType_7002").val()};
       Common.ajax("GET", "/commission/calculation/cntData7002HT", data, function(result) {
           var cnt = result;
           if(cnt > 0){
               var fileName = $("#fileName").val() +"_"+today;
               fileName=fileName+".xlsx";
       ...
       <aside class="title_line"><!-- title_line start -->
        ...
        <form id="form7002HT">
          <input type="hidden" name="actionType" id="actionType_7002" value="${actionType }"/>
           ...
           <input type="hidden" id="fileName" name="fileName" value="HT_normal_7002_basic.xlsx"/>
           <ul class="right_btns">
              <li><p class="btn_blue"><a href="#" id="search_7002HT"><span class="search"></span><spring:message code='sys.btn.search'/></a></p></li>
            </ul>
            ...
            <table class="type1 mt10"><!-- table start -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                        <input type="text" title="Create start Date" placeholder="DD/MM/YYYY" name="searchDt" id="7002HT_Dt" class="j_date2" value="${searchDt_pop }" />
                        </td>
                        <th scope="row"><spring:message code='commission.text.search.memCode'/></th>
                        <td>
                              <input type="text" id="memberCd_7002HT" name="memberCd" style="width: 100px;">
        ...
        <article class="grid_wrap3"><!-- grid_wrap start -->
            ...
            <!-- grid_wrap start -->
            <div id="grid_wrap_7002HTX" style="width: 100%; height: 334px; margin: 0 auto;"></div>

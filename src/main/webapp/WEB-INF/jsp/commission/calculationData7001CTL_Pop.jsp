...
<script type="text/javaScript">
	var myGridID_7001CTL;
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001CTL, "cellClick", function(event) {
		...
		$("#search_7001CT").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7001CT", $("#form7001CT").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001CTL, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7001CTL = AUIGrid.create("#grid_wrap_7001CTL", columnLayout_7001CT,gridPros);
   }
   ...
   function fn_AlldownFile() {
	   var data = { "searchDt" : $("#7001CT_Dt").val() , "code": $("#code").val() };
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<form id="form7001CT">
		   ...
		   <input type="hidden" id="fileName" name="fileName" value="ct_leader_basic.xlsx"/>
		   <ul class="right_btns">
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001CTL" style="width: 100%; height: 334px; margin: 0 auto;"></div>

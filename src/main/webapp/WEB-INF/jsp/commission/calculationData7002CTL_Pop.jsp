...
<script type="text/javaScript">
	var myGridID_7002CTL;
	var today = "${today}";
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002CTL, "cellClick", function(event) {
		...
		$("#search_7002CT").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7002CT", $("#form7002CT").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002CTL, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7002CTL = AUIGrid.create("#grid_wrap_7002CTL", columnLayout_7002CT,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002CTL" style="width: 100%; height: 334px; margin: 0 auto;"></div>

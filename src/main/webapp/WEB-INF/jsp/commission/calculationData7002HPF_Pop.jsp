...
<script type="text/javaScript">
	var myGridID_7002HPF;
	var today = "${today}";
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002HPF, "cellClick", function(event) {
		...
		$("#search_7002HP").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7002HP", $("#form7002HP").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002HPF, result);
			});
		});
   ...
   function createAUIGrid() {
	...
	myGridID_7002HPF = AUIGrid.create("#grid_wrap_7002HPF", columnLayout_7002HP,gridPros);
   }
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002HPF" style="width: 100%; height: 334px; margin: 0 auto;"></div>

...
function fn_getInActivefilterInfo(){
    ...
    Common.ajax("GET", "/services/bs/getInActivefilterInfo.do", {salesOrdId : '${csOrderView.ordId}'}, function(result) {
...
function fn_getActivefilterInfo(){
    ...
    Common.ajax("GET", "/services/bs/getActivefilterInfo.do", {salesOrdId : '${csOrderView.ordId}'}, function(result) {
...
function fn_getAddFilter() {
    Common.popupDiv("/services/bs/hSAddFilterSetPop.do",{salesOrdId:'${csOrderView.ordId}'} , null, null , true , '');
}
...
<form action="#" method="post"  id='orderInfoForm'  name='orderInfoForm' >
    ...
    <input type="hidden" name="orderId"  id="orderId" value="${csOrderView.ordId}"/>
    <input type="hidden" name="hidStusId"  id="hidStusId" value="${csOrderView.ordStusId}"/>
    <input type="hidden" name="hidCustId"  id="hidCustId" value="${csOrderView.custId}"/>
...
<tr>
    ...
    <td>
    <input type="text" title="" id="entry_orderNo" name="entry_orderNo"  value="${csOrderView.ordNo}" placeholder="" class="readonly " readonly="readonly" style="width: 157px; " />
    </td>
    <th scope="row"><spring:message code='service.title.ApplicatonType'/></th>
    <td>
    <input type="text" title="" id="entry_appType" name="entry_appType"  value="${csOrderView.appTypeCode}" placeholder="" class="readonly " readonly="readonly" style="width: 157px; "/>
    </td>
    <th scope="row"><spring:message code='service.title.OrderStatus'/></th>
    <td>
    <input type="text" title="" id="entry_StusCode" name="entry_StusCode"  value="${csOrderView.ordStusCode}" placeholder="" class="readonly " readonly="readonly" style="width: 157px; "/>
    </td>
</tr>
<tr>
    <th scope="row"><spring:message code='service.title.ProductCode'/></th>
    <td>
    <input type="text" title="" id="entry_product" name="entry_product"  value="${csOrderView.stockCode}" placeholder="" class="readonly " readonly="readonly" style="width: 157px; "/>
    </td>
    <th scope="row"><spring:message code='service.title.ProductName'/></th>
    <td colspan="3">
    <input type="text" title="" id="entry_stockDesc" name="entry_stockDesc"  value="${csOrderView.stockDesc}" placeholder="" class="readonly " readonly="readonly" style="width: 306px; "/>
    <input  type='hidden' id='stkId' name='stkId'  value='${csOrderView.stkId}'></textarea>
    </td>
</tr>
<tr>
    <th scope="row"><spring:message code='service.title.CustomerName'/></th>
    <td colspan="3">
    <input type="text" title="" id="entry_custName" name="entry_custName"  value="${csOrderView.custName}" placeholder="" class="readonly " readonly="readonly" style="width: 444px; "/>
    </td>
    <th scope="row"><spring:message code='service.title.NRIC_CompanyNo'/></th>
    <td>
    <input type="text" title="" id="entry_nric" name="entry_nric"  value="${csOrderView.custNric}" placeholder="" class="readonly " readonly="readonly" style="width: 157px; "/>
    </td>
</tr>
</tbody>
</table><!-- table end -->

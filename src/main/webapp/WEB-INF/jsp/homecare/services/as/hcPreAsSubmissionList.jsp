...
<script type="text/javaScript">
    ...
    function fn_registerRequest(){
        Common.popupDiv("/homecare/services/as/hcPreAsSubmissionRegister.do", null, null, true, '');
    }
...
<!--          <td><select class="w100p" id="preAsErrorCode" name="preAsErrorCode"></select></td> -->
        ...
        <c:forEach var="list" items="${hcErrorCodeList}" varStatus="preAsErrorCode">
             <option value="${list.codeId}" selected>${list.codeName}</option>
        </c:forEach>
      </select></td>

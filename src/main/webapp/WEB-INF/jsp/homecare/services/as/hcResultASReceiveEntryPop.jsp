...
<script type="text/javaScript">
  ...
  function fn_getASHistoryInfo() {
	//console.log({"SALES_ORD_ID":'${orderDetail.basicInfo.ordId}', "SALES_ORD_NO":'${orderDetail.basicInfo.ordNo}'});
    Common.ajax("GET", "/homecare/services/as/getASHistoryList.do", {
  ...
  function fn_getBSHistoryInfo() {
    Common.ajax("GET", "/homecare/services/as/getBSHistoryList.do", {
      SALES_ORD_NO : '${orderDetail.basicInfo.ordNo}',
      SALES_ORD_ID : '${orderDetail.basicInfo.ordId}'
    }, function(result) {
    ...
    <div id='Panel_AS' style="display: inline">
     <section class="search_result">
       ...
       <section class="tap_wrap">
	       ...
	       <!------------------------------------------------------------------------------
	          Order Detail Page Include START - Order Info Tab-1
	        ------------------------------------------------------------------------------->
           ...
           <article class="tap_area">   <!--  After Service Tab-2 -->
               <article class="grid_wrap">
                   <div id="ashistory_grid_wrap" style="width: 100%; height: 300px; margin: 0 auto;"></div>
               </article>
           </article>
           <article class="tap_area">   <!--  Before Service Tab-3 -->
               <article class="grid_wrap">
      ...
      <table class="type1">
       ...
       <%-- <tr>
        ...
        <tr>
         ...
         <th scope="row">
             <!-- Appointment Session -->
             <spring:message code='service.title.AppointmentSessione' /><span class="must">*</span>
         </th>
         <td>
        ...
        <tr>
         <th scope="row">
             <spring:message code='home.lbl.assignDT' /><span class="must">*</span>
         </th>
         <td colspan="3">
         ...
         <th scope="row">
             <spring:message code='service.title.Sms' />
         </th>
         <td>
      ...
      <aside class="title_line">
       <h2><spring:message code='service.title.ASCallTrans' /></h2> <!-- AS Call-Log Transaction -->
      </aside>

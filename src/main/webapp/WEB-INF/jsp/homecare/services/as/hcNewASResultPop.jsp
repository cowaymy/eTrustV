...
<script type="text/javaScript">
  ...
  function fn_clearPageField() {
    ...
    $("#ddlFilterQty").val("1").attr("disabled", true);
...
*/
  ...
  function fn_dftTyp(dftTyp){
    ...
    Common.popupDiv("/homecare/services/as/hcDftTypPop.do", {
    	callPrgm : dftTyp,
...
function fn_serialSearchPop(){
    ...
    if (FormUtil.isEmpty(filterCodeVal)) {
        var text = "<spring:message code='home.lbl.partsCode'/>";
      ...
      <table class="type1">
       ...
       <tbody>
        ...
        <tr>
         ...
         <th scope="row"><spring:message code='home.lbl.inchargeDT' /></th>
       ...
       <table class="type1">
        ...
        <tbody>
         ...
         <tr>
          ...
          <td>
            <input type="text" title="Create start Date" id='dpSettleDate' name='dpSettleDate' placeholder="DD/MM/YYYY" class="readonly j_dateHc" disabled="disabled" onChange="fn_chkDt('#dpSettleDate')"/>
          </td>
       ...
       <table class="type1">
        ...
        <tbody>
         <tr>
           ...
           <td>
            <input type="text" title="Create start Date" placeholder="DD/MM/YYYY" class="j_dateHc " readonly="readonly" id="appDate" name="appDate" onChange="fn_chkDt2();"/>
           </td>
         ...
         <tr>
           ...
           <td>
             <input type="text" title="" placeholder="<spring:message code='home.lbl.assignDT' />" id="CTCode" name="CTCode" class="readonly" readonly="readonly" onchange="fn_changeCTCode(this)" />
           </td>
         </tr>
         <tr>
           <th scope="row"><spring:message code='home.lbl.dTGroup' /></th>
           <td colspan="3">
             <input type="text" title="<spring:message code='home.lbl.dTGroup' />" placeholder="<spring:message code='home.lbl.dTGroup' />" class="w100p" id="CTGroup" name="CTGroup" />
           </td>
         </tr>
         <tr>
      ...
      <dd id='defEvt_div' style="display: none">
       <table class="type1">
        ...
        <tr>
          ...
          <td>
              <input type="text" title="" id='def_type' name='def_type' placeholder="" class="" onblur="fn_getASReasonCode2(this, 'def_type' ,'387')" onkeyup="this.value = this.value.toUpperCase();"/>
        ...
        <tr>
          <th scope="row"><spring:message code='service.text.dtlDef' />
              <span id='m12' name='m12' class="must" style="display:none">*</span>
          </th>
          <td>
              ...
              <a class="search_btn" id="HDD" onclick="fn_dftTyp('HDD')"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a>
        ...
        <tr>
          <th scope="row">
              <spring:message code='service.text.defCde' /><span id='m10' name='m10' class="must" style="display:none">*</span>
          </th>
          <td>
              ...
              <a class="search_btn" id="HDC" onclick="fn_dftTyp('HDC')"><img src="${pageContext.request.contextPath}/resources/images/common/normal_search.gif" alt="search" /></a>
        ...
        <tr>
          <th scope="row"><spring:message code='service.text.defPrt' />
              <span id='m11' name='m11' class="must" style="display:none">*</span>
          </th>
          <td>

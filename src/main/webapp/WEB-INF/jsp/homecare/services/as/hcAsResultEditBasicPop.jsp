      ...
      <table class="type1">
       ...
       <tbody>
        ...
        <tr>
         ...
         <th scope="row"><spring:message code='home.lbl.dtCode' /><span id='m7' name='m7' class="must">*</span>
         </th>
         <td>
         <!--
    ...
    <dd>
      <table class="type1">
       ...
       <tbody>
        ...
        <tr>
          <th scope="row">
              <spring:message code='service.text.dtlDef' /><span id='m12' name='m12' class="must" style="display:none">*</span>
          </th>
          <td>

...
function fn_report(viewType){
    ...
    $("#reportDownFileName").val("CareServiceConfigRawData_"+date+(new Date().getMonth()+1)+new Date().getFullYear());


     if(viewType == "EXCEL"){
        $("#form #viewType").val("EXCEL");
        $("#form #reportFileName").val("/homecare/htConfigRawData_Excel.rpt");
    }

...
function fn_HSReportGroup(){
    ...
    Common.ajax("GET", "/homecare/services/selectHSReportGroup.do", $("#searchHsGroupReport").serialize(), function(result) {
        console.log("성공.");
...
function fn_Generate(){
    ...
    $("#searchHsReport #reportDownFileName").val(CSNo + "_"+day+month+date.getFullYear());
...
<h1>CS Management - CS REPORT(Group)</h1>
<ul class="right_opt">

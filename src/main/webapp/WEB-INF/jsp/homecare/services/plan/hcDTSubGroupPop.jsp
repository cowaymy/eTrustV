...
<script type="text/javaScript">
	...
	function tagRespondGrid() {
	    ...
	    var columnCtSubgrpLayout =[
            {dataField: "ctSubGrp",          headerText: "DT Sub Group",          width: 160},
            {dataField: "asignFlag",          headerText: "Assign",                     width: 0},
            {dataField : "checkFlag",        headerText : 'Assign ',                    width: 100,
	            renderer : {
            ...
            {dataField: "majorGrp",          headerText: "Major",                      width: 0},
            {dataField : "radioFlag",         headerText : 'Major',                      width: 100,
				renderer : {
				    type : "CheckBoxEditRenderer",
				    showLabel : false, // 참, 거짓 텍스트 출력여부( 기본값 false )
				    editable : true, // 체크박스 편집 활성화 여부(기본값 : false)
	...
	function fn_CTAssignSave(){
	    ...
	    if(mainGroupItems.length > 1) {
	    	Common.alert("Only can select a single DT Sub Group as a Major Colum.");
	        return
	    }
    ...
    $(document).ready(function(){
        ...
        Common.ajax("GET","/homecare/services/plan/selectAssignDTSubGroupList",{memId : memberId, branch : branchCode},function(result) {

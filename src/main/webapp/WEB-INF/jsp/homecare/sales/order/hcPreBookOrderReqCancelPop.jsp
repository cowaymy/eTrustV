...
/*     var codeList_19 = [];
    ...
    function fn_doSaveReqCancel() {
        ...
        Common.ajax("POST", "/homecare/sales/order/hcRequestCancelPreBookOrder.do", updPreBookVO , function(result) {
...
<h1>Pre-Booking (HC) - Cancellation</h1>
<ul class="right_opt">

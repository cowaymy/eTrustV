...
------------------------------------------------------------------------------->
  <section id="scMA" class="blind">
   ...
   <ul class="right_btns mb10">
    <li><p class="btn_grid">
      <a id="btnViewMailHistory" href="#"><spring:message code="sal.title.text.viewHistory" /></a>
     </p></li>
    <li><p class="btn_grid">
      <a id="btnBillNewAddr" href="#"><spring:message code="sal.btn.addNewAddr" /></a>
     </p></li>
    <li><p class="btn_grid">
      <a id="btnBillSelAddr" href="#"><spring:message code="sal.title.text.seMailAddr" /></a>
     </p></li>
   </ul>
   <section class="search_table">
    <!-- search_table start -->
   ...
   <ul class="center_btns">
    <li><p class="btn_blue2">
      <a id="btnSaveMailingAddress" href="#"><spring:message code="sal.btn.save" /></a>
     </p></li>
   </ul>
  </section>
  <!------------------------------------------------------------------------------
...
------------------------------------------------------------------------------->
  <section id="scMA2" class="blind">
   ...
   <ul class="right_btns mb10">
    <li><p class="btn_grid">
      <a id="btnMailNewAddr" href="#"><spring:message code="sal.btn.addNewAddr" /></a>
     </p></li>
    <li><p class="btn_grid">
      <a id="btnMailSelAddr" href="#"><spring:message code="sal.title.text.seMailAddr" /></a>
     </p></li>
   </ul>
   <section class="search_table">
    <!-- search_table start -->
   ...
   <ul class="center_btns">
    <li><p class="btn_blue2">
      <a id="btnSaveMailingAddress2" href="#"><spring:message code="sal.btn.save" /></a>
     </p></li>
   </ul>
  </section>
  <!------------------------------------------------------------------------------
  ...
  <section id="scCP" class="blind">
   ...
   <ul class="center_btns">
    <li><p class="btn_blue2 big">
      <a id="btnSaveCntcPerson" href="#"><spring:message code="sal.btn.save" /></a>
     </p></li>
   </ul>
  </section>
  <!------------------------------------------------------------------------------
...
<!--            <p style="width: 70px;" class="voucherSection btn_grid"><a id="btnVoucherApply" href="#" onclick="javascript:applyVoucher()">Apply</a></p> -->
      ...
      <tr>
       <th scope="row" class="relatedNoField"><spring:message code="sal.title.text.relatedNo" /></th>
       <td class="relatedNoField"><input id="" name="relatedNo" type="text" title="" placeholder="Related Number" class="w100p readonly" readonly />

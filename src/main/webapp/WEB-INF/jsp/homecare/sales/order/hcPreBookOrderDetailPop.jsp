...
<script type="text/javaScript">
    ...
    $(document).ready(function(){
		...
		doGetComboAndGroup2('/common/selectProductCodeList.do', {selProdGubun: 'HC'}, '${preBookOrderInfo.stkId}', 'preOrdProduct', 'S', 'fn_setOptGrpClass');//product 생성
        ...
        $('#relatedNo').val('${preBookOrderInfo.salesOrdNoOld}');
        $('#preRemark').val('${preBookOrderInfo.rem}');
        $('#hiddenPreBookId').val('${preBookOrderInfo.preBookId}');
        createAUIGridCancelRemark();
        fn_selectCancelRemarkList();
    ...
    function createAUIGridCancelRemark() {

	    //AUIGrid 칼럼 설정
	     var columnLayout = [
	            { headerText : 'Status', dataField : "stus", width : 150}
	          , { headerText : 'Cancel Reason', dataField : "rem", width : 150}
	          , { headerText : 'Update User Id', dataField : "updUserId",  width : 180 }
	          , { headerText : 'Update Date', dataField : "updDt",  width : 180, dataType : "date", formatString : "dd/mm/yyyy"}
	          , { headerText : 'Update Time', dataField : "updTime",  width : 180}
	     ];
	     ...
	     CancelRemarkGridID =  GridCommon.createAUIGrid("grid_CancelRemark_wrap", columnLayout, "", gridPros);
	 }

	 function fn_selectCancelRemarkList() {
	     Common.ajax("GET", "/homecare/sales/order/selectPreBookOrderCancelStatus.do", {preBookId : $('#hiddenPreBookId').val()}, function(result) {
	            AUIGrid.setGridData(CancelRemarkGridID, result);
	     });
	 }
...
<ul class="tap_type1 num4">
	...
	<li><a id="aTabCAN" onClick="javascript:chgTab('can');">Cancellation Info</a></li>
</ul>
	...
	<tbody>
		<tr>
		    ...
		    <option value="2301" selected>Ex-trade</option></select></p>
                ...
                <p><input id="relatedNo" name="relatedNo" type="text" title="" placeholder="Related Number" value= "" class="w100p readonly" readonly /></p>
		...
		<tr>
		    ...
		    <td><select id="preOrdProduct" name="preOrdProduct" class="w100p" disabled></select>
		    </td>
		</tr>
		...
		<tr>
		    ...
		    <td><textarea id="preRemark" name="preRemark" cols="20" rows="5" class="w100p readonly" readonly ></textarea></td>
		</tr>
...
<br><br><br><br><br>
 ...
 <article class="tap_area"><!-- tap_area start -->
		...
		<div id="grid_CancelRemark_wrap" style="width:100%; height:380px; margin:0 auto;"></div>

...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/homecare-js-1.0.js"></script>
	...
	<header class="pop_header">
		...
		<ul class="right_opt">
			<li><p class="btn_blue2">
					<a id="btnPreOrdClose"
						onClick="javascript:fn_closePreOrdModPop2();" href="#">CLOSE</a>
				</p></li>
		</ul>
	</header>
	<!-- pop_header end -->
			...
			<table class="type1">
				...
				<tbody>
					<tr>
						...
						<td><input id="nric2" name="nric2" type="text" value=""
							title="" placeholder="" class="w100p readonly" readonly /></td>
						<td><input id="nric" name="nric" type="hidden" value=""
							title="" placeholder="" class="w100p readonly" readonly /></td>
						<th scope="row">SOF No</th>
						<td><input id="sofNo" name="sofNo" type="text"
							value="${preOrderInfo.sofNo}" title="" placeholder=""
		...
		<section id="scPreOrdArea" class="">
			<section class="tap_wrap">
				...
				<ul class="tap_type1 num4">
					...
					<li><a href="aTabOI" onClick="javascript:chgTab('ord');">Order
							Info</a></li>
					<li><a href="aTabBD" onClick="javascript:chgTab('pay');">Payment
							Info</a></li>
				...
				<article class="tap_area">
					...
					<section class="search_table">
						<!-- search_table start -->
						<form id="frmPreOrdReg" name="frmPreOrdReg" action="#"
							method="post">
							<input id="hiddenPreOrdId" name="preOrdId" type="hidden"
								value="${preOrderInfo.preOrdId}" /> <input id="hiddenPreOrdId1"
								name="preOrdId1" type="hidden"
								value="${preMatOrderInfo.preOrdId}" /> <input
								id="hiddenPreOrdId2" name="preOrdId2" type="hidden"
								value="${preFrmOrderInfo.preOrdId}" /> <input
								id="hiddenOrdSeqNo" name="ordSeqNo" type="hidden"
								value="${hcPreOrdInfo.ordSeqNo}" /> <input id="hiddenCustId"
								name="custId" type="hidden" /> <input id="hiddenTypeId"
								name="typeId" type="hidden" /> <input id="hiddenCustCntcId"
								name="custCntcId" type="hidden" /> <input id="hiddenCustAddId"
								name="custAddId" type="hidden" /> <input id="hiddenRcdTms"
								name="rcdTms" type="hidden" value="${preOrderInfo.updDt}" /> <input
								id="hiddenRcdTms1" name="rcdTms1" type="hidden"
								value="${preMatOrderInfo.updDt}" /> <input id="hiddenRcdTms2"
								name="rcdTms2" type="hidden" value="${preFrmOrderInfo.updDt}" />
							<aside class="title_line">
								<!-- title_line start -->
							...
							<table class="type1">
								...
								<tbody>
									<tr>
										<th scope="row"><spring:message code="sal.text.custType2" /><span
											class="must">*</span></th>
										<td><input id="custTypeNm" name="custTypeNm" type="text"
											title="" placeholder="" class="w100p readonly" /></td>
									</tr>
									<tr>
										<th scope="row"><spring:message code="sal.text.initial2" /><span
											class="must">*</span></th>
										<td><input id="custInitial" name="custInitial"
											type="text" title="Initial" placeholder="Initial"
											class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row"><spring:message
												code="sal.title.text.companyType2" /><span class="must">*</span></th>
										<td><input id="corpTypeNm" name="corpTypeNm" type="text"
											title="" placeholder="" class="w100p readonly" /></td>
									</tr>
									<tr>
										<th scope="row"><spring:message code="sal.text.custName2" /><span
											class="must">*</span></th>
										<td><input id="name" name="name" type="text" title=""
											placeholder="" class="w100p readonly" readonly /></td>
									</tr>
									<!--
                  <tr>
                  ...
                  -->
							...
							<table class="type1">
								...
								<tbody>
									<tr>
										<th scope="row"><spring:message
												code="sal.text.nationality2" /></th>
										<td><input id="nationNm" name="nationNm" type="text"
											title="" placeholder="Nationality" class="w100p readonly"
											readonly /></td>
									</tr>
									<tr>
										<th scope="row">Passport Visa expiry date | Visa passport
											tarikh tamat(foreigner)</th>
										<td><input id="visaExpr" name="visaExpr" type="text"
											title="Create start Date" placeholder="DD/MM/YYYY"
											class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row">Passport expiry date | Passport tarikh
											luput(foreigner)</th>
										<td><input id="pasSportExpr" name="pasSportExpr"
											type="text" title="Create start Date"
											placeholder="DD/MM/YYYY" class="w100p readonly" readonly />
										</td>
									</tr>
									<tr>
										<th scope="row"><spring:message code="sal.text.dob2" /><span
											class="must">*</span></th>
									...
									<tr>
										<th scope="row"><spring:message code="sal.text.race2" /><span
											class="must">*</span></th>
										<td><input id="race" name="race" type="text"
											title="Create start Date" placeholder="Race"
											class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row"><spring:message code="sal.text.gender2" /><span
											class="must">*</span></th>
									...
									<tr>
										<th scope="row"><spring:message
												code="sal.title.text.email2" /><span class="must">*</span></th>
										...
										<td>
											<div style="display: inline-block; width: 100%;">
												<div style="display: inline-block;">
													<input id="marketMessageYes" type="radio" value="1"
														name="marketingMessageSelection" /><label
														for="marketMessageYes">Yes</label>
												</div>
												<div style="display: inline-block;">
													<input id="marketMessageNo" type="radio" value="0"
														name="marketingMessageSelection" /><label
														for="marketMessageNo">No</label>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td><input id="custStatus" name="custStatus" type="text"
											title="" placeholder="" class="w100p readonly" readonly /></td>
									</tr>
									<input id="hiddenCustStatusId" name="hiddenCustStatusId"
										type="hidden" />
									<!--
                  <tr>
                  ...
                  -->
                      ...
                      <td><input id="custCntcInitial" name="custCntcInitial" type="text" title="Create start Date" placeholder="Race" class="w100p readonly" readonly/></td> -->
										...
										<tr>
											...
											<td><input id="custCntcExt" name="custCntcExt"
												type="text" title="" placeholder="" class="w100p readonly"
												readonly /></td>
										</tr>
										<tr>
							...
							<ul class="right_btns mb10">
								...
								<li><p class="btn_grid">
										<a id="btnSelInstAddr" href="#">Select Another Address</a>
									</p></li>
							</ul>
							<table class="type1">
								<!-- table start -->
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="3"><input id="instCity" name="instCity"
											type="text" title="" placeholder="City"
											class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row">PostCode | Poskod<span class="must">*</span></th>
										<td colspan="3"><input id="instPostCode"
											name="instPostCode" type="text" title=""
											placeholder="Post Code" class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row">State | Negeri<span class="must">*</span></th>
										<td colspan="3"><input id="instState" name="instState"
											type="text" title="" placeholder="State"
											class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row">Country | Negara<span class="must">*</span></th>
										<td colspan="3"><input id="instCountry"
											name="instCountry" type="text" title="" placeholder="Country"
											class="w100p readonly" readonly /></td>
									</tr>
								</tbody>
							</table>
							...
							<table class="type1">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="3"><select id="keyinBrnchId"
											name="keyinBrnchId" class="w100p" disabled></select></td>
									</tr>
									<tr>
										<th scope="row">Prefer Install Date<span class="must">*</span></th>
										<td colspan="3"><input id="prefInstDt" name="prefInstDt"
											type="text" title="Create start Date"
											placeholder="Prefer Install Date (dd/MM/yyyy)"
											class="j_date w100p" value="${preOrderInfo.preDt}" disabled />
										</td>
									</tr>
									<tr>
										...
										<td colspan="3">
											<div class="time_picker">
												<!-- time_picker start -->
												<input id="prefInstTm" name="prefInstTm" type="text"
													title="" placeholder="Prefer Install Time (hh:mi tt)"
													class="time_date w100p" value="11:00 AM"
													value="${preOrderInfo.preTm}" disabled />
												<ul>
													<li>Time Picker</li>
							...
							<tbody>
								<tr>
									...
									<td>
										...
										</p> <a><input id="isReturnExtrade" name="isReturnExtrade"
											type="checkbox" disabled /> Return ex-trade product</a> <input
										id="txtOldOrderID" name="txtOldOrderID" type="hidden" />
									</td>
								</tr>
<!-- 								<tr> -->
...
<!-- 												onchange="displayVoucherSection()" class="w100p"></select> -->
<!-- 										</p> -->
<!-- 										<p class="voucherSection"> -->
<!-- 											<input id="voucherCode" name="voucherCode" type="text" -->
<!-- 												title="Voucher Code" placeholder="Voucher Code" -->
<!-- 												class="w100p" /> -->
<!-- 										</p> -->
<!-- 										<p class="voucherSection"> -->
<!-- 											<input id="voucherEmail" name="voucherEmail" type="text" -->
<!-- 												title="Voucher Email" placeholder="Voucher Email" -->
<!-- 												class="w100p" /> -->
<!-- 										</p> -->
<!-- 										<p style="width: 70px;" class="voucherSection btn_grid"> -->
<!-- 											<a id="btnVoucherApply" href="#" -->
<!-- 												onclick="javascript:applyVoucher()">Apply</a> -->
<!-- 										</p> -->
<!-- 										<p style="display: none; color: red; font-size: 10px;" -->
<!-- 											id="voucherMsg"></p> -->
<!-- 									</td> -->
<!-- 								</tr> -->
								<tr>
									<th scope="row">Application Type | Jenis Permohonan<span
										class="must">*</span></th>
									<td>
										<p>
										...
										<p>
											<select id="srvPacId" name="srvPacId" class="w100p" disabled></select>
										</p>
									</td>
								</tr>
								<tr>
									...
									<td><input id="installDur" name="installDur" type="text"
										title="" placeholder="Installment Duration (1-36)"
										class="w100p readonly" readonly /></td>
								</tr>
							</tbody>
						</table>
						...
						<table class="type1">
							...
							<tbody>
								<tr>
									...
									<td><select id="ordProduct1" name="ordProduct1"
										class="w100p" disabled></select></td>
								</tr>
								<tr id='trCpntId1' style='visibility: collapse'>
									<th scope="row"><spring:message
											code="sal.title.text.cpntId" /> | Komponen Tambahan <span
										class="must">*</span></th>
									<td><select id="compType1" name="compType1" class="w100p"
										onchange="fn_reloadPromo('1')"></select></td>
								</tr>
								<tr>
									<th scope="row">Promotion | Promosi<span class="must">*</span></th>
									<td><select id="ordPromo1" name="ordPromo1" class="w100p"
										disabled></select></td>
								</tr>
								<tr style="display: none;">
									<th scope="row">Price / RPF (RM)</th>
									<td><input id="ordPrice1" name="ordPrice1" type="text"
										data-ref='ordProduct1' title=""
										placeholder="Price/Rental Processing Fees (RPF)"
										class="w100p readonly" readonly /> <input id="ordPriceId1"
										name="ordPriceId1" type="hidden" data-ref='ordProduct1' /> <input
										id="normalOrdPrice1" name="normalOrdPrice1" type="hidden"
										data-ref='ordProduct1' /> <input id="normalOrdPv1"
										name="normalOrdPv1" type="hidden" data-ref='ordProduct1' /></td>
								</tr>
								<tr style="display: none;">
									<th scope="row">Rental Fee</th>
									<td><input id="ordRentalFees1" name="ordRentalFees1"
										type="text" data-ref='ordProduct1' title="" placeholder=""
										class="w100p readonly" readonly /></td>
								</tr>
								<tr>
									<th scope="row">PV<span class="must">*</span></th>
									<td><input id="ordPv1" name="ordPv1" type="text"
										data-ref='ordProduct1' title="" placeholder="Point Value (PV)"
										class="w100p readonly" readonly /> <input id="ordPvGST1"
										name="ordPvGST1" type="hidden" data-ref='ordProduct1' /></td>
								</tr>
							</tbody>
						</table>
						<!-- Frame -->
						...
						<table class="type1">
							...
							<tbody>
								<tr>
									<th scope="row">Product | Produk<span class="must">*</span></th>
									<td><select id="ordProduct2" name="ordProduct2"
										class="w100p" disabled></select></td>
								</tr>
								<tr id='trCpntId2' style='visibility: collapse'>
									<th scope="row"><spring:message
											code="sal.title.text.cpntId" /> | Komponen Tambahan <span
										class="must">*</span></th>
									<td><select id="compType2" name="compType2" class="w100p"
										onchange="fn_reloadPromo('2')"></select></td>
								</tr>
								<tr>
									<th scope="row">Promotion | Promosi<span class="must">*</span></th>
									<td><select id="ordPromo2" name="ordPromo2" class="w100p"
										disabled></select></td>
								</tr>
								<tr style="display: none;">
									<th scope="row">Price / RPF (RM)</th>
									<td><input id="ordPrice2" name="ordPrice2" type="text"
										data-ref='ordProduct2' title=""
										placeholder="Price/Rental Processing Fees (RPF)"
										class="w100p readonly" readonly /> <input id="ordPriceId2"
										name="ordPriceId2" type="hidden" data-ref='ordProduct2' /> <input
										id="normalOrdPrice2" name="normalOrdPrice2" type="hidden"
										data-ref='ordProduct2' /> <input id="normalOrdPv2"
										name="normalOrdPv2" type="hidden" data-ref='ordProduct2' /></td>
								</tr>
								<tr style="display: none;">
									<th scope="row">Rental Fee</th>
									<td><input id="ordRentalFees2" name="ordRentalFees2"
										type="text" data-ref='ordProduct2' title="" placeholder=""
										class="w100p readonly" readonly /></td>
								</tr>
								<tr>
									<th scope="row">PV<span class="must">*</span></th>
									<td><input id="ordPv2" name="ordPv2" type="text"
										data-ref='ordProduct2' title="" placeholder="Point Value (PV)"
										class="w100p readonly" readonly /> <input id="ordPvGST2"
										name="ordPvGST2" type="hidden" data-ref='ordProduct2' /></td>
								</tr>
							</tbody>
						</table>
						<!--  Total -->
						...
						<table class="type1">
							...
							<tbody>
								<tr>
									<th scope="row" style="font-weight: bold;"><spring:message
											code="sal.title.text.priceRpfRm" /></th>
									<td><input id="totOrdPrice" name="totOrdPrice" type="text"
										title="" placeholder="Price/Rental Processing Fees (RPF)"
										style="width: 100% !important; font-weight: bold;"
										class="readonly" readonly /></td>
								</tr>
								<tr>
									<th scope="row" style="font-weight: bold;"><spring:message
											code="sal.title.text.finalRentalFees" /></th>
									<td><input id="totOrdRentalFees" name="totOrdRentalFees"
								...
								<tr>
									<th scope="row" style="font-weight: bold;"><spring:message
											code="sal.title.text.pv" /></th>
									<td><input id="totOrdPv" name="totOrdPv" type="text"
										title="" placeholder="Point Value (PV)"
										style="width: 100% !important; font-weight: bold;"
										class="readonly" readonly /></td>
								</tr>
								<tr>
									<th scope="row">Advance Rental Payment*</th>
									<td><span>Does customer make advance rental payment
											for 12 months and above?</sapn> <input id="advPayYes" name="advPay"
											type="radio" value="1" /><span>Yes</span> <input
											id="advPayNo" name="advPay" type="radio" value="0" /><span>No</span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input id="salesmanCd" name="salesmanCd" type="text"
										style="width: 115px;" title="" placeholder="" class="" /> <a
										...
										<p>
											<input id="salesmanNm" name="salesmanNm" type="text"
												class="w100p readonly" title="" placeholder="Salesman Name"
												disabled />
										</p></td>
								</tr>
								<tr>
									<th scope="row">Special Instruction<span class="must">*</span></th>
									<td><textarea id="speclInstct" name="speclInstct"
                  ...
                  -->
									...
									<td>
										<p>
											<select id="promoDiscPeriodTp1" name="promoDiscPeriodTp1"
												class="w100p" disabled></select>
										</p>
										<p>
											<input id="promoDiscPeriod1" name="promoDiscPeriod1"
												type="text" title="" placeholder="" style="width: 42px;"
												class="readonly" readonly />
										</p>
										<p>
											<select id="promoDiscPeriodTp2" name="promoDiscPeriodTp2"
												class="w100p" disabled></select>
										</p>
										<p>
											<input id="promoDiscPeriod2" name="promoDiscPeriod2"
												type="text" title="" placeholder="" style="width: 42px;"
												class="readonly" readonly />
										</p>
									</td>
								...
								<tr style="display: none;">
									...
									<td><select id="corpCustType" name="corpCustType"
										class="w50p" disabled></select>
								</tr>
								<tr style="display: none;">
									<th scope="row">Agreement Type<span class="must">*</span></th>
									<td><select id="agreementType" name="agreementType"
										class="w50p" disabled></select>
								</tr>
							</tbody>
						</table>
            ...
            ------------------------------------------------------------------------------->
						<section id="sctRentPayMode">
							<table class="type1">
								...
								<tbody>
									<tr>
										<th><spring:message code="sal.text.rentalPaymode2" /><span
											class="must">*</span></th>
										<td scope="row" colspan="3"'><select id="rentPayMode"
											name="rentPayMode" class="w100p"></select></td>
										<!--
                    ...
                    -->
						...
						<section id="sctCrCard" class="blind">
							...
							<ul class="right_btns mb10">
								...
								<li><p class="btn_grid">
										<a id="selCreditCardBtn" href="#">Select Another Credit
											Card</a>
									</p></li>
							</ul>
							<!------------------------------------------------------------------------------
              ...
              ------------------------------------------------------------------------------->
							<table class="type1 mb1m">
								...
								<tbody>
									<tr>
										<th scope="row"><spring:message
												code="sal.text.creditCardNo2" /><span class="must">*</span></th>
               ...
               -->
						...
						<section id="sctDirectDebit" class="blind">
							...
							<ul class="right_btns mb10">
								...
								<li><p class="btn_grid">
										<a id="btnSelBankAccount" href="#">Select Another Bank
											Account</a>
									</p></li>
							</ul>
							<!------------------------------------------------------------------------------
							...
							<table class="type1">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan=3><input id="accBank" name="accBank"
											type="text" title="" placeholder="Issue Bank"
											class="w100p readonly" readonly /> <input
											id="hiddenAccBankId" name="hiddenAccBankId" type="hidden" />
										</td>
									</tr>
								</tbody>
							</table>
							...
							<tbody>
								<tr>
									...
									<td><label><input type="radio" id="grpOpt1"
											name="grpOpt" value="new" /><span>New Billing Group</span></label> <label><input
											type="radio" id="grpOpt2" name="grpOpt" value="exist" /><span>Existion
												Billing Group</span></label></td>
								</tr>
							</tbody>
						</table>
						<!-- table end -->
            ...
            ------------------------------------------------------------------------------->
						<section id="sctBillMthd" class="blind">
							<table class="type1 mb1m">
								...
								<tbody>
									<tr>
										<th scope="row" rowspan="5">Billing Method<span
											class="must">*</span></th>
										<td colspan="3"><label><input id="billMthdPost"
												name="billMthdPost" type="checkbox" /><span>Post</span></label></td>
									</tr>
									<tr>
										<td colspan="3"><label><input id="billMthdSms"
												name="billMthdSms" type="checkbox" /><span>SMS</span></label> <label><input
												id="billMthdSms1" name="billMthdSms1" type="checkbox"
												disabled /><span>Mobile 1</span></label> <label><input
												id="billMthdSms2" name="billMthdSms2" type="checkbox"
												disabled /><span>Mobile 2</span></label></td>
									</tr>
									<tr>
										<td><label><input id="billMthdEstm"
												name="billMthdEstm" type="checkbox" /><span>E-Billing</span></label>
											<label><input id="billMthdEmail1"
												name="billMthdEmail1" type="checkbox" disabled /><span>Email
													1</span></label> <label><input id="billMthdEmail2"
												name="billMthdEmail2" type="checkbox" disabled /><span>Email
													2</span></label></td>
									...
									<tr>
										<td><label><input id="billGrpWeb"
												name="billGrpWeb" type="checkbox" /><span>Web Portal</span></label>
										</td>
										<th scope="row">Web address(URL)</th>
										<td><input id="billGrpWebUrl" name="billGrpWebUrl"
											type="text" title="" placeholder="Web Address" class="w100p" />
										</td>
									</tr>
								</tbody>
							</table>
            ...
            ------------------------------------------------------------------------------->
              ...
              -->
							<table class="type1">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="3"><input id="billCity" name="billCity"
											type="text" title="" placeholder="City"
											class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row">PostCode<span class="must">*</span></th>
										<td colspan="3"><input id="billPostCode"
											name="billPostCode" type="text" title=""
											placeholder="Postcode" class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row">State<span class="must">*</span></th>
										<td colspan="3"><input id="billState" name="billState"
											type="text" title="" placeholder="State"
											class="w100p readonly" readonly /></td>
									</tr>
									<tr>
										<th scope="row">Country<span class="must">*</span></th>
										<td colspan="3"><input id="billCountry"
											name="billCountry" type="text" title="" placeholder="Country"
											class="w100p readonly" readonly /></td>
									</tr>
								</tbody>
							</table>
						...
						<section id="sctBillPrefer" class="blind">
							...
							<!-- title_line end -->
							<ul class="right_btns mb10">
								<li class="blind"><p class="btn_grid">
										<a id="billPreferAddAddrBtn" href="#">Add New Contact</a>
									</p></li>
								<li class="blind"><p class="btn_grid">
										<a id="billPreferSelAddrBtn" href="#">Select Another
											Contact</a>
									</p></li>
							</ul>
							<!------------------------------------------------------------------------------
								...
								<tbody>
									<tr>
										...
										<td><input id="billGrp" name="billGrp" type="text"
											...
											name="billGrpId" type="hidden"
											value="${preOrderInfo.custBillId}" /></td>
					...
					<table class="type1">
						...
						<tbody>
								...
								<td>
									<div class='auto_file2 auto_file3'>
										<input type='file' title='file add' id='sofFile'
											accept='image/*' '/> <label> <input type='text'
											class='input_text' readonly='readonly' id='sofFileTxt' /> <span
											class='label_text'><a href='#'>Upload</a></span>
										</label>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="auto_file2 auto_file3">
										<input type="file" title="file add" id="sofTncFile"
											accept="image/*" /> <label> <input type='text'
											class='input_text' readonly='readonly' id='sofTncFileTxt' />
								...
								<td>
									<div class='auto_file2 auto_file3'>
										<input type='file' title='file add' id='nricFile'
											accept='image/*' '/> <label> <input type='text'
											class='input_text' readonly='readonly' id='nricFileTxt' /> <span
											class='label_text'><a href='#'>Upload</a></span>
										</label>
									</div>
								</td>
							...
							<tr>
								...
								<td id="tdPayFile">
									<div class='auto_file2 auto_file3'>
										<input type='file' title='file add' id='payFile'
											accept='image/*' '/> <label> <input type='text'
											class='input_text' readonly='readonly' id='payFileTxt'
											name='' /> <span class='label_text'><a href='#'>Upload</a></span>
										</label> <span class='label_text'><a href='#'
											onclick='fn_removeFile("PAY")'>Remove</a></span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td id="tdTrFile">
									<div class='auto_file2 auto_file3'>
										<input type='file' title='file add' id='trFile'
											accept='image/*' '/> <label> <input type='text'
											class='input_text' readonly='readonly' id='trFileTxt' name='' />
											<span class='label_text'><a href='#'>Upload</a></span>
										</label> <span class='label_text'><a href='#'
											onclick='fn_removeFile("TRF")'>Remove</a></span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td id="tdOtherFile">
									<div class='auto_file2 auto_file3'>
										<input type='file' title='file add' id='otherFile'
											accept='image/*' '/> <label> <input type='text'
											class='input_text' readonly='readonly' id='otherFileTxt'
											name='' /> <span class='label_text'><a href='#'>Upload</a></span>
										</label> <span class='label_text'><a href='#'
											onclick='fn_removeFile("OTH")'>Remove</a></span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td id="tdOtherFile2">
									<div class='auto_file2 auto_file3'>
										<input type='file' title='file add' id='otherFile2'
											accept='image/*' '/> <label> <input type='text'
											class='input_text' readonly='readonly' id='otherFileTxt2'
											name='' /> <span class='label_text'><a href='#'>Upload</a></span>
										</label> <span class='label_text'><a href='#'
											onclick='fn_removeFile("OTH2")'>Remove</a></span>
									</div>
								</td>
							</tr>
								...
								<td>
									<div class='auto_file2 auto_file3'>
										<input type='file' title='file add' id='msofFile'
											accept='image/*' '/> <label> <input type='text'
											class='input_text' readonly='readonly' id='msofFileTxt' /> <span
											class='label_text'><a href='#'>Upload</a></span>
										</label> <span class='label_text'><a href='#'
											onclick='fn_removeFile("MSOF")'>Remove</a></span>
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<div class="auto_file2 auto_file3">
										<input type="file" title="file add" id="msofTncFile"
											accept="image/*" /> <label> <input type='text'
											class='input_text' readonly='readonly' id='msofTncFileTxt' />
											<span class='label_text'><a href='#'>Upload</a></span>
										</label> <span class='label_text'><a href='#'
											onclick='fn_removeFile("MSOFTNC")'>Remove</a></span>
									</div>
								</td>
							</tr>

							<tr>
								<td colspan=2><span class="red_text">Only allow
										picture format (JPG, PNG, JPEG)</span></td>
							</tr>
						</tbody>
					</table>
				</article>

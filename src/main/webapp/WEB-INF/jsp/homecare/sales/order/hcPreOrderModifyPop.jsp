...
//             $('#compType'+tagNum+' option').remove();
    ...
    function fn_loadProductComponent(stkId, tagNum) {
        ...
        doGetComboData('/sales/order/selectProductComponent.do', {stkId:stkId}, cnptId, 'compType'+tagNum, 'S', ''); //Common Code
    }
...
<form id="frmPreOrdReg" name="frmPreOrdReg" action="#" method="post">
    ...
    <input id="hiddenPreOrdId1" name="preOrdId1" type="hidden" value="${preMatOrderInfo.preOrdId}" />
    <input id="hiddenPreOrdId2" name="preOrdId2" type="hidden" value="${preFrmOrderInfo.preOrdId}" />
    <input id="hiddenOrdSeqNo" name="ordSeqNo" type="hidden" value="${hcPreOrdInfo.ordSeqNo}" />
    ...
    <input id="hiddenRcdTms1" name="rcdTms1" type="hidden" value="${preMatOrderInfo.updDt}" />
    <input id="hiddenRcdTms2" name="rcdTms2" type="hidden" value="${preFrmOrderInfo.updDt}" />

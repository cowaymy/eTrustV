...
<script type="text/javaScript" language="javascript">
  ...
  function  fn_doMFree(){
    ...
    Common.popupDiv("/homecare/sales/membership/membershipFreePop.do" , {pdpaMonth:${PAGE_AUTH.pdpaMonth}}, null , true, '_FreeMembership');
    ...
    if(selectedItems ==""){
      ...
      if (type=="Invoice") {
        if (parseInt(selectedItems[0].item.mbrshId ,10) < 490447){
          ...
          Common.popupDiv("/payment/initTaxInvoiceMembershipPop.do",{isHc:1},'',true,'');
  ...
  function fn_keyInList(){
    Common.popupDiv("/sales/membership/membershipOutrightKeyInListPop.do" ,{isHc:1}, null , true , '_rptDiv1');
  }

  function fn_YSListing(){
    Common.popupDiv("/sales/membership/membershipOutrightYSListingPop.do", {isHc:1}, null, true);
  }

  function fn_expireList(){
    Common.popupDiv("/sales/membership/membershipOutrightExpireListPop.do", {isHc:1}, null, true);
  }

  function fn_expireListRental(){
    Common.popupDiv("/sales/membership/membershipOutrightExpireYearListPop.do", {isHc:1}, null, true);
  }

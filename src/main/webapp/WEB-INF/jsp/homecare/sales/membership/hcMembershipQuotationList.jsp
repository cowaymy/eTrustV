...
<script type="text/javaScript" language="javascript">
   ...
   function fn_selectListAjax() {
       ...
       Common.ajax("GET", "/homecare/sales/membership/quotationList", $("#listSForm").serialize(), function(result) {
            console.log( result);
   ...
   function  fn_doViewQuotation(){
      ...
      /*  var pram  ="?QUOT_ID="+selectedItems[0].item.quotId+"&ORD_ID="+selectedItems[0].item.ordId+"&CNT_ID="+selectedItems[0].item.cntId +"&MBRSH_ID="+selectedItems[0].item.memId; */
       ...
       Common.popupDiv("/homecare/sales/membership/mViewQuotation.do"+pram ,null, null , true , '_ViewQuotDiv1');
 }

 function fn_goNewQuotation(){
	    Common.popupDiv("/homecare/sales/membership/mNewQuotation.do", $("#listSForm").serializeJSON(), null , true , '_NewQuotDiv1');
 }

 function  fn_goQuotationRawData(){
	  Common.popupDiv("/homecare/sales/membership/mQuotationRawData.do");
...
function fn_goConvertSale(){
   ...
   if(v_stus !="ACT" ){
	   ...
	   Common.popupDiv("/homecare/sales/membership/mConvSale.do"+pram,null, null , true , '_mConvSaleDiv1');
   }
 }

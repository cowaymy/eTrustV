...
<script type="text/javaScript" language="javascript">
    ...
    function fn_setData(ordNo , ordId) {
        ...
        else if($('#callPrgm').val() == 'CARESRVC_PAYMENT') {
            fn_callBackCareSrvcOrderInfo(ordNo, ordId);
        }
    }
    ...
    function fn_selectListAjax() {
        Common.ajax("GET", "/homecare/sales/selectHTOrderJsonList", $("#popSearchForm").serialize(), function(result) {

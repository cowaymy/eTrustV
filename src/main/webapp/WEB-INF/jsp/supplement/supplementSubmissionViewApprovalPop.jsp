...
<script type="text/javaScript">
  ...
  function fn_loadMainCntcPerson(custCntcId) {
    Common.ajax("GET", "/sales/order/selectCustCntcJsonInfo.do", { custCntcId : custCntcId },
  ...
  function fn_loadSupplementSubmissionItem(supSubmId) {
    ...
    Common.ajax("GET", "/supplement/selectSupplementSubmissionItmView",
  ...
  function createPurchaseGridID() {
    ...
    purchaseGridID = GridCommon.createAUIGrid("#item_grid_wrap", posColumnLayout, '', gridPros);
...
<div id="popup_wrap" class="popup_wrap">
  ...
  <header class="pop_header">
    ...
    <ul class="right_opt">
      <li>
        <p class="btn_blue2">
          <a id="btnSubmissionViewApprovalClose" href="#"><spring:message
  ...
  <section class="pop_body">
      ...
      <table class="type1">
        ...
        <tbody>
          ...
          <tr id="submissionStatusView">
            ...
            <td colspan="3">
              <span id="submissionStatusText" name="submissionStatusText"></span>
            </td>
          </tr>
    ...
    <section id="scSupplementSubmissionView" class="blind">
      <section class="tap_wrap">
        <ul class="tap_type1 num4">
          <li>
            <a id="aTabCS" class="on"><spring:message code="sal.page.title.custInformation" /></a>
          </li>
          <li>
            <a id="aTabBD"><spring:message code="supplement.text.paymentInfo" /></a>
          </li>
          <li>
            <a id="aTabOI"><spring:message code="supplement.text.supplementInfo" /></a>
          </li>
          <li>
            <a id="aTabFL"><spring:message code="sal.text.attachment" /></a>
          </li>
        </ul>
        ...
        <article class="tap_area">
          <section class="search_table">
            <section class="tap_wrap">
              <ul class="tap_type1 num4">
                <li>
                  <a id="aTabGI" class="on"><spring:message code="supplement.text.generalInfo" /></a>
                </li>
                <li>
                  <a id="aTabCI"><spring:message code="sal.tap.title.contactInfo" /></a>
                </li>
                <li>
                  <a id="aTabDI"><spring:message code="supplement.text.deliveryAddressInfo" /></a>
                </li>
              </ul>
              <article class="tap_area">
                  ...
                  <table class="type1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan="3"><span id="instPostCode" name="instPostCode"></span></td>
                      </tr>
                      <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="auto_file2">
                      ...
                      <label> <input type='text' class='input_text'  readonly='readonly' id='nricFileTxt' /> <!-- <span class='label_text'>
                ...
                <tr>
                  ...
                  <td>
                    <div class="auto_file2">
                      ...
                      <label> <input type='text' class='input_text' readonly='readonly' id='otherFileTxt' />
                ...
                <tr>
                  ...
                  <td>
                    <div class="auto_file2">
                      ...
                      <label> <input type='text' class='input_text' readonly='readonly' id='otherFileTxt2' />
                      <!-- <span class='label_text'>
                        <a href='#'>Upload</a>
                      </span>
                      <span class='label_text'>
                ...
                <tr>
                  ...
                  <td>
                    <div class="auto_file2">
                      ...
                      <label> <input type='text' class='input_text' readonly='readonly' id='otherFileTxt3' /> <!-- <span class='label_text'>
                        <a href='#'>Upload</a>
                      </span>
                      <span class='label_text'>
                ...
                <tr>
                  ...
                  <td>
                    <div class="auto_file2">
                      ...
                      <label> <input type='text' class='input_text' readonly='readonly' id='otherFileTxt4' /> <!-- <span class='label_text'>
                        <a href='#'>Upload</a>
                      </span>
                      <span class='label_text'>
                ...
                <tr>
                  ...
                  <td>
                    <div class="auto_file2">
                      ...
                      <label> <input type='text' class='input_text' readonly='readonly' id='otherFileTxt5' /> <!-- <span class='label_text'>
                        <a href='#'>Upload</a>
                      </span>
                      <span class='label_text'>
    ...
    <section id="scSubmissionApproval">
      <aside class="title_line">
        <h3>
          <spring:message code="supplement.text.submissionApproval" />
        </h3>
      </aside>
      <table class="type1">
        <caption>table</caption>
        ...
        <tbody>
          <tr>
            ...
            <td colspan="2"><select id="subApprovalStatus" name="subApprovalStatus" class="w100p"></select></td>
          </tr>
          <tr>
            <th scope="row"><spring:message code="sal.title.remark" /></th>
            <td colspan="2">

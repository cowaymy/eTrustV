  ...
  $(document)
      .ready(
          function() {
            ...
            doGetComboData('/status/selectStatusCategoryCdList.do',
                {
                  selCategoryId : 34,
                  parmDisab : 0
                }, '', 'subApprovalStatus', 'S', '');
            ...
            if (modValue == "approval") {
              ...
              $('#supSubmHeader')
                  .text(
                      '<spring:message code="supplement.text.submissionCancel" />');
            } else {
              $('#scSubmissionApproval').hide();
              $('#btnSaveApproval').hide();
              $('#btnSaveCancel').hide();
              $('#supSubmHeader')
                  .text(
                      '<spring:message code="supplement.text.submissionView" />');
        ...
        .click(
            function() {
              if (FormUtil.checkReqValue($("#subApprovalStatus"))) {
                Common
                    .alert("* <spring:message code='sys.msg.necessary' arguments='Submission Status' htmlEscape='false'/> </br>");
                return false;
              }

              if ($("#subApprovalStatus").val() == "RJT"
                  || $("#subApprovalStatus").val() == "CAN") {
                if (FormUtil
                    .checkReqValue($("#subApprovalRemark"))) {
                  Common
                      .alert("* <spring:message code='sys.msg.necessary' arguments='Submission Remark' htmlEscape='false'/> </br>");
                  return false;
                }
              }
              ...
              var saveSubmissionApproval = function() {
                ...
                Common
                    .ajax(
                        "POST",
                        "/supplement/updateSubmissionApprovalStatus.do",
                        data,
                        function(result) {
                          Common
                              .alert(
                                  result.message,
                                  fn_closeSupplementSubmissionViewApprovalPop);
                          $("#popup_wrap").remove();
                        },
                        function(error) {
                          Common
                              .alert("An error occurred while saving submission approval: "
                                  + error.message);
                        });
              };
              ...
              var saveSubmissionApproval = function() {
                ...
                Common
                    .ajax(
                        ...
                        function(error) {
                          Common
                              .alert("An error occurred while saving submission cancel: "
                                  + error.message);
                        });
              };
...
<div id="popup_wrap" class="popup_wrap">
  ...
  <section class="pop_body">
        ...
        <tbody>
          ...
          <tr id="submissionStatusView">
            <th scope="row"><spring:message
                code="supplement.text.approvalStatus" /></th>
            <td colspan="3"><span id="submissionStatusText"
              name="submissionStatusText"></span></td>
          </tr>
          <tr id="submissionRemarkView">
            <th scope="row"><spring:message
                code="supplement.text.approvalRemark" /></th>
            <td colspan="3">
              <!-- <input type="text" title="" placeholder="" class="w100p" id="_remark" name="_remark" maxlength = "50" /> -->
              <textarea id="subApprovalRemarkText" name="subApprovalRemarkText"
                cols="20" rows="5" disabled="disabled"></textarea>
            </td>
          </tr>
            ...
            <table class="type1">
              ...
              <tr>
                ...
                <td><input id="salesmanCd" name="salesmanCd" type="text"
                  style="width: 230px;" title="" placeholder="" class=""
                  disabled="disabled" /> <a id="memBtn" href="#"
    ...
    <section id="scSubmissionApproval">
      ...
      <table class="type1">
        ...
        <tbody>
          <tr>
            <th scope="row"><spring:message
                code="supplement.text.submissionStatus" /><span class="must">**</span></th>
            <td colspan="2"><select id="subApprovalStatus" name="subApprovalStatus"
          ...
          <tr>
            ...
            <td colspan="2">
              <!-- <input type="text" title="" placeholder="" class="w100p" id="_remark" name="_remark" maxlength = "50" /> -->
              <textarea id="subApprovalRemark" name="subApprovalRemark"
      ...
      <ul class="center_btns mt20">
        <li>
          <p class="btn_blue2 big">
            <a id="btnSaveApproval" href="#"><spring:message
                code="sys.btn.save" /></a>
          </p>
        </li>
      </ul>
    ...
    <ul class="center_btns mt20">
      <li>
        <p class="btn_blue2 big">
          <a id="btnSaveCancel" href="#"><spring:message
              code="sales.btn.CtoC" /></a>
        </p>
      </li>
    </ul>
  </section>

...
$(document).ready(function() {
    ...
    $("#_saveBtn").click(function() {
        ...
        var param = {supRefId: supRefId, supRefNo: supRefNo, mainDept: inchgDeptList,  subDept : ddlSubDeptUpd, tagStus : tagStus, remark : remark, counselingNo : counselingNo, ccr0006dCallEntryIdSeq : ccr0006dCallEntryIdSeq , preTagStatusId : preTagStatusId , subTopicId : subTopicId , supTagId : supTagId , attachYN : "N"};

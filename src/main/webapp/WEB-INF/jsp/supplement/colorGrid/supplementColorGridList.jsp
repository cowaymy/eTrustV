...
<script type="text/javaScript">
  ...
  $(document).ready(
      function() {
        ...
        AUIGrid.bind(myGridID, "cellDoubleClick", function(event) {
          ...
          Common.ajax("GET", "/supplement/colorGrid/getSupplementDetailList", detailParam,
            function(result) {
  ...
  function fn_searchListAjax() {
    ...
    if (isValid == true) {
      ...
      Common.ajax("GET", "/supplement/colorGrid/supplementColorGridJsonList", param,
        function(result) {
...
<section id="content">
  ...
  <aside class="title_line">
    ...
    <h2>
      <spring:message code="supplement.title.colorGrid" />
    </h2>
    <ul class="right_btns">
      <li>
        <p class="btn_blue">
          <a href="#" onClick="fn_searchListAjax()"><span class="search"></span>
            <spring:message code="supplement.btn.search" />
          </a>
        </p>
      </li>
      <li>
      ...
      <table class="type1">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <input type="text" title="" id="deptCode" name="deptCode" onkeyup="this.value = this.value.toUpperCase();" placeholder="Department Code" class="w100p" /></td>
          </tr>
          <tr>
            ...
            <td>
              <div class="date_set w100p">
                <p>
                  <input type="text" title="Create start Date" id="createStDate" name="createStDate" placeholder="DD/MM/YYYY" class="j_date" />
                </p>
                <span><spring:message code="supplement.title.text.ordDateTo" /></span>
                <p>
                  <input type="text" title="Create end Date" id="createEnDate" name="createEnDate" placeholder="DD/MM/YYYY" class="j_date" />
                </p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select class="multy_select w100p" id="cmbCustomerType" name="cmbCustomerType" multiple="multiple"></select>
            </td>
          ...
          <tr>
            ...
            <td>
              <input type="text" title="기준년월" id="netSalesMonth" name="netSalesMonth" placeholder="MM/YYYY" class="j_date2 w100p" />
            </td>
          </tr>
          <tr>
            <th scope="row"><spring:message code="supplement.title.text.keyInMonth" /></th>
            <td>
              <input type="text" title="" id="keyInMonth" name="keyInMonth" placeholder="MM/YYYY" class="j_date2 w100p" />
            </td>
        ...
        <dd>
          <ul class="btns">
            <c:if test="${PAGE_AUTH.funcUserDefine2 == 'Y'}">
              <li>
                <p class="link_btn">
                  <a href="#" id="btnFinanceColorGrid"><spring:message code='supplement.btn.financeColorGrid' /></a>
                </p>
              </li>
            </c:if>
          </ul>
  ...
  <section class="search_result">
    <c:if test="${PAGE_AUTH.funcUserDefine1 == 'Y'}">
      <ul class="right_btns">
        <li>
          <p class="btn_grid">
            <a href="#" id="excelDown">GENERATE</a>
          </p>
        </li>
      </ul>
    </c:if>

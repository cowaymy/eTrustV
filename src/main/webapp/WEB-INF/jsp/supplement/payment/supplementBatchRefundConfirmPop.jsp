...
function fn_confirm() {
	Common.confirm("<spring:message code='supplement.alert.confRefundBatch'/>",function (){
...
<div id="popup_wrap" class="popup_wrap"><!-- popup_wrap start -->
  <header class="pop_header"><!-- pop_header start -->
      <h1><spring:message code='supplement.title.batchRefundConfirmation'/></h1>
      <ul class="right_opt">
      ...
      <section class="tap_wrap">
            ...
            <aside class="title_line"><!-- title_line start -->
                <ul class="right_btns">
                	<c:if test="${bRefundInfo.batchStusId ne 4 && bRefundInfo.cnfmStusId ne 77}">
                	   <li><p class="btn_grid"><a href="#" id="remove_btn"><spring:message code='supplement.btn.remove'/></a></p></li>
                	</c:if>
             ...
             <section class="search_result">
                <article class="grid_wrap"><!-- grid_wrap start -->
                    <div id="bRefund_confirm_grid_wrap" style="width:100%; margin:0 auto;"></div>
        ...
        <c:if test="${bRefundInfo.batchStusId ne 4 && bRefundInfo.cnfmStusId ne 77}">
              <ul class="center_btns">
                  <li><p class="btn_blue2 big"><a href="#" id="pConfirm_btn"><spring:message code='supplement.btn.confirm'/></a></p></li>
                  <li><p class="btn_blue2 big"><a href="#" id="deactivate_btn"><spring:message code='supplement.btn.deactivate'/></a></p></li>
              </ul>
        </c:if>
      </section>

...
<div id="upload_popup_wrap" class="popup_wrap"><!-- popup_wrap start -->
    <header class="pop_header"><!-- pop_header start -->
        ...
        <ul class="right_opt">
            <li><p class="btn_blue2"><a href="${pageContext.request.contextPath}/resources/download/supplement/SupplementBatchRefundFormat.csv"><spring:message code='supplement.btn.downloadTemplate'/></a></p></li>
    ...
    <section class="pop_body"><!-- pop_body start -->
        ...
        <ul class="center_btns mt20">
            ...
            <li><p class="btn_blue2 big"><a href="javascript:uploadClear();"><spring:message code='supplement.btn.removeFile' /></a></p></li>
        </ul>

...
var batchInfoLayout = [
   ...
   var batchListLayout = [
    ...
    function fn_batchPayItemList(validStatusId, gubun){
    	...
    	Common.ajax("GET","/supplement/payment/selectBatchPayItemList.do",{"batchId":batchId, "validStatusId" : validStatusId}, function(result){
    	    if(gubun == "V"){//VIEW
    	    	if(validStatusId == "4"){
    ...
    function fn_removeItem(detId){
    	Common.ajax("GET","/supplement/payment/updRemoveItem.do",{"detId":detId}, function(result){
    ...
    function fn_confirmBatch(){
    	Common.confirm("<spring:message code='pay.alert.confPayBatch'/>",function (){
    		...
    		if(totalInvalid > 0){
    			...
    			if(totalValid > 0){
    				Common.ajax("GET","/supplement/payment/saveConfirmBatch.do", {"batchId" : batchId}, function(result){
    	                fn_confirmBatchPopup();
    	                $('#btnConf').hide();
    	                $('#btnDeactivate').hide();
    	                Common.alert(result.message);
    ...
    function fn_uploadFile(){
        ...
        Common.ajaxFile("/supplement/payment/csvFileUpload.do", formData, function(result){
...
<section id="content">
    ...
    <aside class="title_line">
		...
		<h2>Supplement Payment - Batch Payment</h2>
		<ul class="right_btns">
           <li><p class="btn_blue"><a href="#" onclick="fn_uploadPopup();"><spring:message code='pay.btn.link.uploadBatchPayment'/></a></p></li>
           <li><p class="btn_blue"><a href="#" onclick="fn_confirmBatchPopup();"><spring:message code='pay.btn.link.confirmBatchPayment'/></a></p></li>
    ...
    <section class="search_table"><!-- search_table start -->
		<form id="searchForm" action="#" method="post">
			...
			<table class="type1"><!-- table start -->
				...
				<tbody>
					<tr>
					    <th scope="row">Payment Batch ID</th>
                        ...
                        <th scope="row">Payment Batch Status</th>
                        <td>
					...
					<tr>
					    <th scope="row">Payment Confirm Status</th>
					    <td>
     ...
     <ul class="right_btns">
        <li><p class="btn_grid"><a href="#" id="excelDown"><spring:message code='pay.btn.generate'/></a></p></li>
    </ul>
    <!-- search_result start -->
...
<div id="view_popup_wrap" class="popup_wrap size_big" style="display:none;"><!-- popup_wrap start -->
	<header class="pop_header"><!-- pop_header start -->
		<h1>Supplement Payment - Batch Payment View</h1>
		<ul class="right_opt">
...
<div id="conf_popup_wrap" class="popup_wrap size_big" style="display:none;">
	<header class="pop_header"><!-- pop_header start -->
		<h1>Supplement Payment - Batch Payment Confirmation</h1>
		<ul class="right_opt">
	...
	<section class="pop_body"><!-- pop_body start -->
	    ...
	    <ul class="tap_type1">
	        ...
	        <li><a href="#">Batch Payment Detail List</a></li>
	    </ul>
	    <article class="tap_area"><!-- tap_area start -->
		    <table class="type1"><!-- table start -->
			    <caption>table</caption>
			    ...
			    <tbody>
				    <tr>
				        ...
				        <th scope="row">Payment Confirmation Status</th>
				        <td>
				    ...
				    <tr>
				        ...
				        <th scope="row">Payment Batch Upload By</th>
				        <td>
				            <span id="txtUploadBy_conf"></span>
				        </td>
				        <th scope="row">Payment Batch Upload Date</th>
				        <td>
				            <span id="txtUploadAt_conf"></span>
				        </td>
				    </tr>
				    <tr>
                        <th scope="row">Payment Batch Confirm By</th>
				        <td>
				            <span id="txtConfirmBy_conf"></span>
				        </td>
				        <th scope="row">Payment Batch Confirm Date</th>
				        <td >
	    ...
	    <article class="tap_area">
		    ...
		    <!-- grid_wrap start -->
            <section class="search_result">
    		    <article id="conf_grid_wrap" class="grid_wrap" style="width:100%; margin:0 auto;">
    		    </article>
             </section>
		    <!-- grid_wrap end -->
	      </article><!-- tap_area end -->
...
<div id="upload_popup_wrap" class="popup_wrap" style="display:none;"><!-- popup_wrap start -->
	<header class="pop_header"><!-- pop_header start -->
		<h1>Supplement Payment - Batch Payment Upload</h1>
		<ul class="right_opt">
            <li><p class="btn_blue2"><a href="${pageContext.request.contextPath}/resources/download/payment/BatchPaymentFormat.csv"><spring:message code='pay.btn.downloadTemplate'/></a></p></li>
	...
	<section class="pop_body"><!-- pop_body start -->
		...
		<ul class="center_btns mt20">
		    ...
		    <li><p class="btn_blue2 big"><a href="javascript:fn_uploadFile();"><spring:message code='sys.btn.upload'/></a></p></li>
		</ul>

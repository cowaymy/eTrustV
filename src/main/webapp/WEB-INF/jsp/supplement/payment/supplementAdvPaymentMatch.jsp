...
var payTypeData = [
                               {"codeId": "","codeName": "Choose One"},
                               {"codeId": "105","codeName": "Cash"},
                               {"codeId": "106","codeName": "Cheque"},
                               {"codeId": "108","codeName": "Online"}
];

var bankTypeData = [
                   {"codeId": "","codeName": "Choose One"},
                   {"codeId": "2728","codeName": "JomPay"},
                   {"codeId": "2729","codeName": "MBB CDM"},
                   {"codeId": "2730","codeName": "VA"},
                   {"codeId": "2731","codeName": "Others"}
];
...
var advKeyInLayout = [
    {dataField : "groupSeq",headerText : "<spring:message code='supplement.head.paymentGroupNo'/>",width : 90 , editable : false},
    {dataField : "payItmModeNm",headerText : "<spring:message code='supplement.head.paymentMode'/>",width : 90 , editable : false},
    {dataField : "payItmRefDt",headerText : "<spring:message code='supplement.head.transactionDate'/>",width : 100 , editable : false},
    {dataField : "payItmBankAccNm",headerText : "<spring:message code='supplement.head.bankAccount'/>",editable : false},
    {dataField : "payItmBankInSlipNo",headerText : "<spring:message code='supplement.head.slipNo'/>",width : 120 , editable : false},
    {dataField : "refDtl",headerText : "<spring:message code='pay.head.refDetailsJompayRef'/>",width : 120 , editable : false},
    {dataField : "totAmt",headerText : "<spring:message code='supplement.head.amount'/>",width : 100 , editable : false, dataType:"numeric", formatString : "###0.00" },
    {dataField : "bankChgAmt",headerText : "<spring:message code='supplement.head.bankCharge'/>",width : 100 , editable : false, dataType:"numeric", formatString : "###0.00" }
];

var bankStmtLayout = [
    {dataField : "bankId",headerText : "<spring:message code='supplement.head.bankId'/>",editable : false, visible : false},
    {dataField : "bankAcc",headerText : "<spring:message code='supplement.head.bankAccountCode'/>", editable : false, visible : false},
    {dataField : "count",headerText : "", editable : false, visible : false},
    {dataField : "fTrnscId",headerText : "<spring:message code='supplement.head.tranxId'/>", editable : false},
    {dataField : "bankName",headerText : "<spring:message code='supplement.head.bank'/>", editable : false},
    {dataField : "bankAccName",headerText : "<spring:message code='supplement.head.bankAccount'/>",editable : false},
    {dataField : "fTrnscDt",headerText : "<spring:message code='supplement.head.dateTime'/>", editable : false},
    {dataField : "fTrnscTellerId",headerText : "<spring:message code='supplement.head.refCheqNo'/>", editable : false},
    {dataField : "fTrnscRef3",headerText : "<spring:message code='supplement.head.description1'/>",editable : false},
    {dataField : "fTrnscRefChqNo",headerText : "<spring:message code='supplement.head.description2'/>", editable : false},
    {dataField : "fTrnscRef1",headerText : "<spring:message code='supplement.head.ref5'/>", editable : false},
    {dataField : "fTrnscRef2",headerText : "<spring:message code='supplement.head.ref6'/>", editable : false},
    {dataField : "fTrnscRef6",headerText : "<spring:message code='supplement.head.ref7'/>", editable : false},
    {dataField : "fTrnscRem",headerText : "<spring:message code='supplement.head.type'/>", editable : false},
    {dataField : "fTrnscDebtAmt",headerText : "<spring:message code='supplement.head.debit'/>", editable : false, dataType:"numeric", formatString:"#,##0.00"},
    {dataField : "fTrnscCrditAmt",headerText : "<spring:message code='supplement.head.credit'/>", editable : false, dataType:"numeric", formatString:"#,##0.00"},
    {dataField : "fTrnscRef4",headerText : "<spring:message code='supplement.head.depositSlipNoEftMid'/>", editable : false},
    {dataField : "fTrnscNewChqNo",headerText : "<spring:message code='supplement.head.chqNo'/>", editable : false},
    {dataField : "fTrnscRefVaNo",headerText : "<spring:message code='supplement.head.vaNumber'/>", editable : false}
];

var reportLayout = [
      {dataField : "keyInDate",headerText : "<spring:message code='supplement.text.keyInDate'/>",width : 100, editable : false, visible : false},
      {dataField : "branchCode",headerText : "<spring:message code='supplement.text.brnchCode'/>",width : 100, editable : false, visible : false},
      {dataField : "userId",headerText : "<spring:message code='sys.title.user.id'/>",width : 100, editable : false, visible : false},
      {dataField : "count",headerText : "",width : 100, editable : false, visible : false},
      {dataField : "systemTransactionID",headerText : "<spring:message code='supplement.text.sysTransactionID'/>",width : 100, editable : false},
      {dataField : "order",headerText : "<spring:message code='supplement.text.order'/>",width : 100, editable : false},
      {dataField : "customerName",headerText : "<spring:message code='supplement.text.custName'/>",width : 100, editable : false},
      {dataField : "applicationType",headerText : "<spring:message code='supplement.text.appType'/>",width : 100, editable : false},
      {dataField : "amount",headerText : "<spring:message code='supplement.head.amount'/>",width : 100, editable : false, dataType:"numeric", formatString:"#,##0.00"},
      {dataField : "receiptNumber",headerText : "<spring:message code='supplement.text.receiptNo'/>",width : 100, editable : false},
      {dataField : "transactionDate",headerText : "<spring:message code='supplement.head.transactionDate'/>",width : 100, editable : false},
      {dataField : "paymentType",headerText : "<spring:message code='supplement.text.paymentType'/>",width : 100, editable : false},
      {dataField : "amount2",headerText : "<spring:message code='supplement.head.amount2'/>",width : 100, editable : false, dataType:"numeric", formatString:"#,##0.00"},
      {dataField : "bankType",headerText : "<spring:message code='supplement.text.bankType'/>",width : 100, editable : false},
      {dataField : "bankAccount",headerText : "<spring:message code='supplement.head.bankAccount'/>",width : 100, editable : false},
      {dataField : "vaNumber",headerText : "<spring:message code='supplement.head.vaNumber'/>",width : 100, editable : false},
      {dataField : "slipNo",headerText : "<spring:message code='supplement.head.slipNo'/>",width : 100, editable : false},
      {dataField : "remark",headerText : "<spring:message code='supplement.text.remark'/>",width : 100, editable : false},
      {dataField : "statementTransactionId",headerText : "<spring:message code='supplement.text.stmtTransactionID'/>",width : 100, editable : false},
      {dataField : "status",headerText : "<spring:message code='sys.title.status'/>",width : 100, editable : false},
      {dataField : "mappingRejectDate",headerText : "<spring:message code='supplement.text.mappingRejectDate'/>",width : 100, editable : false},
      {dataField : "actionDate",headerText : "<spring:message code='supplement.text.actionDate'/>",width : 100, editable : false},
      {dataField : "actionByUserID",headerText : "<spring:message code='supplement.text.actionByUserId'/>",width : 100, editable : false},
      {dataField : "actionType",headerText : "<spring:message code='supplement.text.actionType'/>",width : 100, editable : false},
      {dataField : "adjAmount",headerText : "<spring:message code='supplement.text.adjAmount'/>",width : 100, editable : false},
      {dataField : "remark2",headerText : "<spring:message code='supplement.text.remark2'/>",width : 100, editable : false},
      {dataField : "remark3",headerText : "<spring:message code='supplement.text.remark3'/>",width : 100, editable : false}
];
...
function fn_bankChange(){
    ...
    if(bankType == "2729"){
    	...
    	$("#bankAcc option").remove();
        $("#bankAcc").append("<option value=''>Choose One</option>");
        $("#bankAcc").append("<option value='525'>2710/010B - CIMB VA</option>");
    }else if(bankType == "2731"){
    	$("#bankAcc option").remove();
    	doGetCombo('/supplement/payment/getAccountList.do', '','', 'bankAcc', 'S', '');
...
function fn_searchAdvMatchList(){
    if(FormUtil.checkReqValue($("#transDateFr")) ||  FormUtil.checkReqValue($("#transDateTo"))){
        Common.alert("<spring:message code='supplement.alert.inputTransactionDate'/>");
        return;
    }
...
function fn_saveMapping(withPop){
    //Journal Entry - validation check
    if(withPop == 'Y'){
    ...
    Common.confirm("<spring:message code='pay.alert.wantToSave'/>",function (){
        Common.ajax("POST", "/supplement/payment/saveAdvPaymentMapping.do", $("#entryForm").serializeJSON(), function(result) {
...
function fn_saveDebtor(){
    ...
    Common.confirm("<spring:message code='supplement.alert.wantToSave'/>",function (){
        Common.ajax("POST", "/supplement/payment/saveAdvPaymentDebtor.do", $("#debtorForm").serializeJSON(), function(result) {
            var message = "<spring:message code='supplement.alert.mappingSuccess'/>";
...
<section id="content"><!-- content start -->
    ...
    <aside class="title_line"><!-- title_line start -->
        ...
        <h2><spring:message code='supplement.text.supplementAdvPayMatching'/></h2>
        <ul class="right_btns">
    ...
    <section class="search_table"><!-- search_table start -->
        <form action="#" method="post" id="searchForm">
            <table class="type1"><!-- table start -->
                ...
                <tbody>
                    <tr>
                        <th scope="row"><spring:message code='supplement.head.transactionDate'/></th>
                        <td>
                            <!-- date_set start -->
                        ...
                        <th scope="row"><spring:message code='supplement.text.paymentType'/></th>
                        <td>
    ...
    <div class="divine_auto"><!-- divine_auto start -->
        <div style="width:50%;">
            <aside class="title_line"><!-- title_line start -->
                <h3><spring:message code='supplement.text.advKeyInList'/></h3>
            </aside><!-- title_line end -->
            <article id="adv_keyin_grid_wrap" class="grid_wrap"></article>
        </div><!-- border_box end -->
        <div style="width:50%;">
            <aside class="title_line"><!-- title_line start -->
                <h3><spring:message code='supplement.text.bankStatement'/></h3>
            </aside><!-- title_line end -->
...
<div id="reportAdvanceKeyin_wrap" class="popup_wrap" style="display:none">
    ...
    <h1><spring:message code='supplement.text.advKeyInRpt'/></h1>
    <ul class="right_opt">
        <li><p class="btn_blue2"><a href="#" onclick="javascript:fn_generateReport();"><spring:message code='supplement.btn.generateRpt'/></a></p></li>
        <li><p class="btn_blue2"><a href="#" onclick="hideViewPopup('#reportAdvanceKeyin_wrap');"><spring:message code='sys.btn.close'/></a></p></li>
    </ul>

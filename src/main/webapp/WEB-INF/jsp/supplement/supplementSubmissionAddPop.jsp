...
<script type="text/javaScript">
  ...
  <header class="pop_header">
    <!-- pop_header start -->
    <h1><spring:message code="supplement.text.newSubmission" /></h1>
    <ul class="right_opt">
      <li>
        <p class="btn_blue2">
                    ...
                    <label>
                      <input type='text' class='input_text' readonly='readonly' />
                        <span class='label_text'>
                          <a href='#'><spring:message code="sys.btn.upload" /></a></span> <span class='label_text'></span>
                    </label>
                  </div>
                </td>
              </tr>
                ...
                <td>
                  <div class="auto_file2">
                    ...
                    <label>
                      ...
                      <a href='#'><spring:message code="sys.btn.upload" /></a></span>
                      <span class='label_text'>
                        <a href='#' onclick='fn_removeFile("OTH")'><spring:message code="sys.btn.remove" /></a>
                      </span>
                    </label>
                  </div>
                </td>
                ...
                <td>
                  <div class="auto_file2">
                    ...
                    <label>
                      ...
                      <span class='label_text'>
                        <a href='#' onclick='fn_removeFile("OTH2")'><spring:message code="sys.btn.remove" /></a>
                      </span>
                    </label>
                  </div>
                </td>
                ...
                <td>
                  <div class="auto_file2">
                    ...
                    <label>
                      ...
                      <span class='label_text'>
                        <a href='#' onclick='fn_removeFile("OTH3")'><spring:message code="sys.btn.remove" /></a>
                      </span>
                    </label>
                  </div>
                </td>
                ...
                <td>
                  <div class="auto_file2">
                    ...
                    <label>
                      ...
                      <span class='label_text'>
                        <a href='#' onclick='fn_removeFile("OTH4")'><spring:message code="sys.btn.remove" /></a>
                      </span>
                    </label>
                  </div>
                </td>
                ...
                <td>
                  <div class="auto_file2">
                    ...
                    <label>
                      ...
                      <span class='label_text'>
                        <a href='#' onclick='fn_removeFile("OTH5")'><spring:message code="sys.btn.remove" /></a>
                      </span>
                    </label>
                  </div>
                </td>

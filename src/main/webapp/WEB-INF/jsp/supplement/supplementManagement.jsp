...
/*      CommonCombo.make('cmbWhBrnchId', "/supplement/selectWhBrnchList", '' , '', '');
    ...
    $("#_search").click(function() {
    	...
    	console.log ("_supRefNo ::" + $("#_supRefNo").val());
    	...
    	if ($("#_supRefNo").val() == '' ) {
            if ($("#_sDate").val() == '' || $("#_eDate").val() == ''){
             ...
             if (!js.date.checkDateRange($("#_sDate").val() , $("#_eDate").val() ,"Reference Date", "1"))
            	 {
    ...
    $("#_updateShipTrackNoBtn").click(function() {
    	...
    	var supplementForm = { supRefId : clickChk[0].item.supRefId, ind : "1" };
...
function createPosPaymentDetailGrid(){
    var posPaymentColumnLayout =  [
                                     ...
                                     { dataField:"itemCode" ,headerText:"<spring:message code='log.head.itemcode'/>" ,editable : false },
                                     { dataField:"itemDesc" ,headerText:"<spring:message code='log.head.itemdescription'/>" ,editable : false },
                                     { dataField:"quantity" ,headerText:"<spring:message code='pay.head.quantity'/>" ,editable : false },
                                     { dataField:"unitPrice" ,headerText:"<spring:message code='pay.head.unitPrice'/>" ,editable : false , dataType : "numeric", formatString : "#,##0.#"},
                                     { dataField:"totalAmount" ,headerText:"<spring:message code='pay.head.totalAmount'/>" ,editable : false , dataType : "numeric", formatString : "#,##0.#" }
  ...
  //          selectionMode       : "singleRow",  //"multipleCells",
    ...
    posItmDetailGridID = GridCommon.createAUIGrid("#payment_detail_grid_wrap", posPaymentColumnLayout,'',paymentGridPros);  // address list
...
function createAUIGrid(){
    ...
    var posColumnLayout =  [
                           /*  {dataField : "supRefNo", headerText : '<spring:message code="supplement.text.supplementReferenceNo" />', width : '8%' , editable : false},
                            {dataField : "sofNo", headerText : '<spring:message code="supplement.text.eSOFno" />', width : '8%', editable : false},
                            {dataField : "supRefStus", headerText : '<spring:message code="supplement.text.supplementReferenceStatus" />', width : '8%' , editable : false},
                            {dataField : "supRefStg", headerText : '<spring:message code="supplement.text.supplementReferenceStage" />', width : '8%' , editable : false},
                            {dataField : "supRefDate", headerText : '<spring:message code="supplement.text.supplementReferenceDate" />', width : '8%' , editable : false},
                            {dataField : "submBrch", headerText : '<spring:message code="supplement.text.submissionBranch" />', width : '8%' , editable : false},
                            {dataField : "parcelTrackNo", headerText : '<spring:message code="supplement.text.supplementTrackingNo" />', width : '8%' , editable : false},

                            {dataField : "SupConsgNo", headerText : '<spring:message code="supplement.text.supplementConsignmentNo" />', width : '20%' , editable : false},
                            {dataField : "salesmanId", headerText : '<spring:message code="sal.text.salManId" />', width : '18%' , editable : false},
                            {dataField : "salesmanName", headerText : '<spring:message code="sal.text.salManName" />', width : '8%' , style : 'left_style' , editable : false},
                            {dataField : "custName", headerText : '<spring:message code="sal.text.custName" />', width : '8%' , style : 'left_style' , editable : false},
                            {dataField : "refCreateBy", headerText : '<spring:message code="sal.text.refCreateBy" />', width : '8%' , editable : false},
                            {dataField : "refCreateDate", headerText : '<spring:message code="sal.text.refCreateDate" />', width : '8%' , editable : false},
                            {dataField : "refUpdateBy", headerText : '<spring:message code="sal.text.refUpdateBy" />', width : '8%' , editable : false},
                            {dataField : "refUpdateDate", headerText : '<spring:message code="sal.text.refUpdateDate" />', width : '8%' , editable : false}, */

                            {dataField : "supRefId", visible : false , editable : false},
                            {dataField : "supRefNo", headerText : 'reference No', width : '8%' , editable : false},
                            {dataField : "sofNo", headerText : '<spring:message code="supplement.text.eSOFno" />', width : '8%', editable : false},
                            {dataField : "supRefStus", headerText : 'Reference Status', width : '8%' , editable : false},
                            {dataField : "supRefStg", headerText : 'Reference Stage', width : '8%' , editable : false},
                            {dataField : "supRefDate", headerText : 'Reference Date', width : '8%' , editable : false},
                            {dataField : "submBrch", headerText : 'Submission Branch', width : '8%' , editable : false},
                            {dataField : "parcelTrackNo", headerText : 'Tracking No', width : '8%' , editable : false},

                            {dataField : "SupConsgNo", headerText : 'Consignment No', width : '20%' , editable : false},
                            {dataField : "salesmanId", headerText : '<spring:message code="sal.text.salManId" />', width : '18%' , editable : false},
                            {dataField : "salesmanName", headerText : '<spring:message code="sal.text.salManName" />', width : '8%' , style : 'left_style' , editable : false},
                            {dataField : "custName", headerText : '<spring:message code="sal.text.custName" />', width : '8%' , style : 'left_style' , editable : false},
                            {dataField : "refCreateBy", headerText : '<spring:message code="sal.text.refCreateBy" />', width : '8%' , editable : false},
...
function createExcelAUIGrid(){
    ...
    var excelColumnLayout =  [
                            ...
                            {dataField : "supRefNo" , headerText : "Reference No", width : 100 , editable : false},
                            {dataField : "sofNo", headerText : "eSOF No", width : 100, editable : false},
                            {dataField : "supRefStus", headerText : "Reference Status", width : 100 , editable : false},
                            {dataField : "supRefStg", headerText : "Reference Stage" , width : 100 , editable : false},
                            {dataField : "supRefDate", headerText : "Reference Date", width : 100 , editable : false},
                            {dataField : "submBrch", headerText : "Branch", width : 100 , editable : false},
                            {dataField : "parcelTrackNo", headerText : "parcel Tracking No", width : 100 , editable : false},

                            {dataField : "SupConsgNo", headerText : "Consignment No", width : 100, editable : false},
                            {dataField : "salesmanId", headerText : "salesman Id", width : 100 , editable : false},
                            {dataField : "salesmanName", headerText : "salesman Name", width : 100 , editable : false},
                            {dataField : "custName", headerText : "Customer Name", width :100 , editable : false},
                            {dataField : "refCreateBy", headerText : "CreateBy", width : 100 , editable : false},
                            {dataField : "refCreateDate", headerText : "CreateDate", width : 100 , editable : false},
                            {dataField : "refUpdateBy", headerText : "UpdateBy", width : 100 , editable : false},
                            {dataField : "refUpdateDate",  headerText : "UpdateDate", width : 100 , editable : false}
...
<h2><spring:message code="supplement.title.supplementManagement" /></h2>
<ul class="right_btns">
    <c:if test="${PAGE_AUTH.funcUserDefine1 == 'Y'}">
    <li><p class="btn_blue"><a href="#" id="_updateShipTrackNoBtn"><spring:message code="supplement.title.updateShipmentTrackingNo" /></a></p></li>
    </c:if>
     <c:if test="${PAGE_AUTH.funcUserDefine2 == 'Y'}">
        <li><p class="btn_blue"><a href="#" id="_viewBtn"><spring:message code="sys.scm.inventory.ViewDetail" /></a></p></li>
    </c:if>
...
<tr>
  ...
  <!--   <td>
     <select  id="cmdSupRefStus"  name="supRefStus" class="w100p"></select>
    </td> -->
    <td><select class="multy_select w100p" multiple="multiple"  id="supRefStus" name="supRefStus">
...
<tr>
    <th scope="row"><spring:message code="supplement.text.supplementReferenceDate" /><span class="must">*</span></th>
    <td>
    ...
    <th scope="row"><spring:message code="supplement.text.supplementReferenceCreator" /></th>
    <td>
...
<tr>
    <th scope="row"><spring:message code="sal.text.salManId" /></th>
    <td>
    ...
    <td>
        <input id="salesmanPopNm" name="salesmanPopNm" type="text" title="" placeholder="" class="w100p"  disabled="disabled"/>

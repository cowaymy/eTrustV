...
<script type="text/javascript">
  ...
  function fn_dailyOrderReport() {
	Common.popupDiv("/supplement/supplementDailyOrderReportPop.do",{ind : 'CAN'},null, true, '_insDiv');
  }

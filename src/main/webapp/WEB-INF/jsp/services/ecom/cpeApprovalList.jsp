...
<script type="text/javaScript">
      ...
      $("#search").click(
        function() {
          ...
          AUIGrid.bind(gridID, "cellDoubleClick", function(event) {
              ...
              console.log("CellDoubleClick cpeId : " + event.item.cpeId);

              var cpeId = event.item.cpeId;
              var appvPrcssNo = event.item.appvPrcssNo;
              fn_cpeRequestApproveViewPop();
          });
  ...
  function fn_cpeApproveViewPop() {
      var data = {
          appvPrcssNo : appvPrcssNo,
          cpeId : cpeId
      };
      Common.popupDiv("/services/ecom/cpeApproveViewPop.do", data, null, true, "cpeApproveViewPop");
  }

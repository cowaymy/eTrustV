...
<ul class="right_btns">
    ...
    <li><p class="btn_grid"><a href="#" id="lineDel_btn"><spring:message code="newCpeRequest.btn.delete" /></a></p></li>
</ul>
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a href="#" id="submit"><spring:message code="newCpeRequest.btn.submit" /></a></p></li>
</ul>

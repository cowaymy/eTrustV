...
function asManagementGrid() {
    ...
    var columnLayout = [ {
        ...
        editable : false,
        width : 120 , dataType : "date", formatString : "dd/mm/yyyy"
    }, {
        dataField : "code1",
...
function fn_CompensationPop(){
    Common.popupDiv("/services/compensation/compensationCreatePop.do", $("#compensationForm").serializeJSON(), null , true , '');
}
...
<tr>
    ...
    <p><input type="text" title="Create start Date" placeholder="DD/MM/YYYY" class="j_date" id="applicationStrDate"  name="applicationStrDate"/></p>
    <span>To</span>
    <p><input type="text" title="Create end Date" placeholder="DD/MM/YYYY" class="j_date" id="applicationEndDate" name="applicationEndDate"/></p>
    </div><!-- date_set end -->
    </td>
</tr>
<tr>
    <th scope="row">DSC Branch</th>
    <td><input type="text" title="" placeholder="DSC Branch" class="w100p" id="dscBranch" name="dscBranch"/></td>
    <th scope="row">Compensation Type</th>
    <td><input type="text" title="" placeholder="Compensation Type" class="w100p" id="compensationType" name="compensationType"/></td>
    <th scope="row">Responsibility Type</th>
    <td><input type="text" title="" placeholder="Responsibility Type" class="w100p" id="ResponsibilityType" name="ResponsibilityType"/></td>
</tr>
<!-- 171115 :: 선한이  -->
<tr>
    <th scope="row">Cause of Compensation</th>
    <td><input type="text" title="" placeholder="Cause of Compensation" class="w100p" id="causeOfCompensation" name="causeOfCompensation"/></td>
    <th scope="row">Status</th>
    <td><input type="text" title="" placeholder="Status" class="w100p" id="status" name="status"/></td>
...
<ul class="right_btns">
    <li><p class="btn_grid"><a href="#" onClick="fn_CompensationPop()">Add Case</a></p></li>

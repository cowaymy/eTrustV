...
function createCFilterAUIGrid() {
        ...
        var  clayout = [
                            ...
                            { dataField : "filterID",     headerText  : "filterID",  width          :150,    editable       : false }
...
function  fn_setSaveFormData(){
	...
	var asResultM ={
				   ...
				   AS_DEFECT_GRP_ID:             0,  
				   AS_DEFECT_ID:                   $('#ddlStatus').val()== 4 ? $('#def_code').val() : '0' , 
				   AS_DEFECT_PART_GRP_ID:    0 , 
				   AS_DEFECT_PART_ID:          $('#ddlStatus').val()== 4 ? $('#def_part').val() : '0' , 
...
<tr>
    ...
    <td colspan="3">   <span id="txtRequestorContact">text</span>  </td>

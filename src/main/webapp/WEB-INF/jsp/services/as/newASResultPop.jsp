...
<dl>
    ...
    <tr>
        ...
        <td>
        <input type="text" title="Create start Date" placeholder="DD/MM/YYYY" class="readonly j_date" disabled="disabled" />
        </td>
    ...
    <tr>
        ...
        <input type="text" title="" placeholder="" class="readonly time_date" disabled="disabled" />
        <ul>
            <li>Time Picker</li>
    ...
    <tr>
        ...
        <td colspan="3">
        <textarea cols="20" rows="5" placeholder="" class="readonly" readonly="readonly"></textarea>
        </td>
    </tr>
    <tr>
        <th scope="row">Commission</th>
        <td colspan="3">
        <label><input type="checkbox" disabled="disabled" /><span>Has commission ? </span></label>
        </td>
    </tr>
    </tbody>
    </table><!-- table end -->
    ...
    <ul class="center_btns">
        <li><p class="btn_blue2"><a href="#">Add Filter</a></p></li>

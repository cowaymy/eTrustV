...
function  fn_setSaveFormData(){
    ...
    Common.ajax("POST", "/services/as/saveASInHouseEntry.do", saveForm, function(result) {
        console.log("newASInHouseAdd.");
        console.log( result);       
        
        if(result.data !=""){
            Common.alert("<b>AS result successfully saved.</b>  </BR> New ASNo["+result.asNo+"] New ResultNo ["+result.asResultNo+"]</b>");
              $("#txtResultNo").html( "<font size='3' color='red'> <b> " +result.asResultNo+ " </b></font>");  
              fn_DisablePageControl();

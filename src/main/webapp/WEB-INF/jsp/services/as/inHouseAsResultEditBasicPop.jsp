...
function  fn_setSaveFormData(){
    ...
    Common.ajax("POST", "/services/as/updateASInHouseEntry.do", saveForm, function(result) {
        console.log("updateASInHouseEntry.");
        console.log( result);       
...
<tr>
    ...
    <td >
         <input type="text" title="" placeholder="Open AS  No "  disabled="disabled"  class="readonly" id="asOpenAsNo" name="asOpenAsNo"/>
    </td>
    <th scope="row">Close AS  No </th>
    <td >
            <input type="text" title="" placeholder="Close AS  No"disabled="disabled"  class="readonly" id="asCloseAsNo" name="asCloseAsNo"  />
    </td>
 </tr>
...
<tr>
    ...
    <td >
         <input type="text" title="" placeholder="DD/MM/YYYY"  disabled="disabled" class="readonly j_date" id="asResultCrtDt" name="asResultCrtDt"/>
    </td>
...
<tr style="display:none">
    ...
    <td >
            <input type="text" title="" placeholder="DD/MM/YYYY" class="j_date" id="APPNT_DT" name="APPNT_DT"/>
    </td>
 </tr>

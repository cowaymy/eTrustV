...
<tr>
    <td>
    <label><input type="radio" name="name" checked="checked" /><span>CT Sub Group Display</span></label>
    <label><input type="radio" name="name" /><span>Sub Group – Area Display</span></label>
    </td>
</tr>
</tbody>
</table>
...
<ul class="right_btns">
    <li><p class="btn_grid"><a href="#">CT Sub Group Edit</a></p></li>
    <li><p class="btn_grid"><a href="#" onclick="javascript:fn_CTSubGroupSave()">CT Sub Group Save</a></p></li>

...
function createLargeAUIGrid() {
    ...
    [
      ...
      { dataField : "defectTyp", headerText : "Defect Type", width : "15%"},
      { dataField : "defectCode", headerText : "Defect Code", width : "15%"},
      { dataField : "defectDesc", headerText : "Defect Description", width : "15%"},
      { dataField : "defectRemark", headerText : "Remark", width : "15%"},

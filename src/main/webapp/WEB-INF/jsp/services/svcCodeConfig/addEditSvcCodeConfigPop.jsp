...
var msg = "";
var prdCtgry = '${codeMgmtMap.stkCtgryId}';
var statusId = '${codeMgmtMap.stusId}';

$(document).ready(function(){
	doGetCombo('/services/svcCodeConfig/selectProductCategoryList.do', '', '${codeMgmtMap.stkCtgryId}', 'productCtgry', 'S','');
...
function  fn_viewType(type){
    ...
    if(type == 1){
    	...
    	$("#productCtgry option[value="+prdCtgry +"]").attr("selected", true);

...
<h1>BS Management - BS REPORT(SINGLE)</h1>
<ul class="right_opt">
...
<tr>
    ...
    <td><input type="text" title="BS Number" placeholder="BS Number" class="w100p" /></td>
    <th scope="row">BS Month</th>
    <td><input type="text" title="BS Month" placeholder="MM/YYYY" class="j_date2 w100p" /></td>
</tr>
<tr>
    <th scope="row">Order Number</th>
    <td><input type="text" title="Order Number" placeholder="Order Number" class="w100p" /></td>
    <th scope="row">Member Code</th>
    <td><input type="text" title="Member Code" placeholder="Member Code" class="w100p" /></td>
</tr>
</tbody>
</table><!-- table end -->

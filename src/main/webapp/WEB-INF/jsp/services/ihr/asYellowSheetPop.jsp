...
<script type="text/javaScript">
  ...
  function fn_openExcel() {
    ...
    if (fn_validation) {
      ...
      $("#reportFormYS #V_BRANCHID").val(branchID);
      $("#reportFormYS #V_YSAGING").val(YSAging);
      $("#reportFormYS #reportFileName").val('/services/IHYellowSheet_RawData.rpt');
      $("#reportFormYS #viewType").val("EXCEL");
      $("#reportFormYS #reportDownFileName").val("IHYellowSheet_" + day + month + date.getFullYear());

...
<script type="text/javaScript">
  ...
  function fn_getASEvntsInfo() {
    Common.ajax("GET", "/services/inhouse/getASEvntsInfo.do", $("#resultASForm")
  ...
  function fn_getASHistoryInfo() {
    Common.ajax("GET", "/services/inhouse/getASHistoryInfo.do", $(
        "#resultASForm").serialize(), function(result) {
  ...
  function fn_selectASDataInfo() {
    ...
    Common.ajax("GET", "/services/inhouse/selectASDataInfo", $("#resultASForm")
        .serialize(), function(result) {
      asDataInfo = result;
    });
  }
...
<div id="popup_wrap" class="popup_wrap">
 ...
 <section id="content">
  ...
  <section class="pop_body">
   ...
   <jsp:include page='${pageContext.request.contextPath}/services/inhouse/asResultInfoEdit.do' />

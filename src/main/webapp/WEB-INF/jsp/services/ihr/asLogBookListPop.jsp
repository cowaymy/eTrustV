...
<script type="text/javaScript">
  $(document).ready(
    function() {
      ...
      //doGetCombo('/services/inhouse/report/selectMemberCodeList.do', '', '','CTCode', 'S' ,  '');
  ...
  function fn_changeCT() {
    ...
    doGetCombo('/services/inhouse/report/selectMemberCodeList.do', branchCd, '', 'CTCode', 'S', '');
  }
  function fn_openGenerate() {
    ...
    if (fn_validation()) {
      ...
      $("#reportFormList #reportFileName").val('/services/IHLogBookList.rpt');
      $("#reportFormList #reportDownFileName").val("IHLogBook_" + day + month + date.getFullYear());

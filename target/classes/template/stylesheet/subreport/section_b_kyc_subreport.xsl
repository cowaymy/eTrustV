					...
					<table id='section_b_match_details_table_template'
						...
						<p class="title">
							...
							<xsl:value-of select="r:name" />
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="r:false_positive != ''">
                                                        <tr>
                                                                <th class="caption-left-match-details">False Positive</th>
                                                                <td class="long-content-left-match-details">
                                                                        <xsl:choose>
                                                                                <xsl:when test="r:false_positive = 'true'">
                                                                                        True – Incorrect matching result
                                                                                </xsl:when>
                                                                                <xsl:when test="r:false_positive = 'false'">
                                                                                        False – Correct matching result
                                                                                </xsl:when>
                                                                                <xsl:when test="r:false_positive = ''">
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="r:name_score != ''">
                                                        <tr>
                                                                <th class="caption-left-match-details">Name Score</th>
                                                                <td class="long-content-left-match-details">
                                                                        <xsl:choose>
                                                                                <xsl:when test="r:name_score != ''">
                                                                                        <xsl:value-of select="r:name_score" />
                                                                                </xsl:when>
                                                                                <xsl:when test="r:name_score = ''">
                                                                                        <xsl:value-of select="$nonapplicable" />
                                                                                </xsl:when>

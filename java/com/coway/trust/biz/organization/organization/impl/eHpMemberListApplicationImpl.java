...
//import com.coway.trust.biz.organization.organization.impl.eHPmemberListMapper;
  ...
  public class eHpMemberListApplicationImpl implements eHpMemberListApplication {
      ...
      @Override
      public void insertEHPAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params, List<String> seqs) {
      ...
      public void insertFile(int fileGroupKey, FileVO flVO, FileType flType, Map<String, Object> params,String seq) {
          ...
          int atchFlId = eHPmemberListMapper.selectNextFileId();
          ...
          eHPmemberListMapper.insertFileDetail(flInfo);
      ...
      @Override
      public void updateEHPAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params,List<String> seqs) {
          // TODO Auto-generated method stub

...
/**
 * @ClassName : GroupOrderApiMapper.java
 ...
 * </pre>
 */
@Mapper("groupOrderApiMapper")
public interface GroupOrderApiMapper {
	 ...
	 * @param params
	 */
	void insertGroupOrderMove(Map<String, Object> params);
	 ...
	 * @param params
	 */
	void updateGroupOrderMove(Map<String, Object> params);
	 ...
	 * @return
	 */
	EgovMap selectGroupOrderReqStusYn(Map<String, Object> params);

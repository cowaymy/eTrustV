package com.coway.trust.biz.payment.groupOrder.service;
...
/**
 * @ClassName : GroupOrderApiService.java
 ...
 * </pre>
 */
public interface GroupOrderApiService{
    ...
    * @return
    */
	List<EgovMap> selectGroupOrder(Map<String, Object> params);
	 ...
	 * @return
	 */
	List<EgovMap> selectGroupOrderList(Map<String, Object> params);
	 ...
	 * @return
	 */
	List<EgovMap> selectGroupOrderDetailList(Map<String, Object> params);
	 ...
	 * @throws Exception
	 */
	void saveGroupOrderMove(GroupOrderForm  groupOrderForm) throws Exception;
	 ...
	 * @throws Exception
	 */
	void saveGroupOrderCancel(GroupOrderForm  groupOrderForm) throws Exception;

...
public class OrderReqApplicationImpl implements OrderReqApplication {
  ...
  @Override
  public void insertOrderCancelAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params, List<String> seqs) {
  ...
  public void insertFile(int fileGroupKey, FileVO flVO, FileType flType, Map<String, Object> params,String seq) {
      ...
      int atchFlId = orderRequestMapper.selectNextFileId();
      ...
      orderRequestMapper.insertFileDetail(flInfo);
  ...
  @Override
  public void updateOrderCancelAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params,List<String> seqs) {
      // TODO Auto-generated method stub

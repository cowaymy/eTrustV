...
@Mapper("ccpRentalAgreementMapper")
public interface CcpRentalAgreementMapper {
	...
	String crtSeqSAL0308D();

	String crtSeqSAL0307D();

	String crtSeqSAL0306D();
	...
	void updateGovAgreementInfo(Map<String, Object> params) throws Exception;

	void updateGovAgreementSub(Map<String, Object> params) throws Exception;
}

...
public class AdjustmentStockBarcodeListVo implements Serializable {
	...
	private List<BarcodeDListDto> adjustList;

	private List<BarcodeCListDto> completeList;
	...
	public List<BarcodeDListDto> getAdjustList() {
		return adjustList;
	}

	public void setAdjustList(List<BarcodeDListDto> adjustList) {
		this.adjustList = adjustList;
	}

	public List<BarcodeCListDto> getCompleteList() {
		return completeList;
	}

	public void setCompleteList(List<BarcodeCListDto> completeList) {

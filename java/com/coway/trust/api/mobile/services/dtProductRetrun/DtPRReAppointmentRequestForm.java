...
public class DtPRReAppointmentRequestForm {
	...
	public static Map<String, Object> createMaps(DtPRReAppointmentRequestForm pRReAppointmentRequestForm) {
		...
		List<Map<String, Object>> list = new ArrayList<>();
			...
			map = BeanConverter.toMap(pRReAppointmentRequestForm);

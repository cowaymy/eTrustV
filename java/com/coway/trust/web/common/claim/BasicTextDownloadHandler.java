...
class BasicTextDownloadHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(BasicTextDownloadHandler.class);
	...
	BasicTextDownloadHandler(FileInfoVO fileInfoVO, Map<String, Object> params) {

...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        if(initForm.initType.value == '282'){
            $("#prodExchngDiv").hide();
            $("#applicationDiv").show();
            $("#OwnerShipDiv").hide();
        }
        if(initForm.initType.value == '284'){
            $("#prodExchngDiv").hide();
            $("#applicationDiv").hide();
            $("#OwnerShipDiv").show();
        }
    ...
    function fn_selectOrderSameRentalGroupOrderList() {        
        Common.ajax("GET", "/sales/order/selectSameRentalGrpOrderJsonList.do", $("#initForm").serialize(), function(result) {
    ...
    function fn_selectMembershipInfoList() {        
        Common.ajax("GET", "/sales/order/selectMembershipInfoJsonList.do", $("#initForm").serialize(), function(result) {
    ...
    function fn_selectDocumentList() {        
        Common.ajax("GET", "/sales/order/selectDocumentJsonList.do", $("#initForm").serialize(), function(result) {
    ...
    function fn_selectCallLogList() {        
        Common.ajax("GET", "/sales/order/selectCallLogJsonList.do", $("#initForm").serialize(), function(result) {
    ...
    function fn_selectPaymentList() {        
        Common.ajax("GET", "/sales/order/selectPaymentJsonList.do", $("#initForm").serialize(), function(result) {
    ...
    function fn_selectTransList() {        
        Common.ajax("GET", "/sales/order/selectLast6MonthTransJsonList.do", $("#initForm").serialize(), function(result) {
    ...
    function fn_selectAutoDebitList() {        
        Common.ajax("GET", "/sales/order/selectAutoDebitJsonList.do", $("#initForm").serialize(), function(result) {
    ...
    function fn_selectDiscountList() {        
        Common.ajax("GET", "/sales/order/selectDiscountJsonList.do", $("#initForm").serialize(), function(result) {
...
//    	Common.alert(msg);
    ...
    function fn_saveCancel(){
    	Common.ajax("GET", "/sales/order/saveCancelReq.do", $("#initForm").serialize(), function(result){
...
<form id="initForm" name="initForm" method="post">
    <input type="text" id="initType" name="initType" value="${initType }">

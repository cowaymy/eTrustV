...
function setPackgCombo(){
    doGetCombo('/sales/membershipRentalQut/getSrvMemCode', '', '','cTPackage', 'S' , 'f_multiCombo');            // Customer Type Combo Box
    doGetCombo('/sales/membershipRentalQut/getPromotionCode', '', '','cPromotionpac', 'S' , 'f_multiCombo2');          
...
<div  id="resultcontens"  style="display:none">
		...
		<tr>
		    ...
		    <td  colspan="3"><span id='txtMonthlyFee'></span></td>  
		</tr>
		<tr>

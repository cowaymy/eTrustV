...
@Mapper("rentalMemberShipBillingMapper")
public interface RentalMemberShipBillingMapper {
	 ...
	 * @return
	 */
	void insBillTaskLog_M(Map<String, Object> params);
	 ...
	 * @return
	 */
	EgovMap selectSalesOrderMs_M(Map<String, Object> params);
	 ...
	 * @return
	 */
	void insTaskLogOrder_M(Map<String, Object> params);
	 ...
	 * @return
	 */
	void confirmTaxesManualBillRentalMbrsh(Map<String, Object> params);
}

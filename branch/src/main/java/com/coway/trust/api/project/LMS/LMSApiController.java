...
public class LMSApiController {
  ...
  public ResponseEntity<EgovMap> updateCourse(HttpServletRequest request,@ModelAttribute Map<String, Object> params) throws Exception {
  ...
  public ResponseEntity<EgovMap> updateCourseAttend(HttpServletRequest request,@ModelAttribute Map<String, Object> params) throws Exception {
  ...
  public ResponseEntity<EgovMap> updateAttendResult(HttpServletRequest request,@ModelAttribute Map<String, Object> params) throws Exception {

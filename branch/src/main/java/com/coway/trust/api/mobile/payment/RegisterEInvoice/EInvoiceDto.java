...
/**
 * @ClassName : RegisterEInvoiceDto.java
 ...
 * </pre>
 */
@ApiModel(value = "EInvoiceDto", description = "E-Invoice Dto")
public class EInvoiceDto {
    ...
    @ApiModelProperty(value = "nric")
    private String nric;

    @ApiModelProperty(value = "custBillEmail")
    private String custBillEmail;

    @ApiModelProperty(value = "custBillIsEstm")
    private int custBillIsEstm;

    @ApiModelProperty(value = "custBillIsPost")
    private int custBillIsPost;

    @ApiModelProperty(value = "custBillIsSms")
    private int custBillIsSms;


    @ApiModelProperty(value = "cntcName")
    private String cntcName;

    @ApiModelProperty(value = "mobileNo")
    private String mobileNo;

    @ApiModelProperty(value = "custBillEmailAdd")
	...
	public static EInvoiceDto create(EgovMap egvoMap) {
		// TODO Auto-generated method stub
		return BeanConverter.toBean(egvoMap, EInvoiceDto.class);
	}
}

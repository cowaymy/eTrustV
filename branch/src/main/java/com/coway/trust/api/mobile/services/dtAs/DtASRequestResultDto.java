...
public class DtASRequestResultDto {
	...
	public static DtASRequestResultDto create(EgovMap egvoMap) {
		return BeanConverter.toBean(egvoMap, DtASRequestResultDto.class);
	}

...
@Service("scmActivityFundApplication")
public class ScmActivityFundApplicationImpl implements ScmActivityFundApplication {
	...
	@Override
	public void insertScmActivityFundAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
	...
	@Override
	public void updateScmActivityFundAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
	...
	@Override
	public void deleteScmActivityFundAttachBiz(FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub
		LOGGER.debug("params =====================================>>  " + params);
		if(CommonUtils.isEmpty(params.get("clmNo"))) {
			...
			fileService.removeFilesByFileGroupId(type, (int) params.get("atchFileGrpId"));
			scmActivityFundService.deleteScmActivityFundExpItem(params);
			scmActivityFundService.updateScmActivityFundExpTotAmt(params);
		}
	}

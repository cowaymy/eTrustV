...
public class VendorApplicationImpl implements VendorApplication {
	...
	@Override
	public void insertVendorAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
	...
	@Override
	public void updateVendorAttachBiz(List<FileVO> list, FileType type, Map<String, Object> params) {
		// TODO Auto-generated method stub

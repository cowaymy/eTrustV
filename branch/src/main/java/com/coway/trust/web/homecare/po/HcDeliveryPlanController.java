...
public class HcDeliveryPlanController {
	private static Logger logger = LoggerFactory.getLogger(HcDeliveryPlanController.class);
	...
	public ResponseEntity<ReturnMessage> selectHcDeliveryPlanMainList(@RequestBody Map<String, Object> params, HttpServletRequest request, ModelMap model) throws Exception {
		...
		result.setTotal(hcDeliveryPlanService.selectHcDeliveryPlanMainListCnt(params));
		if(result.getTotal() != 0){
			list =  hcDeliveryPlanService.selectHcDeliveryPlanMainList(params);
		}
	...
	// Detail 조회
	@RequestMapping(value = "/selectHcDeliveryPlanSubList.do", method = RequestMethod.GET)
	public ResponseEntity<ReturnMessage> selectHcDeliveryPlanSubList(@RequestParam Map<String, Object> params, HttpServletRequest request, ModelMap model) throws Exception {
		ReturnMessage result = new ReturnMessage();

		List<EgovMap> list = hcDeliveryPlanService.selectHcDeliveryPlanSubList(params);
	...
	// Plan 조회
	@RequestMapping(value = "/selectHcDeliveryPlanPlan.do", method = RequestMethod.GET)
	public ResponseEntity<ReturnMessage> selectHcDeliveryPlanPlan(@RequestParam Map<String, Object> params, HttpServletRequest request, ModelMap model) throws Exception {
		ReturnMessage result = new ReturnMessage();

		List<EgovMap> list = hcDeliveryPlanService.selectHcDeliveryPlanPlan(params);
		result.setTotal(list.size());
	...
	// 존재하는 Plan을 확인한다.
	@RequestMapping(value = "/selectHcDeliveryPlanPlanCnt.do", method = RequestMethod.GET)
	public ResponseEntity<ReturnMessage> selectHcDeliveryPlanPlanCnt(@RequestParam Map<String, Object> params, HttpServletRequest request, ModelMap model) throws Exception {
		ReturnMessage result = new ReturnMessage();
		int cnt = hcDeliveryPlanService.selectHcDeliveryPlanPlanCnt(params);
		result.setCode(AppConstants.SUCCESS);
		result.setMessage(messageAccessor.getMessage(AppConstants.MSG_SUCCESS));
		result.setData(cnt);
		return ResponseEntity.ok(result);
	...
	// Po의 Plan을 전부 삭제한다.
	@RequestMapping(value = "/deleteHcPoPlan.do", method = RequestMethod.POST)
	public ResponseEntity<ReturnMessage> deleteHcPoPlan(@RequestBody Map<String, Object> params, SessionVO sessionVO) throws Exception {

		int totCnt = hcDeliveryPlanService.deleteHcPoPlan(params, sessionVO);
	...
	// plan Management Save
	@RequestMapping(value = "/multiHcPoPlan.do", method = RequestMethod.POST)
	public ResponseEntity<ReturnMessage> multiHcPoPlan(@RequestBody Map<String, ArrayList<Object>> params, SessionVO sessionVO) throws Exception {

		int totCnt = hcDeliveryPlanService.multiHcPoPlan(params, sessionVO);

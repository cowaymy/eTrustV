...
/*     function fn_getHsViewfilterInfoAjax(){
         Common.ajax("GET", "/homecare/services/selectHsViewfilterPop.do",{selSchdulId : selSchdulId}, function(result) {
         ...
         Common.ajax("GET", "/homecare/services/selectHistoryHSResult.do",{selSchdulId : selSchdulId}, function(result) {
...
/*
         Common.ajax("GET", "/homecare/service/selectFilterTransaction.do",{selSchdulId : selSchdulId}, function(result) {
...
<tr>
    ...
    <th scope="row">Prev CS Area</th>
    <td><span><c:out value="${basicinfo.prevSvcArea}"/></span></td>
    <th scope="row">Next CS Area</th>

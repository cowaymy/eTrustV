<script type="text/javaScript" language="javascript">
    ...
    function createAUIGrid2() {
        ...
        var columnLayout = [
          ...
          , { headerText : '<spring:message code="sal.text.package" />',      dataField : "pacName"  , width   : 200    }
    ...
    function fn_selectMembershipInfoList() { console.log('fn_selectMembershipInfoList');
        Common.ajax("GET", "/homecare/sales/selectMembershipInfoJsonList.do", {salesOrderId : '${orderDetail.basicInfo.ordId}'}, function(result) {

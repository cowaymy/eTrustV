...
function fn_report(viewType){
    ...
    if(viewType == "PDF"){
        ...
        $("#form #reportFileName").val("/homecare/htOrderSOFList.rpt");
    }else if(viewType == "EXCEL"){
        $("#form #viewType").val("EXCEL");
        $("#form #reportFileName").val("/homecare/htOrderSOFList_Excel.rpt");
    }
...
<h1>CS Report - Mattress Care Service (MCS) List</h1>
<ul class="right_opt">

...
$(document).ready(function() {
    ...
    if("${claimType}" == "nc") {
        ...
        if("${clamUn}" != "") {
            ...
            Common.ajax("GET", "/newStaffClaim/selectStaffClaimInfo.do?_cacheId=" + Math.random(), data, fn_setStaffClaimInfo);
        }
    }
...
function claimDtls() {
    ...
    if("${claimType}" == "nc") {
        ...
        /*if("${clamUn}" != "") {
            ...
            Common.ajax("GET", "/newStaffClaim/removeClaim.do", {claimNo : $("#claimNo").val(), clamUn : clamUn, clmType : "CM"}, function(iResult) {
                console.log(iResult);
            })
        }*/
    }

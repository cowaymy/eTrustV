...
function fn_approveLineSubmit() {
    ...
    Common.ajax("POST", "/eAccounting/smGmClaim/approveLineSubmit.do", obj, function(result) {
        console.log(result);
        Common.popupDiv("/eAccounting/smGmClaim/completedMsgPop.do", {callType:callType, clmNo:result.data.clmNo}, null, true, "completedMsgPop");
...
<h1><spring:message code="newRgistSmGmClaim.title" /></h1>
<p class="pop_close"><a href="#"><spring:message code="newWebInvoice.btn.close" /></a></p>
</header><!-- pop_header end -->

<section class="pop_body"><!-- pop_body start -->
<p class="msg_txt"><spring:message code="newRgistSmGmClaim.rgistMsg" /></p>

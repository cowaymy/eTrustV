...
function btnGenerate_Click(){
    ...
    $("#reportDownFileName").val("eRequestCancellationRaw_"+date+(new Date().getMonth()+1)+new Date().getFullYear());
    $("#reportFileName").val("/sales/eRequestRawData.rpt");
    $("#viewType").val("EXCEL");
...
<h1>eRequest Cancellation Raw Data</h1>
<ul class="right_opt">

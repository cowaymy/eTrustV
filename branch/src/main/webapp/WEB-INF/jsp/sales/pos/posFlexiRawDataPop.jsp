...
// ADDED CHECKING POS MODULE TYPE ID FOR POS RAW DATA REPORT -- TPY
    ...
    //params Setting
    $("#reportFileName").val("/sales/POSFlexiRawData.rpt");
    $("#viewType").val("EXCEL");
    //
...
function fn_insTransactionLogRaw(whereSql){
    ...
    var transacMap = {};
    transacMap.rptChkPoint = "http://etrust.my.coway.com/sales/pos/posFlexiRawDataPop.do";
    transacMap.rptModule = "POS";
    transacMap.rptName = "POS Listing";
    transacMap.rptSubName = "POS Listing - Excel";
    transacMap.rptEtType = "xlsx";
    transacMap.rptPath = getContextPath()+"/sales/POSFlexiRawData.rpt";

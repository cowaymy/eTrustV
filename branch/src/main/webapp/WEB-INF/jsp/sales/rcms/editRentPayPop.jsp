...
<script type="text/javaScript" language="javascript">
    ...
    function createModAUIGrid2() {
        ...
        var rfrColumnLayout = [
          ...
          , { headerText : '<spring:message code="sal.text.contactNo" />', dataField : "refCntc",    editable : true,  width : 110, editRenderer : { type : "InputEditRenderer", 
                                                                                                                  onlyNumeric : true}}
          , { headerText : '<spring:message code="sal.text.remark" />',    dataField : "refRem",     editable : true}
          , { headerText : '<spring:message code="sal.title.created" />',   dataField : "crtDt",      editable : false, width : 120 }
    ...
    $(function(){
        ...
        $('#chkRejectDate').click(function() {
            ...
            if(isChk) {
                if($("#rentPayMode option:selected").index() <= 0) {
                    ...
                    Common.alert('<spring:message code="sal.alert.msg.rentPayModeRequired" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.plzSelRentPayFirst" />');
                }
                else {
                    $('#spRjctDate').text("*");
                    $('#spRejectReason').text("*");
        ...
        $('#thrdPartyId').change(function(event) {
            ...
            if(InputCustID != CUST_ID) {
                ...
                //Common.alert('<spring:message code="sal.alert.msg.thirdPartyRestriction" />' + DEFAULT_DELIMITER + "<b>Third party and customer cannot be same person/company.<br />Your input third party ID : "+InputCustID+"</b>");
                Common.alert('<spring:message code="sal.alert.msg.thirdPartyRestriction" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.plzInputPartyId" arguments="'+InputCustID+'" />');
        ...
        $('#rentPayMode').change(function(event) {
            ...
            if($("#rentPayMode option:selected").index() > 0) {
                ...
                if($('#rentPayMode').val() == '133' || $('#rentPayMode').val() == '134') {
                    //Common.alert('<spring:message code="sal.alert.msg.rentPayRestriction" />' + DEFAULT_DELIMITER + "<b>Currently we are not provide [" + $("#rentPayMode option:selected").text() + "] service.</b>");
                    Common.alert('<spring:message code="sal.alert.msg.rentPayRestriction" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.weNotProvideService" arguments="'+$("#rentPayMode option:selected").text() +'"/>');
                    $('#rentPayMode').val('');
                }
                else {
                    if($('#rentPayMode').val() == '131') {
                        if($('#thrdParty').is(":checked")) {
                            if(FormUtil.isEmpty($('#hiddenThrdPartyId').val())) {
                                Common.alert('<spring:message code="sal.alert.msg.thirdPartyRequiredmsg" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.plzSelThirdPartyFirst" />');
                                $('#rentPayMode').val('');
                            }
                            else {
        ...
        $('#btnCal').click(function() {            
            ...
            msg += '<spring:message code="sal.alert.msg.applicationTypeCol"  arguments="'+appTypeName+'"/>';
            msg += '<spring:message code="sal.alert.msg.productCol" arguments="'+productName+'"/>';
            msg += '<spring:message code="sal.alert.msg.prcRPFCol" arguments="'+newPriceGST+'"/>';
            msg += '<spring:message code="sal.alert.msg.normalRentalCol" arguments="'+oldRentalGST+'"/>';
            msg += '<spring:message code="sal.alert.msg.promotionCol" arguments="'+newRentalGST+'"/>';
            msg += '<spring:message code="sal.alert.msg.feeApplyToTab" />';
    ...
    function isEditableNRIC() {
        ...
        Common.ajax("GET", "/sales/order/checkNricEdit.do", {custId : CUST_ID}, function(result) {
            ...
            if(result != null) {
                ...
                if(isEditable == false) {
                    Common.alert('<spring:message code="sal.alert.msg.actionRestriction" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.disallowCustidEdit" arguments="'+CUST_ID+'" />');
                    //<b>Customer NRIC/Company No. for Customer ID : " + CUST_ID + " is disallowed to edit.</b>
                }
    ...
    function fn_changeTab(tabNm) {
        ...
        if(tabNm == 'PRM') {
            ...
            if(ORD_STUS_ID != '1' && ORD_STUS_ID != '4') {
                var msg = '<spring:message code="sal.alert.msg.notInActCompStusPromo" />';
...
*/
    ...
    function fn_loadThirdPartyPop(InputCustID) {
            ...
            if(InputCustID != CUST_ID) {
                ...
                Common.alert('<spring:message code="sal.alert.msg.thirdPartyCustCannotSame" />'
                    + InputCustID + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msginvalidThirdPartyId" />');
            }
    }
    ...
    function fn_loadThirdParty(custId, sMethd) {
        ...
        Common.ajax("GET", "/sales/customer/selectCustomerJsonList", {custId : custId}, function(result) {
            ...
            if(result != null && result.length == 1) {
                ...
                if(sMethd == 2) {
                    Common.alert('<spring:message code="sal.alert.msg.thirdPartyNotFoundInput" />' + custId + '</b>'
                        + InputCustID + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.thirdPartyNotFoundmsg" />');
                }
            }
        });
    ...
    function fn_loadBankAccountPop(bankAccId) {
      ...
      //$('#rentPayMode').val('');
        ...
        if(!FormUtil.IsValidBankAccount($('#hiddenRentPayBankAccID').val(), $('#rentPayBankAccNo').val())) {
            fn_clearRentPaySetDD();
            $('#scPC_DirectDebit').removeClass("blind");
            Common.alert('<spring:message code="sal.alert.msg.invalidBankAccNum" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.invalidAccForAutoDebit" />');
        }
    }
            ...
            if(fn_checkInstallResult(ORD_ID) == 0) {
                ...
                if(fn_checkGSTZRLocation($("#modInstAreaId").val()) > 0) {
                    ...
                    if(fn_checkGSTZRLocationByAddrId(addrIdOld) > 0) {                        
                        ...
                        Common.alert('<spring:message code="sal.alert.msg.changeFailed" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.zeroRateAreaCnntChng" />');
                    }
                }
                else {
                    if(fn_checkGSTZRLocationByAddrId(addrIdOld) > 0) {
                        Common.alert('<spring:message code="sal.alert.msg.changeFailed" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.nonZeroRateAreaCnntChng" />');
                    }
                    else {
                        $("#modInstCustAddIdOld").val(addrIdNew);
                        fn_loadInstallAddrInfo2(addrIdNew);
    ...
    function fn_validCert() {
        ...
        if(!isValid) Common.alert('<spring:message code="sal.alert.msg.saveCertSummary" />' + DEFAULT_DELIMITER + "<b>"+msg+"</b>");
    ...
    function fn_validInstallInfo() {
        ...
        if(!isValid) Common.alert('<spring:message code="sal.alert.msg.ordUpdSummary" />' + DEFAULT_DELIMITER + "<b>"+msg+"</b>");
    ...
    function fn_validCntcPerson() {
        ...
        if(!isValid) Common.alert('<spring:message code="sal.alert.msg.updSummary" />' + DEFAULT_DELIMITER + "<b>"+msg+"</b>");
...
//              Common.alert("Failed To Save" + DEFAULT_DELIMITER + "<b>Failed to save new member. Please try again later.<br />"+"Error message : " + jqXHR.responseJSON.message + "</b>");
                Common.alert('<spring:message code="sal.alert.title.saveFail" />' + DEFAULT_DELIMITER + '<spring:message code="sal.alert.msg.failToSaveNewMem" />');
            }
            catch (e) {
                console.log(e);
            }
...
//              Common.alert("Data Preparation Failed" + DEFAULT_DELIMITER + "<b>Saving data prepration failed.<br />"+"Error message : " + jqXHR.responseJSON.message + "</b>");
    ...
    function fn_doSaveGstCertInfo() {
        ...
        Common.ajax("POST", "/sales/order/updateGstCertInfo.do", gSTEURCertificateVO, function(result) {
            ...
            Common.alert('<spring:message code="sal.alert.msg.gstCertificateSaved" />' + DEFAULT_DELIMITER + "<b>"+result.message+"</b>", fn_reloadPage);
...
<h1 id="hTitle"><spring:message code="sal.title.text.ordEdit" /></h1>
<ul class="right_opt">
    <li><p class="btn_blue2"><a id="btnCloseModify" href="#"><spring:message code="sal.btn.close" /></a></p></li>
</ul>
...
<h3><spring:message code="sal.title.text.basicInfomation" /></h3>
...
<tr>
    <th scope="row"><spring:message code="sal.title.text.pono" /></th>
...
<tr>
    <th scope="row"><spring:message code="sal.text.keyInBranch" /><span class="must">*</span></th>
    <td>
...
<tr>
    <th scope="row" rowspan="3"><spring:message code="sal.title.remark" /></th>
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSaveBasicInfo" name="btnSaveBasicInfo" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
</section>
<!------------------------------------------------------------------------------
    Basic Info Edit END
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.billingGrpMtncMailAddr" /></h3>
</aside><!-- title_line end -->
<ul class="right_btns mb10">
    <li><p class="btn_grid"><a id="btnBillNewAddr" href="#"><spring:message code="sal.btn.addNewAddr" /></a></p></li>
    <li><p class="btn_grid"><a id="btnBillSelAddr" href="#"><spring:message code="sal.title.text.seMailAddr" /></a></p></li>
</ul>
...
<tr>
    ...
    <th scope="row"><spring:message code="sal.title.text.totOrdGroup" /></th>
    <td><span id="modTotalOrder"></span></td>
</tr>
<tr>
    <th scope="row"><spring:message code="sal.title.text.currAddr" /></th>
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSaveMailingAddress" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
</section>
<!------------------------------------------------------------------------------
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.billingGrpMtcContactPerson" /></h3>
</aside><!-- title_line end -->
<ul class="right_btns mb10">
    <li><p class="btn_grid"><a id="btnNewCntc" href="#"><spring:message code="sal.title.text.addNewCntc" /></a></p></li>
    <li><p class="btn_grid"><a id="btnSelCntc" href="#"><spring:message code="sal.title.text.selContactPerson" /></a></p></li>
</ul>
...
<aside class="title_line"><!-- title_line start -->
<h2><spring:message code="sal.title.text.currCntcPerson" /></h2>
</aside><!-- title_line end -->
...
<aside class="title_line"><!-- title_line start -->
<h2><spring:message code="sal.btn.newContactPerson" /></h2>
</aside><!-- title_line end -->
...
<tr>
    <th scope="row"><spring:message code="sal.tap.title.contactPerson" /></th>
    <td colspan="3"><span id="modCntcPersonNew"></span></td>
</tr>
<tr>
    <th scope="row"><spring:message code="sal.title.text.mobNumber" /></th>
...
<ul class="center_btns">
    <li><p class="btn_blue2 big"><a id="btnSaveCntcPerson" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
</section>
<!------------------------------------------------------------------------------
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.nricCompNo" /></h3>
</aside><!-- title_line end -->
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSaveNric" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
</section>
<!------------------------------------------------------------------------------
...
<ul class="right_btns mb10">
    <li><p class="btn_grid"><a id="btnInstNewAddr" href="#"><spring:message code="sal.btn.addNewAddr" /></a></p></li>
    <li><p class="btn_grid"><a id="btnInstSelAddr" href="#"><spring:message code="sal.title.text.seMailAddr" /></a></p></li>
</ul>
...
<ul class="right_btns mb10">
    <li><p class="btn_grid"><a id="btnInstNewCntc" href="#"><spring:message code="sal.title.text.addNewCntc" /></a></p></li>
    <li><p class="btn_grid"><a id="btnInstSelCntc" href="#"><spring:message code="sal.title.text.selContactPerson" /></a></p></li>
</ul>
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSaveInstInfo" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
</section>
<!------------------------------------------------------------------------------
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.paymentChnnl" /></h3>
</aside><!-- title_line end -->
<ul class="right_btns mb10">
    <li><p class="btn_grid"><a id="btnViewHistory" href="#"><spring:message code="sal.title.text.viewHistory" /></a></p></li>
</ul>
...
<aside class="title_line"><!-- title_line start -->
<h2><spring:message code="sal.title.text.thirdParty" /></h2>
</aside><!-- title_line end -->

<ul class="right_btns mb10">
    <li><p class="btn_grid"><a id="btnAddCust" href="#"><spring:message code="sal.title.text.addNewThirdParty" /></a></p></li>
</ul>
...
<tbody>
<tr>
    <th scope="row"><spring:message code="sal.title.text.rentPayMode" /><span class="must">*</span></th>
    <td>
    <select id="rentPayMode" name="rentPayMode" class="w100p"></select>
    </td>
    <th scope="row"><spring:message code="sal.title.text.nricOnPassbook" /></th>
...
<aside class="title_line"><!-- title_line start -->
<h2><spring:message code="sal.title.text.crdCard" /></h2>
</aside><!-- title_line end -->

<ul class="right_btns mb1m">
    <li><p class="btn_grid"><a id="addCreditCardBtn" href="#"><spring:message code="sal.title.text.addNewCrdCard" /></a></p></li>
    <li><p class="btn_grid"><a id="selCreditCardBtn" href="#"><spring:message code="sal.title.text.selAnotherCrdCard" /></a></p></li>
</ul>
...
<tbody>
<tr>
    <th scope="row"><spring:message code="sal.title.text.crdCardNumber" /><span class="must">*</span></th>
    ...
    <th scope="row"><spring:message code="sal.title.text.crdCardType" /></th>
...
<tr>
    ...
    <th scope="row"><spring:message code="sal.title.text.expiry" /></th>
...
<ul class="right_btns mb10">
    ...
    <li><p class="btn_grid"><a id="btnSelBankAccount" href="#"><spring:message code="sal.title.text.selAnotherBankAcc" /></a></p></li>
</ul>
...
<tbody>
<tr>
    <th scope="row"><spring:message code="sal.title.text.accNumber" /><span class="must">*</span></th>
    ...
    <th scope="row"><spring:message code="sal.title.text.accountType" /></th>
    <td><span id="rentPayBankAccType"></span></td>
</tr>
<tr>
    <th scope="row"><spring:message code="sal.title.accountHolder" /></th>
    <td><span id="accName"></span></td>
    <th scope="row"><spring:message code="sal.title.text.issueBankBrnch" /></th>
...
<tbody>
<tr>
    <th scope="row"><spring:message code="sal.text.applyDate" /><span class="must">*</span></th>
...
<tr>
    <th scope="row"><spring:message code="sal.title.text.payTerm" /></th>
    <td>
    ...
    <th scope="row"><spring:message code="sal.title.text.rejReason" /><span id="spRejectReason" class="must"></span></th>
    <td>
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSavePayChan" href="#"><spring:message code="sal.btn.save2" /></a></p></li>
</ul>  
</section>
<!------------------------------------------------------------------------------
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.docuSubmission" /></h3>
</aside><!-- title_line end -->
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSaveDocSub" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
</section>
<!------------------------------------------------------------------------------
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.referralInfo" /></h3>
</aside><!-- title_line end -->
...
<ul class="right_btns">
    <li><p class="btn_grid"><a id="btnCanclChg" href="#"><spring:message code="sal.title.text.cancelChngs" /></a></p></li>
    <li><p class="btn_grid"><a id="btnAddRowReferral" href="#"><spring:message code="sal.btn.addBtn" /></a></p></li>
</ul>
<article class="grid_wrap"><!-- grid_wrap start -->
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSaveReferral" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
</section>
<!------------------------------------------------------------------------------
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.promoInfomation" /></h3>
</aside><!-- title_line end -->

<ul class="left_btns">
    <li><p class="btn_blue"><p><spring:message code="sal.title.text.expiredPromoQuestion" /></p></li>
</ul>
...
<tr>
    ...
    <td colspan="2"><p id="pBtnCal" class="btn_sky blind"><a id="btnCal" href="#"><spring:message code="sal.title.text.excludeGstCalcu" /></a></p></td>
</tr>
</tbody>
</table><!-- table end -->
</section>
...
<ul class="center_btns">
    <li><p class="btn_blue2"><a id="btnSavePromo" href="#"><spring:message code="sal.btn.save" /></a></p></li>
</ul>
...
<aside class="title_line"><!-- title_line start -->
<h3><spring:message code="sal.title.text.gstCertification" /></h3>
</aside><!-- title_line end -->

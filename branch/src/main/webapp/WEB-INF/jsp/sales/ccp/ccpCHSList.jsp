...
<script type="text/javaScript" language="javascript">
    ...
    $(document).ready(function(){
      ...
      //AUIGrid.setSelectionMode(myGridID, "singleRow");
        ...
        AUIGrid.bind(myGridID, "cellDoubleClick", function(event){
            $("#chsBatchId").val(event.item.chsBatchId);
            Common.popupDiv("/sales/ccp/ccpCHSDetailViewPop.do", $("#chsSearchForm").serializeJSON(), null, true, 'detailPop');
        });
    });
    ...
    function fn_searchListAjax(){
        Common.ajax("GET", "/sales/ccp/selectCcpCHSMstList", $("#chsSearchForm").serialize(), function(result) {
            AUIGrid.setGridData(myGridID, result);
        });
    }

    function fn_chsUpload(){
        Common.popupDiv("/sales/ccp/ccpCHSFileUploadPop.do", $("#chsSearchForm").serializeJSON(), null, true, 'savePop');
    }
...
<h2>Customer Health Score (CHS)</h2>
<ul class="right_btns">
    <c:if test="${PAGE_AUTH.funcChange == 'Y'}">
    <li><p class="btn_blue"><a href="#" onClick="fn_chsUpload()">Upload</a></p></li>
    </c:if>
    ...
    <li><p class="btn_blue"><a href="#" onclick="javascript:$('#chsSearchForm').clearForm();"><span class="clear"></span><spring:message code="sal.btn.clear" /></a></p></li>
</ul>
</aside><!-- title_line end -->


<section class="search_table"><!-- search_table start -->
<form id="chsSearchForm" name="chsSearchForm" method="post">
    ...
    <colgroup>
        ...
        <tbody>
            <tr>
                ...
                <td >
                <input type="text" title="" id="chsBatchId" name="chsBatchId" placeholder="CHS Batch Number" class="w100p" />
                </td>
                <th scope="row"><spring:message code="sal.text.createDate" /></th>
                <td>
                <div class="date_set w100p"><!-- date_set start -->
                <p><input type="text" id="chsCreateStDate" name="chsCreateStDate" title="Create start Date" placeholder="DD/MM/YYYY" class="j_date" /></p>
                <span>To</span>
                <p><input type="text" id="chsCreateEnDate" name="chsCreateEnDate" title="Create end Date" placeholder="DD/MM/YYYY" class="j_date" /></p>
                </div><!-- date_set end -->
                </td>

...
<div id="popup_wrap" class="popup_wrap">
 ...
 <header class="pop_header">
  <!-- pop_header start -->
  <h1>
   <spring:message code="sal.title.addBankAccount" />
  </h1>
  <ul class="right_opt">
   <li><p class="btn_blue2">
     <a id="addDdCloseBtn" href="#"><spring:message
 ...
 <section class="pop_body">
    ...
    <tbody>
     <tr>
      <th scope="row"><spring:message code="sal.text.type" /><span
       class="must">*</span></th>
      <td><select id="cmbBankType" name="bankType"
     ...
     <tr>
      <th scope="row"><spring:message code="sal.text.issueBank" /><span
       class="must">*</span></th>
      <td><select id="cmbAccBank" name="accBank" class="w100p"></select>
      </td>
      <th scope="row"><spring:message code="sal.text.accNo" /><span
       class="must">*</span></th>
      <td><input id="txtAccNo" name="accNo" type="text" title=""
       placeholder="Account No" class="w100p" /></td>
     </tr>
     <tr>
      <th scope="row"><spring:message code="sal.text.bankBranch" /></th>
      <td><input id="txtAccBankBranch" name="accBankBranch"
       type="text" title="" placeholder="Bank Branch" class="w100p" />
      </td>
      <th scope="row"><spring:message code="sal.text.accountOwner" /><span
       class="must">*</span></th>
      <td><input id="txtAccName" name="accName" type="text"
       title="" placeholder="Account Owner" class="w100p" /></td>
     </tr>
     <tr>
      <th scope="row"><spring:message code="sal.text.remark" /></th>
      <td colspan="3"><textarea id="txtAccRemark" name="accRemark"
  ...
  <ul class="center_btns">
   <li><p class="btn_blue2 big">
     <a id="btnAddBankAcc" href="#"><spring:message

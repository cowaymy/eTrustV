...
function fn_uploadFile() {
    ...
    Common.ajaxFile("/incentive/goldPoints/csvUploadRedemptionItems.do", formData, function (result) {
        console.log(result);
...
<div id="popup_wrap" class="popup_wrap size_small"><!-- popup_wrap start -->
 <header class="pop_header">
  <!-- pop_header start -->
  <h1><spring:message code='incentive.title.redemptionItmsUpload'/></h1>
  <ul class="right_opt">
 ...
 <!-- pop_header end -->
  <section class="pop_body"><!-- pop_body start -->
    ...
    <ul class="center_btns mt20">
      ...
      <li><p class="btn_blue2 big"><a href="${pageContext.request.contextPath}/resources/download/incentive/RedemptionItemsFormat.csv"><spring:message code='pay.btn.downloadCsvFormat'/></a></p></li>
    </ul>
  </section>
</div><!-- popup_wrap end -->
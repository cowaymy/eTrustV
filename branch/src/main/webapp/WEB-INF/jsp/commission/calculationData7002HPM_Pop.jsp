...
<script type="text/javaScript">
	var myGridID_7002HPM;
	var today = "${today}";
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7002HPM, "cellClick", function(event) {
		...
		$("#search_7002HP").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7002HP", $("#form7002HP").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7002HPM, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7002HP = [ {
        ...
        dataField : "r4",
        headerText : "<spring:message code='commissiom.text.excel.bonus'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r13",
        ...
        dataField : "r21",
        headerText : "<spring:message code='commission.text.grid.salesCommOveriding'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r22",
        ...
        dataField : "r34",
        headerText : "<spring:message code='commissiom.text.excel.rentalmembershipAmt'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "r39",
	...
	myGridID_7002HPM = AUIGrid.create("#grid_wrap_7002HPM", columnLayout_7002HP,gridPros);
   }
   ...
   function fn_AlldownFile() {
       ...
       Common.ajax("GET", "/commission/calculation/cntData7002HP", data, function(result) {
           var cnt = result;
           if(cnt > 0){
        	   var fileName = $("#fileName").val() +"_"+today;
               fileName=fileName+".xlsx";
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<form id="form7002HP">
            ...
            <input type="hidden" id="fileName" name="fileName" value="hp_manager_basic.xlsx"/>
		   <ul class="right_btns">
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7002HPM" style="width: 100%; height: 334px; margin: 0 auto;"></div>

...
<script type="text/javaScript">
	var myGridID_7001CDC;
	var today = "${today}";
	
	$(document).ready(function() {
		createAUIGrid();
		// cellClick event.
		AUIGrid.bind(myGridID_7001CDC, "cellClick", function(event) {
		...
		$("#search_7001CD").click(function(){  
			Common.ajax("GET", "/commission/calculation/selectData7001CD", $("#form7001CD").serialize(), function(result) {
				...
				AUIGrid.setGridData(myGridID_7001CDC, result);
			});
		});
   ...
   function createAUIGrid() {
	var columnLayout_7001CD = [ {
        ...
        dataField : "v8",
        headerText : "<spring:message code='commissiom.text.excel.netUnit'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v9",
        ...
        dataField : "v12",
        headerText : "<spring:message code='commissiom.text.excel.droppedRate'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v13",
        headerText : "<spring:message code='commissiom.text.excel.droppedMarks'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v14",
        ...
        dataField : "v16",
        headerText : "<spring:message code='commissiom.text.excel.salesPriceTotal'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v17",
        headerText : "<spring:message code='commissiom.text.excel.memAmt'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v18",
        ...
        dataField : "v21",
        headerText : "<spring:message code='commissiom.text.excel.collecCmmAppRate'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v24",
        ...
        dataField : "v32",
        headerText : "<spring:message code='commissiom.text.excel.cffCompliment'/>",
        style : "my-column",
        editable : false
    },{
        dataField : "v33",
        headerText : "<spring:message code='commissiom.text.excel.cffMark'/>",
        style : "my-column",
        editable : false
    }];
	// 그리드 속성 설정
	...
	<section class="pop_body" style="max-height:600px;"><!-- pop_body start -->
	   <aside class="title_line"><!-- title_line start -->
		...
		<article class="grid_wrap3"><!-- grid_wrap start -->
			...
			<!-- grid_wrap start -->
			<div id="grid_wrap_7001CDC" style="width: 100%; height: 334px; margin: 0 auto;"></div>

...
var itemGridID;
	...
	function fn_itemDetailSearch(val){
		if(val == "0"){
			$("#vStusId").val("");
			Common.ajax("GET", "/commission/calculation/mboItemList", $("#conForm").serializeJSON(), function(result) {
...
<h1><spring:message code='commission.title.pop.head.mboConfirm'/></h1>
<ul class="right_opt">

...
function fn_openField_Complete(){
    ...
    /*
    //Bind Completete Result
    ddlDSCCode.SelectedValue = HiddenDSCID.Value;
    ddlErrorCode.SelectedValue = HiddenErrorCodeID.Value;
    ddlCTCode.SelectedValue = HiddenCTID.Value;
    ddlErrorDesc.SelectedValue = HiddenErrorDescID.Value;
    txtRemark.Text = HiddenRemark.Value;
    */
}
...
function  fn_setSaveFormData(){
    ...
    var asResultM ={
                   ...
                   //productCode  :  try{aSOrderInfo.stockCode}catch(e){"0" ;},
                   //productName  : try{aSOrderInfo.stockCode}stockDesc(e){"0" ;},
                   //serialNo :try{aSOrderInfo.lastInstallSerialNo}stockDesc(e){"0" ;} 
    }
...
<dl>
    ...
    <tr>
        <th scope="row">Result Creator <span class="must">*</span></th>
        <td>

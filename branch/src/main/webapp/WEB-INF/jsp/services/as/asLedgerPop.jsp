...
<!--
 ...
 ----------------------------------------------------------------
 17/09/2019  ONGHC  1.0.0          Amend fn_ledgerSearch to pass AS no.
 -->
...
<script type="text/javaScript">
  ...
  function fn_ledgerSearch() {
    Common.ajax("GET", "/services/as/report/getViewLedger.do", {
      ASNO : "${ASNo}"
    }, function(result) {
  ...
  function fn_ledgerGrid() {
    ...
    myGridID_ledger = AUIGrid.create("#grid_wrap_ledger", columnLayout,
        gridPros);
  }

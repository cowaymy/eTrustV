...
<script type="text/javaScript">
  ...
  function fn_validation() {
    ...
    if ($("#orderNoFrom").val() != '' || $("#orderNoTo").val() != '') {
      if ($("#orderNoFrom").val() == '' || $("#orderNoTo").val() == '') {
        Common
            .alert("<spring:message code='sys.common.alert.validation' arguments='Order Number (From & To)' htmlEscape='false'/>");
        return false;
      }
    }
  ...
  function fn_openReport() {
    if (fn_validation()) {
      ...
      if ($("#appStrDate").val() != '' && $("#appEndDate").val() != '') {
        appDate = $("#appStrDate").val() + " To "
            + $("#appEndDate").val();
        whereSql += " AND (ie.Install_Dt between to_date('"
            + $("#appStrDate").val()
            + "', 'DD/MM/YYYY') AND to_date('"
            + $("#appEndDate").val() + "', 'DD/MM/YYYY') ) ";
      }
      ...
      if ($("#productLst").val() != '' && $("#productLst").val() != null) {
        whereSql += "AND ie.INSTALL_STK_ID IN ( " + $("#productLst").val()
            + ")  ";
      }
      ...
      if ($("#doCrtDate").val() != '' && $("#doEndDate").val() != '') {
        whereSql += " AND (sm.MOV_UPD_DT between to_date('"
            + $("#doCrtDate").val()
            + "', 'DD/MM/YYYY') AND to_date('"
            + $("#doEndDate").val() + "', 'DD/MM/YYYY') ) ";
      }
      ...
      if ($("#orderStrDate").val() != ''
          && $("#orderEndDate").val() != '') {
        orderDate = $("#orderStrDate").val() + " To "
            + $("#orderEndDate").val()
        whereSql += " AND (som.Sales_Dt between to_date('"
            + $("#orderStrDate").val()
            + "', 'DD/MM/YYYY') AND to_date('"
            + $("#orderEndDate").val() + "', 'DD/MM/YYYY') ) ";
      }

      if ($("#CTCodeFrom").val() != '' && $("#CTCodeTo").val() != '') {
        whereSql += " AND (m.mem_code between '"
            + $("#CTCodeFrom").val() + "' AND '"
            + $("#CTCodeTo").val() + "') ";
      }
 ...
 <section class="pop_body">
  ...
  <section class="search_table">
   ...
   <form action="#" id="reportForm">
    <input type="hidden" id="V_DSCCODE" name="V_DSCCODE" /> <input
     type="hidden" id="V_APPDATE" name="V_APPDATE" /> <input
     type="hidden" id="V_ORDERDATE" name="V_ORDERDATE" /> <input
     type="hidden" id="V_WHERESQL" name="V_WHERESQL" /> <input
     type="hidden" id="V_ORDERBYSQL" name="V_ORDERBYSQL" />
      ...
      <tr>
       ...
       <td>
        <div class="date_set">
         ...
         <p>
          <input type="text" title="Create start Date"
           placeholder="DD/MM/YYYY" class="j_date" id="doCrtDate"
           name="doCrtDate" />
         </p>
         <span>To</span>
         <p>
          <input type="text" title="Create end Date"
           placeholder="DD/MM/YYYY" class="j_date" id="doEndDate"
           name="doEndDate" />
         </p>
        </div>
        <!-- date_set end -->
      ...
      <tr>
       ...
       <td>
        <div class="date_set">
         ...
         <p>
          <input type="text" title="Create start Date"
           placeholder="DD/MM/YYYY" class="j_date" id="orderStrDate"
           name="orderStrDate" />
         </p>
         <span>To</span>
         <p>
          <input type="text" title="Create end Date"
           placeholder="DD/MM/YYYY" class="j_date" id="orderEndDate"
           name="orderEndDate" />
         </p>
        </div>
        <!-- date_set end -->

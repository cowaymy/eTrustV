...
var rescolumnLayout=[
							...
							{dataField: "whLocDesc",headerText :"<spring:message code='log.head.port'/>"    ,width:250 ,height:30,editable:false, cellMerge : true  },
              {dataField: "plant",headerText :"<spring:message code='log.head.plant'/>"   ,width:120 ,height:30,editable:false, visible:false},
              {dataField: "blNo",headerText :"<spring:message code='log.head.blno'/>" ,width:200 ,height:30,editable:false, cellMerge : true, mergeRef : "whLocDesc", // 이전 칼럼(대분류) 셀머지의 값을 비교해서 실행함. (mergePolicy : "restrict" 설정 필수)

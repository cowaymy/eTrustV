...
var ReceiveStatusCombo = [{"codeId": "4","codeName": "Complete"},{"codeId": "50","codeName": "Incomplete"}];
  ...
  */
    ...
    $(document).ready(function(){
        ...
        //doGetComboData('/logistics/sirim/selectWarehouseLoc.do', '', '','searchWarehouse', 'S' , '');
       doGetComboData('/logistics/sirim/selectWarehouseLocByUserBranch.do', '', '','searchWarehouse', 'S' , '');
